...
void RevealBorderLight::OnConnected(winrt::UIElement const& newElement)
{
    ...
    if (!m_materialProperties)
    {
        ...
        m_transparencyPolicyChangedRevoker = m_materialProperties.TransparencyPolicyChanged(winrt::auto_revoke, { this, &RevealBorderLight::OnTransparencyPolicyChanged });
    }

    // Apply Initial policy state
    MaterialHelper::LightTemplates<RevealBorderLight>::OnLightTransparencyPolicyChanged(this, m_materialProperties, true /* onUIThread */);
...
void RevealBorderLight::OnTransparencyPolicyChanged(const winrt::IMaterialProperties& sender, const winrt::IInspectable& /*args*/)
{
    MaterialHelper::LightTemplates<RevealBorderLight>::OnLightTransparencyPolicyChanged(this, sender, false /* onUIThread */);
}
