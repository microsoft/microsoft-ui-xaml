...
void RevealHoverLight::OnConnected(winrt::UIElement const& newElement)
{
    ...
    if (!m_materialProperties)
    {
        ...
        m_transparencyPolicyChangedRevoker = m_materialProperties.TransparencyPolicyChanged(winrt::auto_revoke, { this, &RevealHoverLight::OnTransparencyPolicyChanged });
    }

    // Apply Initial policy state
    MaterialHelper::LightTemplates<RevealHoverLight>::OnLightTransparencyPolicyChanged(this, m_materialProperties, true /* onUIThread */);
...
#if BUILD_WINDOWS
void RevealHoverLight::OnTransparencyPolicyChanged(const winrt::IMaterialProperties& sender, const winrt::IInspectable& /*args*/)
{
    MaterialHelper::LightTemplates<RevealHoverLight>::OnLightTransparencyPolicyChanged(this, sender, false /* onUIThread */);
}
