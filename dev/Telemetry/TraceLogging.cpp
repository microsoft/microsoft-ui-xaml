...
TRACELOGGING_DEFINE_PROVIDER(g_hPerfProvider, PERF_PROVIDER_NAME, (0xf55f7011, 0x988d, 0x4674, 0xa7, 0x24, 0xe0, 0x1b, 0x39, 0xdc, 0x7a, 0xf6));
...
TRACELOGGING_DEFINE_PROVIDER(g_hLoggingProvider, DEBUG_PROVIDER_NAME, (0xafe0ae07, 0x66a7, 0x55bb, 0x12, 0xff, 0x01, 0x11, 0x6b, 0xc0, 0x8c, 0x1a));
...
void RegisterTraceLogging()
{
    ...
    if (FAILED(hr))
    {
        TraceLoggingWriteActivity(
            g_hTelemetryProvider, "CreateGuidError", nullptr, nullptr, TraceLoggingHResult(hr), TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES));
    ...
    if (FAILED(hr))
    {
        TraceLoggingWriteActivity(g_hPerfProvider, "CreateGuidError", nullptr, nullptr, TraceLoggingHResult(hr));
    ...
    if (FAILED(hr))
    {
        TraceLoggingWriteActivity(g_hLoggingProvider, "CreateGuidError", nullptr, nullptr, TraceLoggingHResult(hr));
