...
WebView2::WebView2()
{
    ...
    m_manipulationModeChangedToken.value = RegisterPropertyChangedCallback(
        winrt::UIElement::ManipulationModeProperty(), { this, &WebView2::OnManipulationModePropertyChanged });
