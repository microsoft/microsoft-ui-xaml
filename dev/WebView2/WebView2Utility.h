...
LPARAM PackIntoWin32StylePointerArgs_lparam(
    const UINT message, const winrt::Windows::UI::Xaml::Input::PointerRoutedEventArgs& args, winrt::Windows::Foundation::Point point)
{
...
WPARAM PackIntoWin32StyleMouseArgs_wparam(const UINT message, const winrt::Windows::UI::Xaml::Input::PointerRoutedEventArgs& args, winrt::PointerPoint pointerPoint)
{
    ...
    else if (message == WM_XBUTTONDOWN || message == WM_XBUTTONUP)
    {
        ...
        if (pointerUpdateKind == winrt::PointerUpdateKind::XButton1Pressed || pointerUpdateKind == winrt::PointerUpdateKind::XButton1Released)
        {
            highWord |= XBUTTON1;
        }
        else if (pointerUpdateKind == winrt::PointerUpdateKind::XButton2Pressed || pointerUpdateKind == winrt::PointerUpdateKind::XButton2Released)
        {
            highWord |= XBUTTON2;
        }
    }
