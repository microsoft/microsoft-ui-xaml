...
class AutoSuggestBoxHelper : public winrt::implementation::AutoSuggestBoxHelperT<AutoSuggestBoxHelper>, public AutoSuggestBoxHelperProperties
{
public:
    ...
    static winrt::DependencyProperty AutoSuggestEventRevokersProperty()
    {
        return s_AutoSuggestEventRevokersProperty;
    }
...
class AutoSuggestEventRevokers : public winrt::implements<AutoSuggestEventRevokers, winrt::Windows::Foundation::IInspectable>
{
public:
