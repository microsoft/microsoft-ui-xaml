...
void BindToIconPropertyIfUnset(winrt::XamlUICommand const& uiCommand, winrt::DependencyObject const& target, winrt::DependencyProperty const& iconProperty);

void BindToIconSourcePropertyIfUnset(winrt::XamlUICommand const& uiCommand, winrt::DependencyObject const& target, winrt::DependencyProperty const& iconSourceProperty);

#endif

void BindToLabelPropertyIfUnset(winrt::XamlUICommand const& uiCommand, winrt::DependencyObject const& target, winrt::DependencyProperty const& labelProperty);

void BindToKeyboardAcceleratorsIfUnset(winrt::XamlUICommand const& uiCommand, winrt::UIElement const& target);

void BindToAccessKeyIfUnset(winrt::XamlUICommand const& uiCommand, winrt::UIElement const& target);

void BindToDescriptionPropertiesIfUnset(winrt::XamlUICommand const& uiCommand, winrt::DependencyObject const& target);

void ClearBindingIfSet(winrt::XamlUICommand const& uiCommand, winrt::FrameworkElement const& target, winrt::DependencyProperty const& targetProperty);
}; // namespace CommandingHelpers
