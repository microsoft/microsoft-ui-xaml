    ...
    if (!s_IgnoredInputKindProperty)
    {
        s_IgnoredInputKindProperty =
            InitializeDependencyProperty(
                ...
                winrt::name_of<winrt::ScrollPresenter>(),
                false /* isAttached */,
                ValueHelper<winrt::ScrollingInputKinds>::BoxValueIfNecessary(ScrollPresenter::s_defaultIgnoredInputKind),
...
void ScrollPresenterProperties::IgnoredInputKind(winrt::ScrollingInputKinds const& value)
{
    static_cast<ScrollPresenter*>(this)->SetValue(s_IgnoredInputKindProperty, ValueHelper<winrt::ScrollingInputKinds>::BoxValueIfNecessary(value));
}

winrt::ScrollingInputKinds ScrollPresenterProperties::IgnoredInputKind()
{
    return ValueHelper<winrt::ScrollingInputKinds>::CastOrUnbox(static_cast<ScrollPresenter*>(this)->GetValue(s_IgnoredInputKindProperty));
}
