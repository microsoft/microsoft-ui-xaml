...
public:
    ...
    winrt::event_token EdgeScrollQueued(winrt::TypedEventHandler<winrt::ScrollPresenter, winrt::ScrollingEdgeScrollEventArgs> const& value);
    ...
    event_source<winrt::TypedEventHandler<winrt::ScrollPresenter, winrt::ScrollingEdgeScrollEventArgs>> m_edgeScrollQueuedEventSource;
