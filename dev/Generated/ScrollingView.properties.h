...
public:
    ...
    winrt::event_token AnchorRequested(winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingAnchorRequestedEventArgs> const& value);
    void AnchorRequested(winrt::event_token const& token);
    winrt::event_token BringingIntoView(winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingBringingIntoViewEventArgs> const& value);
    ...
    winrt::event_token ScrollAnimationStarting(winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingScrollAnimationStartingEventArgs> const& value);
    void ScrollAnimationStarting(winrt::event_token const& token);
    winrt::event_token ScrollCompleted(winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingScrollCompletedEventArgs> const& value);
    ...
    winrt::event_token ZoomAnimationStarting(winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingZoomAnimationStartingEventArgs> const& value);
    void ZoomAnimationStarting(winrt::event_token const& token);
    winrt::event_token ZoomCompleted(winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingZoomCompletedEventArgs> const& value);
    void ZoomCompleted(winrt::event_token const& token);

    event_source<winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingAnchorRequestedEventArgs>> m_anchorRequestedEventSource;
    event_source<winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingBringingIntoViewEventArgs>> m_bringingIntoViewEventSource;
    event_source<winrt::TypedEventHandler<winrt::ScrollingView, winrt::IInspectable>> m_extentChangedEventSource;
    event_source<winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingScrollAnimationStartingEventArgs>> m_scrollAnimationStartingEventSource;
    event_source<winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingScrollCompletedEventArgs>> m_scrollCompletedEventSource;
    ...
    event_source<winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingZoomAnimationStartingEventArgs>> m_zoomAnimationStartingEventSource;
    event_source<winrt::TypedEventHandler<winrt::ScrollingView, winrt::ScrollingZoomCompletedEventArgs>> m_zoomCompletedEventSource;
