...
public:
    ...
    static winrt::DependencyProperty ActiveProperty() { return s_ActiveProperty; }
    ...
    static GlobalDependencyProperty s_ActiveProperty;
    ...
    static void OnActivePropertyChanged(
