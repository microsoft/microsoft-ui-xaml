...
class BreadcrumbBarProperties
{
public:
    BreadcrumbBarProperties();
    ...
    winrt::event_token ItemClicked(winrt::TypedEventHandler<winrt::BreadcrumbBar, winrt::BreadcrumbBarItemClickedEventArgs> const& value);
