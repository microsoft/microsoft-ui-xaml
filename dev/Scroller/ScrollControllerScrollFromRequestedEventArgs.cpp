...
winrt::ScrollInfo ScrollControllerScrollFromRequestedEventArgs::ScrollInfo() const
{
    return m_scrollInfo;
}

void ScrollControllerScrollFromRequestedEventArgs::ScrollInfo(winrt::ScrollInfo scrollInfo)
{
