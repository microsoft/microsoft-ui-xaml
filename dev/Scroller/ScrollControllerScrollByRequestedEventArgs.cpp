...
winrt::ScrollInfo ScrollControllerScrollByRequestedEventArgs::ScrollInfo() const
{
    return m_scrollInfo;
}

void ScrollControllerScrollByRequestedEventArgs::ScrollInfo(winrt::ScrollInfo scrollInfo)
{
