    ...
    public winrt::implements<ProgressRingAnimatedVisual, winrt::IAnimatedVisual, winrt::IClosable>
{
    ...
    winrt::CompositionEllipseGeometry Ellipse_7_0()
    {
        ...
        const float calculatedRadius = std::max(_size.Width / 10.0f - _strokeThickness / 10.0f, 0.0f);
    ...
    winrt::CompositionSpriteShape SpriteShape_1()
    {
        ...
        result.StrokeThickness(_strokeThickness);
        return result;
    }
...
public:
    ProgressRingAnimatedVisual(winrt::Compositor compositor, float strokeThickness, winrt::Size size, winrt::Color foreground, winrt::Color background)
        : _c(compositor),
...
ProgressRingLoading::ProgressRingLoading(float strokeThickness, winrt::Size size, winrt::Color foreground, winrt::Color background)
