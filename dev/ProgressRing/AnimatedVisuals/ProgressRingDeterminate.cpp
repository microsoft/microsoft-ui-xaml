...
class AnimatedVisual : public winrt::implements<AnimatedVisual, winrt::IAnimatedVisual, winrt::IClosable>
{
    ...
    CompositionColorBrush ThemeColor_Foreground_0()
    {
        ...
        BindProperty(
            result,
            L"Color",
            L"ColorRGB(_theme.Foreground.W*0,_theme.Foreground.X,_theme.Foreground.Y,_theme.Foreground.Z)",
            L"_theme",
            _themeProperties);
        return result;
    }
    ...
    CompositionColorBrush ThemeColor_Foreground_1()
    {
        ...
        BindProperty(
            result,
            L"Color",
            L"ColorRGB(_theme.Foreground.W*1,_theme.Foreground.X,_theme.Foreground.Y,_theme.Foreground.Z)",
            L"_theme",
            _themeProperties);
        return result;
    }
