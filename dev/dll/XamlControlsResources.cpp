...
thread_local bool s_tlsControlsResourceVersion2 = true;
...
bool XamlControlsResources::ControlsResourceVersion2()
{
    return ControlsResourceVersion() != winrt::ControlsResourceVersion::Version1;
}
...
void XamlControlsResources::OnPropertyChanged(const winrt::DependencyPropertyChangedEventArgs& args)
{
    ...
    if (property == s_UseCompactResourcesProperty || property == s_ControlsResourceVersionProperty)
    {
        // Source link depends on ControlsResourceVersion and UseCompactResources flag, we need to update it when either property changed
        UpdateSource();
    }
}
...
void XamlControlsResources::UpdateSource()
{
    ...
    const bool useControlsResourceVersion2 = ControlsResourceVersion2();
    ...
    winrt::Uri uri {
        [useCompactResources, useControlsResourceVersion2]() -> hstring {
            ...
            hstring postfix = useControlsResourceVersion2 ? L"themeresources.xaml" : L"themeresources_v1.xaml";
    ...
    s_tlsControlsResourceVersion2 = useControlsResourceVersion2;
}
...
void SetDefaultStyleKeyWorker(winrt::IControlProtected const& controlProtected, std::wstring_view const& className) 
{
    ...
    if (auto control5 = controlProtected.try_as<winrt::IControl5>())
    {
        winrt::Uri uri{
            ...
            std::wstring postfix = s_tlsControlsResourceVersion2 ? L"generic.xaml" : L"generic_v1.xaml";
