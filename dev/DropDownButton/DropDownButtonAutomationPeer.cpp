...
DropDownButtonAutomationPeer::DropDownButtonAutomationPeer(winrt::DropDownButton  /*unused*/const& owner)
...
com_ptr<DropDownButton> DropDownButtonAutomationPeer::GetImpl()
{
    ...
    if (auto dropDownButton = safe_try_cast<winrt::DropDownButton>(Owner()))
    {
