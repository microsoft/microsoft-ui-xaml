...
private:
    ...
    void SetScrollViewer(const winrt::Windows::UI::Xaml::Controls::ScrollViewer& scrollViewer);
...
private:
    ...
    tracker_ref<winrt::Windows::UI::Xaml::Controls::ScrollViewer> m_scrollViewer{ m_owner };
