...
// Abstraction layer between the ParallaxView and its ScrollViewer/ScrollingPresenter source.
...
private:
    ...
    static void GetChildScrollingPresenterOrScrollViewer(
    ...
    void SetScrollingPresenter(const winrt::ScrollingPresenter& scrollingPresenter);
    ...
    void ProcessScrollingPresenterContentChange();
    ...
    void OnScrollingPresenterPropertyChanged(const winrt::DependencyObject& sender, const winrt::DependencyProperty& args);
    ...
    void HookScrollingPresenterPropertyChanged();
    void UnhookScrollingPresenterPropertyChanged();
    void HookScrollingPresenterContentPropertyChanged();
    void UnhookScrollingPresenterContentPropertyChanged();
...
private:
    ...
    tracker_ref<winrt::ScrollingPresenter> m_scrollingPresenter{ m_owner };
    ...
    winrt::event_token m_scrollingPresenterContentChangedToken{ 0 };
