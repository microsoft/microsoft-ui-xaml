...
{
    [TestClass]
    public class EffectiveViewportScrollingPresenterTests : ApiTestBase
    {
        [TestMethod]
        public void ValidateOneScrollingPresenterScenario()
        {
            ...
            RunOnUIThread.Execute(() =>
            {
                ...
                scrollingPresenter.ZoomTo(2.0f, Vector2.Zero, new ScrollingZoomOptions(AnimationMode.Disabled, SnapPointsMode.Ignore));
            });
