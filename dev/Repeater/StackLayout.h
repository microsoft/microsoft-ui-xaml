...
class StackLayout : public ReferenceTracker<StackLayout, winrt::implementation::StackLayoutT, VirtualizingLayout>,
...
private:
    double GetAverageElementSize(winrt::Size availableSize, winrt::VirtualizingLayoutContext context, const winrt::com_ptr<StackLayoutState>& layoutState);
