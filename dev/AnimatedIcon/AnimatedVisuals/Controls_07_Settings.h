...
// | Foreground     | Foreground | Color |   #FF212121   |
// -------------------------------------------------------
class Controls_07_Settings
    : public winrt::implementation::Controls_07_SettingsT<Controls_07_Settings>
{
    winrt::Windows::UI::Composition::CompositionPropertySet _themeProperties{ nullptr };
    winrt::Windows::UI::Color _themeForeground{ 0xFF, 0x21, 0x21, 0x21 };
...
public:
    ...
    static inline const winrt::Windows::UI::Color c_themeForeground{ 0xFF, 0x21, 0x21, 0x21 };
