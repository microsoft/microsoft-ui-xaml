...
AnimatedIcon::AnimationPlay::AnimationPlay(
    AnimatedIcon& owner,
    float fromProgress,
    float toProgress,
    bool looped)
...
float AnimatedIcon::AnimationPlay::FromProgress()
{
    return m_fromProgress;
}

// REENTRANCE SIDE EFFECT: IsPlaying DP.
void AnimatedIcon::AnimationPlay::Start()
{
...
bool AnimatedIcon::AnimationPlay::IsCurrentPlay()
{
    return m_owner.m_nowPlaying.get() == this;
}

void AnimatedIcon::AnimationPlay::SetPlaybackRate(float value)
{
    if (m_controller)
    {
...
void AnimatedIcon::AnimationPlay::OnHiding()
{
...
void AnimatedIcon::AnimationPlay::OnUnhiding()
{
    if (m_isPausedBecauseHidden)
    {
...
void AnimatedIcon::AnimationPlay::Pause()
{
    m_isPaused = true;
...
void AnimatedIcon::AnimationPlay::Resume()
{
    m_isPaused = false;
...
// REENTRANCE SIDE EFFECT: IsPlaying DP.
void AnimatedIcon::AnimationPlay::Complete()
{
    //
...
AnimatedIcon::AnimatedIcon()
{
    ...
    m_loadedRevoker = Loaded(winrt::auto_revoke, { this, &AnimatedIcon::OnLoaded });
    m_unloadedRevoker = Unloaded(winrt::auto_revoke, { this, &AnimatedIcon::OnUnloaded });
}
...
void AnimatedIcon::OnUnloaded(winrt::IInspectable const& /*sender*/, winrt::RoutedEventArgs const& /*args*/)
{
    m_isUnloaded = true;
...
/*
winrt::AutomationPeer AnimatedIcon::OnCreateAutomationPeer()
{
...
winrt::CompositionObject AnimatedIcon::ProgressObject()
{
...
// Public API.
winrt::IAsyncAction AnimatedIcon::PlayAsync(double fromProgress, double toProgress, bool looped)
{
    if (!SharedHelpers::IsRS5OrHigher())
    {
        co_return;
...
void AnimatedIcon::SetProgress(double progress)
{
    if (!SharedHelpers::IsRS5OrHigher())
    {
        return;
...
void AnimatedIcon::OnAutoPlayPropertyChanged(
...
void AnimatedIcon::OnFallbackContentPropertyChanged(
    winrt::DependencyPropertyChangedEventArgs const& args)
{
    if (m_isFallenBack)
    {
...
void AnimatedIcon::OnSourcePropertyChanged(
    winrt::DependencyPropertyChangedEventArgs const& args)
{
...
void AnimatedIcon::UnloadContent()
{
...
void AnimatedIcon::UpdateContent()
{
...
void AnimatedIcon::LoadFallbackContent()
{
...
void AnimatedIcon::UnloadFallbackContent()
{
    MUX_ASSERT(!m_isFallenBack);
    SetFallbackContent(nullptr);
}

void AnimatedIcon::SetFallbackContent(winrt::UIElement const& uiElement)
{
...
void AnimatedIcon::OnPlaybackRatePropertyChanged(
    winrt::DependencyPropertyChangedEventArgs const& args)
{
    if (m_nowPlaying)
    {
...
void AnimatedIcon::OnStretchPropertyChanged(
