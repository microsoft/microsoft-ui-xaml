...
{
    public sealed partial class ScrollingPresenterExpressionAnimationSourcesPage : TestPage
    {
        ...
        public ScrollingPresenterExpressionAnimationSourcesPage()
        {
            InitializeComponent();
            Loaded += ScrollingPresenterExpressionAnimationSourcesPage_Loaded;
            scrollingPresenter.SizeChanged += ScrollingPresenter_SizeChanged;

            ChkLogScrollingPresenterMessages_Checked(null, null);
        }
        ...
        private void ScrollingPresenterExpressionAnimationSourcesPage_Loaded(object sender, RoutedEventArgs e)
        {
            this.fullLogs.Add("ScrollingPresenterExpressionAnimationSourcesPage_Loaded");
        ...
        {
            this.fullLogs.Add("ScrollingPresenter_SizeChanged PreviousSize=" + e.PreviousSize + ", NewSize=" + e.NewSize);
        ...
        private void SetupScrollbars()
        {
            ...
            hIndicatorWidthExpression.SetReferenceParameter("seas", scrollingPresenter.ExpressionAnimationSources);
            vIndicatorHeightExpression.SetReferenceParameter("seas", scrollingPresenter.ExpressionAnimationSources);
            ...
            vIndicatorOffsetExpression = vScrollIndicatorVisual.Compositor.CreateExpressionAnimation(
                "Vector3(" +
                    ...
                    "0.0f)");
            hIndicatorOffsetExpression.SetReferenceParameter("seas", scrollingPresenter.ExpressionAnimationSources);
            vIndicatorOffsetExpression.SetReferenceParameter("seas", scrollingPresenter.ExpressionAnimationSources);
        ...
        private void UpdateScrollbars()
        {
            ...
            Vector2 viewport;
            CompositionGetValueStatus cgvs = scrollingPresenter.ExpressionAnimationSources.Properties.TryGetVector2("Viewport", out viewport);
            txtViewport.Text = cgvs.ToString() + ", " + viewport.ToString();

            Vector2 extent;
            cgvs = scrollingPresenter.ExpressionAnimationSources.Properties.TryGetVector2("Extent", out extent);
