...
{
public:
    ScrollOptions(winrt::ScrollingAnimationMode const& animationMode);
    ScrollOptions(winrt::ScrollingAnimationMode const& animationMode, winrt::ScrollingSnapPointsMode const& snapPointsMode);
