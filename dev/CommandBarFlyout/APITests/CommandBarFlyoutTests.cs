...
namespace Windows.UI.Xaml.Tests.MUXControls.ApiTests
{
    ...
    public class CommandBarFlyoutTests : ApiTestBase
    {
        ...
        [TestMethod]
        public void VerifyAddRemovePrimaryCommandsWhileOpen()
        {
            if (PlatformConfiguration.IsOSVersionLessThan(OSVersion.Redstone2))
            {
                Log.Warning("Test is disabled pre-RS2 because CommandBarFlyout is not supported pre-RS2");
            ...
            RunOnUIThread.Execute(() =>
            {
                ...
                flyout.SecondaryCommands.Add(new AppBarButton() { Label = "Item 2" });
                flyout.SecondaryCommands.Add(new AppBarButton() { Label = "Item 3" });
                flyout.SecondaryCommands.Add(new AppBarButton() { Label = "Item 4" });
                flyout.SecondaryCommands.Add(new AppBarButton() { Label = "Item 5" });
                flyout.SecondaryCommands.Add(new AppBarButton() { Label = "Item 6" });
