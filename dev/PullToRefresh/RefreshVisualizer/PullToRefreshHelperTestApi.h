...
class PullToRefreshHelperTestApi : public winrt::implementation::PullToRefreshHelperTestApiT<PullToRefreshHelperTestApi>
{
public:
    static winrt::RefreshInteractionRatioChangedEventArgs CreateRefreshInteractionRatioChangedEventArgsInstance(double value);
    static winrt::RefreshStateChangedEventArgs CreateRefreshStateChangedEventArgsInstance(
