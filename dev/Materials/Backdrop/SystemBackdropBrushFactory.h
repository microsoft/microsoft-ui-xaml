...
winrt::Windows::UI::Composition::CompositionBrush BuildMicaEffectBrush(
    const winrt::Windows::UI::Composition::Compositor& compositor, winrt::Windows::UI::Color tintColor, float tintOpacity, float luminosityOpacity);
...
winrt::Windows::UI::Composition::ScalarKeyFrameAnimation CreateCrossFadeAnimation(const winrt::Windows::UI::Composition::Compositor& compositor);
} // namespace SystemBackdropComponentInternal
