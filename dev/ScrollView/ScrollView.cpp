...
int32_t ScrollView::SetScrollVelocity(winrt::float2 offsetsVelocity)
{
    SCROLLVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this,
        TypeLogging::Float2ToString(offsetsVelocity).c_str());

    if (auto scrollPresenter = m_scrollPresenter.get())
    {
        return scrollPresenter.SetScrollVelocity(offsetsVelocity);
    }
