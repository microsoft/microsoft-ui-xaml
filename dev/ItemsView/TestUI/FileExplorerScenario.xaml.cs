...
namespace MUXControlsTestApp
{
    ...
    public sealed partial class FileExplorerScenario : Page
    {
        ...
        private void ChangeSelectionMode(object sender, object args)
        {
            switch (((Button)sender).Content.ToString())
            {
                case "None":
                    itemsView.Selector.Mode = ItemsViewPrototype.SelectionMode.None;
                    break;

                case "Single":
                    itemsView.Selector.Mode = ItemsViewPrototype.SelectionMode.Single;
                    break;

                case "Multiple":
                    itemsView.Selector.Mode = ItemsViewPrototype.SelectionMode.Multiple;
                    break;

                case "Extended":
                    itemsView.Selector.Mode = ItemsViewPrototype.SelectionMode.Extended;
                    break;
            }
        }
