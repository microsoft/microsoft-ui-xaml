...
namespace MUXControlsTestApp
{
    ...
    public sealed partial class ItemsViewBasicPage : Page
    {
        public ItemsViewBasicPage()
        {
            ...
            // TODO: File Bug why binding does not automatically trigger for ItemsSource
            stackView.ItemsSource = Books;
            gridView.ItemsSource = Books;
            tableView.ItemsSource = Books;
            groupedTableView.ItemsSource = ByGenre;
            itemsView.ItemsSource = Books;
            itemsViewWithTable.ItemsSource = Books;
            itemsViewWithTableGrouped.ItemsSource = ByGenre;
        ...
        private void HierarchicalViewGenerator_SelectTemplate(object sender, SelectTemplateArgs args)
        {
            var data = args.Owner.DataSource.GetAt(args.Index);
            args.TemplateKey = data is Book ? "RowTemplate" : "GroupTemplate";
        }
