...
namespace WinUI3
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            SetTitleBar(AppTitleBar); // AppTitleBar is a UIElement defined in XAML
        ...
        private void MainWindow_Activated(object sender, Microsoft.UI.Xaml.WindowActivatedEventArgs args)
        {
            ...
            {
                App.Stopwatch.Stop();
                AppStartTimeTextBlock.Text = $"App Start Time: {App.Stopwatch.ElapsedMilliseconds} ms";
        ...
        private async void OpenFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Get the window handle (HWND) and initialize the picker with it
        ...
        private void FileTabView_TabCloseRequested(TabView sender, TabViewTabCloseRequestedEventArgs args)
        {
            ...
            if (args.Tab is TabViewItem tabViewItem && tabViewItem.Content is TabContent tabContent && string.IsNullOrEmpty(tabContent.FilePath))
            {
                // Example: Prompt to save changes before closing
                ContentDialog saveDialog = new ContentDialog
                {
                    Title = "Save Changes?",
                    Content = $"Do you want to save changes to {tabContent.Header}?",
                ...
                saveDialog.PrimaryButtonClick += async (s, e) =>
                {
                    var file = await StorageFile.GetFileFromPathAsync(tabContent.FilePath);
                    await FileIO.WriteTextAsync(file, tabContent.Content ?? string.Empty);
                };
        ...
        private async void OpenFolderButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (currentFolder != null)
            {
                ...
                App.Stopwatch.Stop();
                TreeViewLoadTimeTextBlock.Text = $"TreeView Load Time: {App.Stopwatch.ElapsedMilliseconds} ms";
            }
        }
        ...
        private async void FolderTreeView_DoubleTapped(object sender, DoubleTappedRoutedEventArgs e)
        {
            ...
            if (FolderTreeView.SelectedItem is FolderItem selectedItem && selectedItem.SubItems == null)
            {
