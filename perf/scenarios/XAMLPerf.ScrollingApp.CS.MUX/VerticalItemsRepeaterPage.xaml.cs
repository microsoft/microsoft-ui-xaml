...
namespace XAMLPerf.ScrollingApp.CS.MUX
{
    ...
    /// </summary>
    public sealed partial class VerticalItemsRepeaterPage : Page
    {
        ...
        public VerticalItemsRepeaterPage()
        {
        ...
        {
            return new ScrollingScenario(new VItemsRepeaterInteractionModel(deviceInteractionModel)).Execute();
        }
