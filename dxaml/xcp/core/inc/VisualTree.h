...
public:
    ...
    // http://osgvsowi/17002792: Allow XAML apps to also have XamlIslands (part 2)
...
private:
    ...
    // For XamlIsland content, it's the CXamlIslandRoot.
    ...
    // True if the VisualTree is serving as the main visual tree for a XAML app.  Otherwise, it's for a XamlIsland
