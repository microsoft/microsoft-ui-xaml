...
_Check_return_ HRESULT BaseContentRenderer::PanelRenderContent(_In_ CPanel *pPanel)
{
    if (pPanel->OfTypeByIndex<KnownTypeIndex::SwapChainPanel>())
    {
        ...
        && !(pPanel->OfTypeByIndex<KnownTypeIndex::XamlIsland>() && static_cast<CXamlIslandRoot*>(pPanel)->HasTransparentBackground())
        ...
        && !pPanel->OfTypeByIndex<KnownTypeIndex::SwapChainBackgroundPanel>())
    {
        ...
        if (pPanel->OfTypeByIndex<KnownTypeIndex::RootVisual>() || pPanel->OfTypeByIndex<KnownTypeIndex::XamlIsland>())
        {
