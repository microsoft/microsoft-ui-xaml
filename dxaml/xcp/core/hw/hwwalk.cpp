...
int HWWalk::GetElementsRendered() const
{
    ...
    ) noexcept
{
    ...
    const bool isXamlIsland = pUIElement->GetTypeIndex() == KnownTypeIndex::XamlIsland;
    ...
    )
{
    ...
    switch (typeIndex)
    {
        ...
        case KnownTypeIndex::XamlIslandRootCollection:
            // We handle rendering the XamlIsland roots in separate render walks
            break;
    ...
    )
{
    ...
    rp.m_isInXamlIsland = pVisualRoot->OfTypeByIndex<KnownTypeIndex::XamlIsland>();
    ...
    if (rp.pHWWalk->GetOverrideRenderDataList() == nullptr)
    {
        ...
        else
        {
            ...
            ASSERT(compNodeParent != nullptr
                ...
                || pUIElement->OfTypeByIndex<KnownTypeIndex::XamlIsland>());
