...
namespace XamlGen.Templates.Code.Phone.Bodies
{
    ...
    public partial class AttachedPropertySetterBodyEnum : CppCodeGenerator<AttachedPropertyDefinition>
    {
        /// <summary>
        ...
        public override string TransformText()
        {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Helper.PrefixAbiIfNeeded($"{Helper.GetRootNamespaceCpp()}::IDependencyObject")));
            this.Write("), &spElementAsDO));\r\nIFC(Private::ValueBoxer::CreateReference<");
            this.Write(this.ToStringHelper.ToStringWithCulture(AsCppType(Model.PropertyType.AbiFullName)));
            this.Write(">(value, &spValueAsII));\r\nIFC(spElementAsDO->SetValue(s_");
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.Name));
