...
namespace XamlGen.Templates.Code.Phone.Bodies
{
    ...
    public partial class AttachedPropertyGetterBodyString : CppCodeGenerator<AttachedPropertyDefinition>
    {
        /// <summary>
        ...
        public override string TransformText()
        {
            ...
            this.Write("Property());\r\n\r\nIFC(");
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.TargetType.AbiParameterName));
            this.Write("->GetValue(s_");
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.Name));
            this.Write("Property.Get(), &spValueAsII));\r\n\r\nIFC(Private::ValueBoxer::UnboxString(spValueAs" +
                    "II.Get(), pValue));\r\n\r\n");
