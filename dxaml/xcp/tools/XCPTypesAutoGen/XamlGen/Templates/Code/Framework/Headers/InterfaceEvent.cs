...
namespace XamlGen.Templates.Code.Framework.Headers
{
    ...
    public partial class InterfaceEvent : CppCodeGenerator<EventDefinition>
    {
        /// <summary>
        ...
        public override string TransformText()
        {
            ...
            this.Write(", _Out_ EventRegistrationToken* ptToken) = 0;\r\nIFACEMETHOD(");
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.RemoveName));
            this.Write(")(_In_ EventRegistrationToken tToken) = 0;\r\n");
