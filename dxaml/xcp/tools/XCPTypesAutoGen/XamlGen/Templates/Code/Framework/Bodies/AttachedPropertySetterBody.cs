...
namespace XamlGen.Templates.Code.Framework.Bodies
{
    ...
    public partial class AttachedPropertySetterBody : CppCodeGenerator<AttachedPropertyDefinition>
    {
        /// <summary>
        ...
        {
            this.Write("    RRETURN(DependencyObject::SetAttachedValueByKnownIndex(static_cast<");
