...
namespace XamlOM
{
    ...
    public class ClassFlagsAttribute : Attribute, NewBuilders.IClassBuilder
    {
        /// <summary>
        ...
        /// </summary>
        [DefaultValue(true)]
        public bool HasBaseTypeInDXamlInterface { get; set; }
        ...
        /// </summary>
        [DefaultValue(true)]
        public bool IsCreateableAfterV2 { get; set; }
        ...
        /// </summary>
        [DefaultValue(true)]
        public bool IsVisibleInXAML { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether this class represents a primitive.
        /// Example: INDEX_BOOLEAN
        /// </summary>
        ...
        public ClassFlagsAttribute()
        {
            HasBaseTypeInDXamlInterface = true;
            IsCreateableAfterV2 = true;
            IsVisibleInXAML = true;
        }
        ...
        public void BuildNewClass(OM.ClassDefinition definition, Type source)
        {
            ...
            if (!HasBaseTypeInDXamlInterface)
            {
                definition.IdlClassInfo.BaseClass = NewBuilders.ModelFactory.GetOrCreateClass(typeof(object));
            }
            NewBuilders.Helper.ApplyFlagProperties(this, definition.XamlClassFlags);
        }
    }
}
