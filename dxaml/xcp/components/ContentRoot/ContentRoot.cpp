    ...
    , m_focusManager(&m_coreServices, *this)
{
    ...
    switch (m_type)
    {
        ...
        {
            FAIL_FAST_ASSERT(m_coreServices.GetContentRootCoordinator()->m_unsafe_XamlIslandsIncompatible_CoreWindowContentRoot == nullptr); // There should only be one of this per thread
            m_coreServices.GetContentRootCoordinator()->m_unsafe_XamlIslandsIncompatible_CoreWindowContentRoot = this;
        ...
        case CContentRoot::Type::XamlIsland:
        {
...
CContentRoot::~CContentRoot()
{
    ...
    {
        m_coreServices.GetContentRootCoordinator()->m_unsafe_XamlIslandsIncompatible_CoreWindowContentRoot = nullptr;
    }
...
HWND CContentRoot::GetOwnerWindow() const
{
    ...
    else if (m_type == Type::XamlIsland)
    {
        if (m_xamlIslandRoot)
        {
...
wrl::ComPtr<ixp::IContentIslandEnvironment> CContentRoot::GetContentIslandEnvironment() const
{
    ...
    if (m_type == Type::XamlIsland && m_xamlIslandRoot)
    {
