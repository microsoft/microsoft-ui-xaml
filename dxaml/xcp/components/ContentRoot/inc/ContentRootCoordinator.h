...
public:
    ...
    CContentRoot* Unsafe_XamlIslandsIncompatible_CoreWindowContentRoot() const { return m_unsafe_XamlIslandsIncompatible_CoreWindowContentRoot; }
...
private:
    ...
    CContentRoot* m_unsafe_XamlIslandsIncompatible_CoreWindowContentRoot = nullptr;
};