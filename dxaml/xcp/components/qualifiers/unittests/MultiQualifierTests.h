...
namespace Windows { namespace UI { namespace Xaml { namespace Tests {
    namespace Qualifiers {
        ...
        class MultiQualifierTests : public WEX::TestClass<MultiQualifierTests>
        {
        public:
            BEGIN_TEST_CLASS(MultiQualifierTests)
            END_TEST_CLASS()
            ...
            BEGIN_TEST_METHOD(Score)
                TEST_METHOD_PROPERTY(L"Classification", L"Integration")
                TEST_METHOD_PROPERTY(L"TestPass:IncludeOnlyOn", L"Desktop")
                TEST_METHOD_PROPERTY(L"Description", L"Tests Score function.")
            END_TEST_METHOD()
