...
public:
    ...
    STDMETHODIMP get_Type(_Out_ wf::PropertyType *valueType)  {
        // MUX's CValueBoxer needs enum references to be IPropertyValues and to
...
public:
    ...
    VALUEBOXER_METHOD(FLOAT, CreateSingle);
    ...
    VALUEBOXER_METHOD(UINT32, CreateUInt32);
    VALUEBOXER_METHOD(INT64, CreateInt64);
    VALUEBOXER_METHOD(UINT64, CreateUInt64);
