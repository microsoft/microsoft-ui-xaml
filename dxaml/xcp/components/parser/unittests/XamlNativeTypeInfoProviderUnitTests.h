...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests { namespace Parser {
    ...
    class XamlNativeTypeInfoProviderUnitTests
    {
    public:
        ...
        BEGIN_TEST_CLASS(XamlNativeTypeInfoProviderUnitTests)
            TEST_CLASS_PROPERTY(L"Classification", L"Integration")
            TEST_CLASS_PROPERTY(L"TestPass:IncludeOnlyOn", L"Desktop")
        END_TEST_CLASS()

        BEGIN_TEST_METHOD(Create)
            TEST_METHOD_PROPERTY(L"Description", L"Validates XamlNativeTypeInfoProvider can be created.")
        END_TEST_METHOD()
    ...
    private:
        ...
        std::shared_ptr<XamlTypeInfoProvider> GetNativeTypeInfoProvider(const std::shared_ptr<XamlSchemaContext>& schemaContext);
    };
