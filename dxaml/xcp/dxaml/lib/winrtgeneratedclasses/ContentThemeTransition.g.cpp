...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::ContentThemeTransition), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::ContentThemeTransition*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Media::Animation::IContentThemeTransition), sizeof(IID)) == 0)
    {
