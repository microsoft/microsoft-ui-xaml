...
// Factory methods.
IFACEMETHODIMP DirectUI::CheckBoxFactory::CreateInstance(_In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Controls::ICheckBox** ppInstance)
{

#if DBG
    // We play some games with reinterpret_cast and assuming that the GUID type table is accurate - which is somewhat sketchy, but
    // really good for binary size.  This code is a sanity check that the games we play are ok.
    const GUID uuidofGUID = __uuidof(ABI::Microsoft::UI::Xaml::Controls::ICheckBox);
...
namespace DirectUI
{
    ...
    {
        RRETURN(ctl::ActivationFactoryCreator<CheckBoxFactory>::CreateActivationFactory());
    }
}
