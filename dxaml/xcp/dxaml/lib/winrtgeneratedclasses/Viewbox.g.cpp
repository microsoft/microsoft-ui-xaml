...
{
    if (InlineIsEqualGUID(iid, __uuidof(ABI::Microsoft::UI::Xaml::Controls::IViewboxFactory)))
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::Controls::IViewboxFactory*>(this);
    }
    else     if (InlineIsEqualGUID(iid, __uuidof(ABI::Microsoft::UI::Xaml::Controls::IViewboxStatics)))
    {
...
// Factory methods.
IFACEMETHODIMP DirectUI::ViewboxFactory::CreateInstance(_In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Controls::IViewbox** ppInstance)
{
#if DBG
    const GUID uuidofGUID = __uuidof(ABI::Microsoft::UI::Xaml::Controls::IViewbox);
