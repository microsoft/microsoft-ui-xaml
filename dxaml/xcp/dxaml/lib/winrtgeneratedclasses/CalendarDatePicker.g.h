...
namespace DirectUI
{
    ...
    public:
        ...
        IFACEMETHOD(put_Date)(ABI::Windows::Foundation::IReference<ABI::Windows::Foundation::DateTime>* pValue) override;
        ...
        IFACEMETHOD(put_IsCalendarOpen)(BOOLEAN value) override;
