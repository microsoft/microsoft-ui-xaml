...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::ConnectedAnimation), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::ConnectedAnimation*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Media::Animation::IConnectedAnimation), sizeof(IID)) == 0)
    {
