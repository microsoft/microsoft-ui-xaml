...
IFACEMETHODIMP DirectUI::SplitViewPaneAutomationPeerGenerated::Close()
{
    ...
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "SplitViewPaneAutomationPeer_Close", 0);
    }
...
Cleanup:
    ...
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "SplitViewPaneAutomationPeer_Close", hr);
    }
    RRETURN(hr);
}
IFACEMETHODIMP DirectUI::SplitViewPaneAutomationPeerGenerated::SetVisualState(_In_ ABI::Microsoft::UI::Xaml::Automation::WindowVisualState state)
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "SplitViewPaneAutomationPeer_SetVisualState", 0);
    }
...
Cleanup:
    if (EventEnabledApiFunctionCallStop())
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "SplitViewPaneAutomationPeer_SetVisualState", hr);
    }
    RRETURN(hr);
}
...
Cleanup:
    if (EventEnabledApiFunctionCallStop())
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "SplitViewPaneAutomationPeer_WaitForInputIdle", hr);
    }
    RRETURN(hr);
}
