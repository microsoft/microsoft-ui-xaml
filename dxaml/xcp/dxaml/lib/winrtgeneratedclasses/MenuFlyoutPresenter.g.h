...
namespace ctl
{
    ...
    class interface_forwarder< ABI::Microsoft::UI::Xaml::Controls::IMenuFlyoutPresenterFeature_ExperimentalApi, impl_type> final
        : public ctl::iinspectable_forwarder_base< ABI::Microsoft::UI::Xaml::Controls::IMenuFlyoutPresenterFeature_ExperimentalApi, impl_type>
    {
...
#if WI_IS_FEATURE_PRESENT(Feature_ExperimentalApi)
        , public ctl::forwarder_holder< ABI::Microsoft::UI::Xaml::Controls::IMenuFlyoutPresenterFeature_ExperimentalApi, MenuFlyoutPresenterGenerated >
#endif
    {
...
#if WI_IS_FEATURE_PRESENT(Feature_ExperimentalApi)
            INTERFACE_ENTRY(MenuFlyoutPresenterGenerated, ABI::Microsoft::UI::Xaml::Controls::IMenuFlyoutPresenterFeature_ExperimentalApi)
#endif
...
namespace DirectUI
{
...
#if WI_IS_FEATURE_PRESENT(Feature_ExperimentalApi)
        , public ABI::Microsoft::UI::Xaml::Controls::IMenuFlyoutPresenterStaticsFeature_ExperimentalApi
#endif
    {
...
#if WI_IS_FEATURE_PRESENT(Feature_ExperimentalApi)
            INTERFACE_ENTRY(MenuFlyoutPresenterFactory, ABI::Microsoft::UI::Xaml::Controls::IMenuFlyoutPresenterStaticsFeature_ExperimentalApi)
#endif
    ...
    public:
        ...
        IFACEMETHOD(get_SystemBackdropProperty)(_Out_ ABI::Microsoft::UI::Xaml::IDependencyProperty** ppValue) FEATURE_EXPERIMENTALAPI_OVERRIDE;
