...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::XamlSourceFocusNavigationRequest), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::XamlSourceFocusNavigationRequest*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Hosting::IXamlSourceFocusNavigationRequest), sizeof(IID)) == 0)
    {
...
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Hosting::IXamlSourceFocusNavigationRequestFactory), sizeof(IID)) == 0)
    {
