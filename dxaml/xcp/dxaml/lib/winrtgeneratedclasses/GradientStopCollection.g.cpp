...
HRESULT DirectUI::GradientStopCollection::QueryInterfaceImpl(_In_ REFIID iid, _Outptr_ void** ppObject)
{
    ...
    {
        RRETURN(DirectUI::PresentationFrameworkCollection<ABI::Microsoft::UI::Xaml::Media::GradientStop*>::QueryInterfaceImpl(iid, ppObject));
    }
...
namespace DirectUI
{
    ...
    {
        RRETURN(ctl::BetterActivationFactoryCreator::GetForDO(KnownTypeIndex::GradientStopCollection));
    }
}
