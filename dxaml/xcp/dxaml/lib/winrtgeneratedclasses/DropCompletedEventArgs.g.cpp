...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::DropCompletedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::DropCompletedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IDropCompletedEventArgs), sizeof(IID)) == 0)
    {
