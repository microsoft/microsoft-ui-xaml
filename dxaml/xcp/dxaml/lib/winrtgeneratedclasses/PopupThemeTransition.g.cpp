...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::PopupThemeTransition), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::PopupThemeTransition*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Media::Animation::IPopupThemeTransition), sizeof(IID)) == 0)
    {
