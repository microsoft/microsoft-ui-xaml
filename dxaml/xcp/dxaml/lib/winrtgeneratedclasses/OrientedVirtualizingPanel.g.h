...
#define __OrientedVirtualizingPanel_GUID "c1bff631-094e-4b61-a970-4e5b6dd92261"
...
namespace DirectUI
{
    ...
    class __declspec(novtable) OrientedVirtualizingPanelGenerated:
        public DirectUI::VirtualizingPanel
        , public ABI::Microsoft::UI::Xaml::Controls::Primitives::IOrientedVirtualizingPanel
    ...
    {
        friend class DirectUI::OrientedVirtualizingPanel;

        INSPECTABLE_CLASS(L"Microsoft.UI.Xaml.Controls.Primitives.OrientedVirtualizingPanel");

        BEGIN_INTERFACE_MAP(OrientedVirtualizingPanelGenerated, DirectUI::VirtualizingPanel)
            INTERFACE_ENTRY(OrientedVirtualizingPanelGenerated, ABI::Microsoft::UI::Xaml::Controls::Primitives::IOrientedVirtualizingPanel)
            INTERFACE_ENTRY(OrientedVirtualizingPanelGenerated, ABI::Microsoft::UI::Xaml::Controls::IInsertionPanel)
            INTERFACE_ENTRY(OrientedVirtualizingPanelGenerated, ABI::Microsoft::UI::Xaml::Controls::Primitives::IScrollSnapPointsInfo)
            INTERFACE_ENTRY(OrientedVirtualizingPanelGenerated, DirectUI::IItemLookupPanel)
            INTERFACE_ENTRY(OrientedVirtualizingPanelGenerated, DirectUI::IOrientedPanel)
            INTERFACE_ENTRY(OrientedVirtualizingPanelGenerated, DirectUI::IPaginatedPanel)
            INTERFACE_ENTRY(OrientedVirtualizingPanelGenerated, DirectUI::IScrollInfo)
        END_INTERFACE_MAP(OrientedVirtualizingPanelGenerated, DirectUI::VirtualizingPanel)

    public:
        OrientedVirtualizingPanelGenerated();
        ~OrientedVirtualizingPanelGenerated() override;
        ...
        {
            return KnownTypeIndex::OrientedVirtualizingPanel;
        }
...
namespace DirectUI
{
    ...
    // care.
    class __declspec(novtable) OrientedVirtualizingPanelFactory:
       public ctl::BetterAggregableAbstractCoreObjectActivationFactory
        , public ABI::Microsoft::UI::Xaml::Controls::Primitives::IOrientedVirtualizingPanelFactory
    {
        BEGIN_INTERFACE_MAP(OrientedVirtualizingPanelFactory, ctl::BetterAggregableAbstractCoreObjectActivationFactory)
            INTERFACE_ENTRY(OrientedVirtualizingPanelFactory, ABI::Microsoft::UI::Xaml::Controls::Primitives::IOrientedVirtualizingPanelFactory)
        END_INTERFACE_MAP(OrientedVirtualizingPanelFactory, ctl::BetterAggregableAbstractCoreObjectActivationFactory)
