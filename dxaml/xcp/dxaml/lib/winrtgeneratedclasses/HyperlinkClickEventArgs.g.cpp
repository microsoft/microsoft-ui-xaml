...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::HyperlinkClickEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::HyperlinkClickEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Documents::IHyperlinkClickEventArgs), sizeof(IID)) == 0)
    {
