...
DirectUI::XamlResourceReferenceFailedEventArgs::XamlResourceReferenceFailedEventArgs()
{
}
...
// Properties.
IFACEMETHODIMP DirectUI::XamlResourceReferenceFailedEventArgs::get_Message(_Out_ HSTRING* pValue)
{
    HRESULT hr = S_OK;
...
_Check_return_ HRESULT DirectUI::XamlResourceReferenceFailedEventArgs::put_Message(_In_opt_ HSTRING value)
{
    HRESULT hr = S_OK;
    IFC(CheckThread());
...
namespace DirectUI
{
    _Check_return_ HRESULT OnFrameworkCreateXamlResourceReferenceFailedEventArgs(_In_ CEventArgs* pCoreObject, _Out_ IInspectable** ppNewInstance)
    {
        HRESULT hr = S_OK;
        ctl::ComPtr<DirectUI::XamlResourceReferenceFailedEventArgs> spInstance;
