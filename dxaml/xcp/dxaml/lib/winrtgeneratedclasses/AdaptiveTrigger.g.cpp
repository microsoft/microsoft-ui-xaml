...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::AdaptiveTrigger), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::AdaptiveTrigger*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IAdaptiveTrigger), sizeof(IID)) == 0)
    {
...
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IAdaptiveTriggerFactory), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::IAdaptiveTriggerFactory*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IAdaptiveTriggerStatics), sizeof(IID)) == 0)
    {
