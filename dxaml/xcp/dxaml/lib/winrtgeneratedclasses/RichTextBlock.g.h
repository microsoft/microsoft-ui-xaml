...
namespace DirectUI
{
    ...
    class __declspec(novtable) RichTextBlockFactory:
       public ctl::BetterAggregableCoreObjectActivationFactory
        , public ABI::Microsoft::UI::Xaml::Controls::IRichTextBlockFactory
        , public ABI::Microsoft::UI::Xaml::Controls::IRichTextBlockStatics
    {
        BEGIN_INTERFACE_MAP(RichTextBlockFactory, ctl::BetterAggregableCoreObjectActivationFactory)
            INTERFACE_ENTRY(RichTextBlockFactory, ABI::Microsoft::UI::Xaml::Controls::IRichTextBlockFactory)
            INTERFACE_ENTRY(RichTextBlockFactory, ABI::Microsoft::UI::Xaml::Controls::IRichTextBlockStatics)
        END_INTERFACE_MAP(RichTextBlockFactory, ctl::BetterAggregableCoreObjectActivationFactory)

    public:
        // Factory methods.
        IFACEMETHOD(CreateInstance)(_In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Controls::IRichTextBlock** ppInstance);
