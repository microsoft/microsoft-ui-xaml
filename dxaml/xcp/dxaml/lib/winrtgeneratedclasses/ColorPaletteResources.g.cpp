...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::ColorPaletteResources), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::ColorPaletteResources*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IColorPaletteResources), sizeof(IID)) == 0)
    {
