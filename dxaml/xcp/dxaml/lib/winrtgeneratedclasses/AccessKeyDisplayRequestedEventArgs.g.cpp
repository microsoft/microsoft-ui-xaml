...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::AccessKeyDisplayRequestedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::AccessKeyDisplayRequestedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Input::IAccessKeyDisplayRequestedEventArgs), sizeof(IID)) == 0)
    {
