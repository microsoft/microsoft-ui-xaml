...
namespace DirectUI
{
    ...
    public:
        ...
        // Methods.
        IFACEMETHOD(CreateIsland)(_Outptr_ ABI::Microsoft::UI::Xaml::Hosting::IXamlIsland** ppResult) override;
        IFACEMETHOD(CreateIslandWithContentBridge)(_In_ IInspectable* pOwner, _In_opt_ IInspectable* pContentBridge, _Outptr_ ABI::Microsoft::UI::Xaml::Hosting::IXamlIsland** ppResult) override;
...
#endif
        IFACEMETHOD(RemoveIsland)(_In_ ABI::Microsoft::UI::Xaml::Hosting::IXamlIsland* pIsland) override;
