...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::LoadedImageSourceLoadCompletedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::LoadedImageSourceLoadCompletedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Media::ILoadedImageSourceLoadCompletedEventArgs), sizeof(IID)) == 0)
    {
