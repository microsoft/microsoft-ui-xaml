...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::CalendarDatePickerDateChangedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::CalendarDatePickerDateChangedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::ICalendarDatePickerDateChangedEventArgs), sizeof(IID)) == 0)
    {
