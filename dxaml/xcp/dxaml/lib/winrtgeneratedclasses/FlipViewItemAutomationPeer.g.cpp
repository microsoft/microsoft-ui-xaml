...
// Factory methods.
IFACEMETHODIMP DirectUI::FlipViewItemAutomationPeerFactory::CreateInstanceWithOwner(_In_ ABI::Microsoft::UI::Xaml::Controls::IFlipViewItem* pOwner, _In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Automation::Peers::IFlipViewItemAutomationPeer** ppInstance)
{
    HRESULT hr = S_OK;
...
namespace DirectUI
{
    ...
    {
        RRETURN(ctl::ActivationFactoryCreator<FlipViewItemAutomationPeerFactory>::CreateActivationFactory());
    }
}
