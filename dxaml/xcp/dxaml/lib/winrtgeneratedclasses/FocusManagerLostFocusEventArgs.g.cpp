...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::FocusManagerLostFocusEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::FocusManagerLostFocusEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Input::IFocusManagerLostFocusEventArgs), sizeof(IID)) == 0)
    {
