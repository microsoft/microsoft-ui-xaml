...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::MediaTransportControlsThumbnailRequestedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::MediaTransportControlsThumbnailRequestedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Media::IMediaTransportControlsThumbnailRequestedEventArgs), sizeof(IID)) == 0)
    {
