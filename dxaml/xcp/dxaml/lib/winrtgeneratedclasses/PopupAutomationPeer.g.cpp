...
IFACEMETHODIMP DirectUI::PopupAutomationPeerGenerated::Close()
{
    ...
    {
        ApiEtwStart(this, KnownMethodIndex::PopupAutomationPeer_Close);
    }
...
IFACEMETHODIMP DirectUI::PopupAutomationPeerGenerated::SetVisualState(_In_ ABI::Microsoft::UI::Xaml::Automation::WindowVisualState state)
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        ApiEtwStart(this, KnownMethodIndex::PopupAutomationPeer_SetVisualState);
    }
...
IFACEMETHODIMP DirectUI::PopupAutomationPeerGenerated::WaitForInputIdle(_In_ INT milliseconds, _Out_ BOOLEAN* pReturnValue)
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        ApiEtwStart(this, KnownMethodIndex::PopupAutomationPeer_WaitForInputIdle);
    }
