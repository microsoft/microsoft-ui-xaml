...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::TimePickerSelectedValueChangedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::TimePickerSelectedValueChangedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::ITimePickerSelectedValueChangedEventArgs), sizeof(IID)) == 0)
    {
...
_Check_return_ HRESULT DirectUI::TimePickerSelectedValueChangedEventArgs::put_OldTime(ABI::Windows::Foundation::IReference<ABI::Windows::Foundation::TimeSpan>* pValue)
{
    HRESULT hr = S_OK;
    IFC(CheckThread());
...
_Check_return_ HRESULT DirectUI::TimePickerSelectedValueChangedEventArgs::put_NewTime(ABI::Windows::Foundation::IReference<ABI::Windows::Foundation::TimeSpan>* pValue)
{
    HRESULT hr = S_OK;
    IFC(CheckThread());
