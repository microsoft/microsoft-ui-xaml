...
// Properties.
IFACEMETHODIMP DirectUI::BrushTransitionGenerated::get_Duration(_Out_ ABI::Windows::Foundation::TimeSpan* pValue)
{
...
// Factory methods.
IFACEMETHODIMP DirectUI::BrushTransitionFactory::CreateInstance(_In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::IBrushTransition** ppInstance)
{

#if DBG
    // We play some games with reinterpret_cast and assuming that the GUID type table is accurate - which is somewhat sketchy, but
    // really good for binary size.  This code is a sanity check that the games we play are ok.
    const GUID uuidofGUID = __uuidof(ABI::Microsoft::UI::Xaml::IBrushTransition);
...
namespace DirectUI
{
    ...
    {
        RRETURN(ctl::ActivationFactoryCreator<BrushTransitionFactory>::CreateActivationFactory());
    }
}
