...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::ScrollViewerAutomationPeer), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::ScrollViewerAutomationPeer*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Automation::Peers::IScrollViewerAutomationPeer), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::Automation::Peers::IScrollViewerAutomationPeer*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Automation::Provider::IScrollProvider), sizeof(IID)) == 0)
    {
...
IFACEMETHODIMP DirectUI::ScrollViewerAutomationPeerGenerated::Scroll(ABI::Microsoft::UI::Xaml::Automation::ScrollAmount horizontalAmount, ABI::Microsoft::UI::Xaml::Automation::ScrollAmount verticalAmount)
{
    ...
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "ScrollViewerAutomationPeer_Scroll", 0);
    }
...
Cleanup:
    ...
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "ScrollViewerAutomationPeer_Scroll", hr);
    }
    RRETURN(hr);
}
IFACEMETHODIMP DirectUI::ScrollViewerAutomationPeerGenerated::SetScrollPercent(DOUBLE horizontalPercent, DOUBLE verticalPercent)
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "ScrollViewerAutomationPeer_SetScrollPercent", 0);
    }
...
Cleanup:
    if (EventEnabledApiFunctionCallStop())
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "ScrollViewerAutomationPeer_SetScrollPercent", hr);
    }
    RRETURN(hr);
}
...
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Automation::Peers::IScrollViewerAutomationPeerFactory), sizeof(IID)) == 0)
    {
