...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::FontIconSource), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::FontIconSource*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::IFontIconSource), sizeof(IID)) == 0)
    {
...
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::IFontIconSourceFactory), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::Controls::IFontIconSourceFactory*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::IFontIconSourceStatics), sizeof(IID)) == 0)
    {
