...
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics2), sizeof(IID)) == 0)
    {
