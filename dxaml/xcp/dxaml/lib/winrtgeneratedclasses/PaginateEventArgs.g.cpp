...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::PaginateEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::PaginateEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Printing::IPaginateEventArgs), sizeof(IID)) == 0)
    {
