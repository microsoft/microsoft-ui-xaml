...
namespace DirectUI
{
    ...
    // care.
    class __declspec(novtable) SemanticZoomLocationFactory:
       public ctl::AggregableActivationFactory<DirectUI::SemanticZoomLocation>
        , public ABI::Microsoft::UI::Xaml::Controls::ISemanticZoomLocationFactory
    {
        BEGIN_INTERFACE_MAP(SemanticZoomLocationFactory, ctl::AggregableActivationFactory<DirectUI::SemanticZoomLocation>)
            INTERFACE_ENTRY(SemanticZoomLocationFactory, ABI::Microsoft::UI::Xaml::Controls::ISemanticZoomLocationFactory)
        END_INTERFACE_MAP(SemanticZoomLocationFactory, ctl::AggregableActivationFactory<DirectUI::SemanticZoomLocation>)

    public:
        // Factory methods.
        IFACEMETHOD(CreateInstance)(_In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Controls::ISemanticZoomLocation** ppInstance);
