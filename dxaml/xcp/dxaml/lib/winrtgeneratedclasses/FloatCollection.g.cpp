...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::FloatCollection), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::FloatCollection*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Windows::Foundation::Collections::IVector<FLOAT>), sizeof(IID)) == 0)
    {
