...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::Thumb), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::Thumb*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::Primitives::IThumb), sizeof(IID)) == 0)
    {
...
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::Primitives::IThumbStatics), sizeof(IID)) == 0)
    {
