...
HRESULT DirectUI::FlyoutPresenterAutomationPeerFactory::QueryInterfaceImpl(_In_ REFIID iid, _Outptr_ void** ppObject)
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Automation::Peers::IFlyoutPresenterAutomationPeerFactory), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::Automation::Peers::IFlyoutPresenterAutomationPeerFactory*>(this);
    }
    else
    {
...
// Factory methods.
IFACEMETHODIMP DirectUI::FlyoutPresenterAutomationPeerFactory::CreateInstanceWithOwner(_In_ ABI::Microsoft::UI::Xaml::Controls::IFlyoutPresenter* pOwner, _In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Automation::Peers::IFlyoutPresenterAutomationPeer** ppInstance)
{
    HRESULT hr = S_OK;
...
namespace DirectUI
{
    ...
    {
        RRETURN(ctl::ActivationFactoryCreator<FlyoutPresenterAutomationPeerFactory>::CreateActivationFactory());
    }
}
