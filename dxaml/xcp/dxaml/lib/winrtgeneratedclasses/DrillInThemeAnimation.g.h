...
#define __DrillInThemeAnimation_GUID "c506929a-4ad1-4ea8-aa14-77bd5384961c"

namespace DirectUI
{
    class DrillInThemeAnimation;

    class __declspec(novtable) DrillInThemeAnimationGenerated:
        public DirectUI::DynamicTimeline
        , public ABI::Microsoft::UI::Xaml::Media::Animation::IDrillInThemeAnimation
    {
        friend class DirectUI::DrillInThemeAnimation;

        INSPECTABLE_CLASS(L"Microsoft.UI.Xaml.Media.Animation.DrillInThemeAnimation");

        BEGIN_INTERFACE_MAP(DrillInThemeAnimationGenerated, DirectUI::DynamicTimeline)
            INTERFACE_ENTRY(DrillInThemeAnimationGenerated, ABI::Microsoft::UI::Xaml::Media::Animation::IDrillInThemeAnimation)
        END_INTERFACE_MAP(DrillInThemeAnimationGenerated, DirectUI::DynamicTimeline)

    public:
        DrillInThemeAnimationGenerated();
        ~DrillInThemeAnimationGenerated() override;
...
namespace DirectUI
{
    ...
    // care.
    class __declspec(novtable) DrillInThemeAnimationFactory:
       public ctl::BetterCoreObjectActivationFactory
        , public ABI::Microsoft::UI::Xaml::Media::Animation::IDrillInThemeAnimationStatics
    {
        BEGIN_INTERFACE_MAP(DrillInThemeAnimationFactory, ctl::BetterCoreObjectActivationFactory)
            INTERFACE_ENTRY(DrillInThemeAnimationFactory, ABI::Microsoft::UI::Xaml::Media::Animation::IDrillInThemeAnimationStatics)
        END_INTERFACE_MAP(DrillInThemeAnimationFactory, ctl::BetterCoreObjectActivationFactory)
