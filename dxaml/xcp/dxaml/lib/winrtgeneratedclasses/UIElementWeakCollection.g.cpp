...
HRESULT DirectUI::UIElementWeakCollectionFactory::QueryInterfaceImpl(_In_ REFIID iid, _Outptr_ void** ppObject)
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IUIElementWeakCollectionFactory), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::IUIElementWeakCollectionFactory*>(this);
    }
    else
    {
...
// Factory methods.
IFACEMETHODIMP DirectUI::UIElementWeakCollectionFactory::CreateInstance(_In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Windows::Foundation::Collections::IVector<ABI::Microsoft::UI::Xaml::UIElement*>** ppInstance)
{
...
namespace DirectUI
{
    ...
    {
        RRETURN(ctl::ActivationFactoryCreator<UIElementWeakCollectionFactory>::CreateActivationFactory());
    }
}
