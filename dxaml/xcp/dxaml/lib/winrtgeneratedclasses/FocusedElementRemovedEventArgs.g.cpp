...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::FocusedElementRemovedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::FocusedElementRemovedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Input::IFocusedElementRemovedEventArgs), sizeof(IID)) == 0)
    {
