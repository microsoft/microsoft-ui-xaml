...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::NoFocusCandidateFoundEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::NoFocusCandidateFoundEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Input::INoFocusCandidateFoundEventArgs), sizeof(IID)) == 0)
    {
