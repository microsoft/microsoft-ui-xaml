...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::CleanUpVirtualizedItemEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::CleanUpVirtualizedItemEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::ICleanUpVirtualizedItemEventArgs), sizeof(IID)) == 0)
    {
