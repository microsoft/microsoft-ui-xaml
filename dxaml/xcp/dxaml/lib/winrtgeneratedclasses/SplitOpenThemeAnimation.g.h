...
#define __SplitOpenThemeAnimation_GUID "2b3d1dda-2942-436b-888f-8d9818b268a0"

namespace DirectUI
{
    class SplitOpenThemeAnimation;

    class __declspec(novtable) SplitOpenThemeAnimationGenerated:
        public DirectUI::DynamicTimeline
        , public ABI::Microsoft::UI::Xaml::Media::Animation::ISplitOpenThemeAnimation
    {
        friend class DirectUI::SplitOpenThemeAnimation;

        INSPECTABLE_CLASS(L"Microsoft.UI.Xaml.Media.Animation.SplitOpenThemeAnimation");

        BEGIN_INTERFACE_MAP(SplitOpenThemeAnimationGenerated, DirectUI::DynamicTimeline)
            INTERFACE_ENTRY(SplitOpenThemeAnimationGenerated, ABI::Microsoft::UI::Xaml::Media::Animation::ISplitOpenThemeAnimation)
        END_INTERFACE_MAP(SplitOpenThemeAnimationGenerated, DirectUI::DynamicTimeline)

    public:
        SplitOpenThemeAnimationGenerated();
        ~SplitOpenThemeAnimationGenerated() override;

        // Event source typedefs.

        KnownTypeIndex GetTypeIndex() const override
        {
            return KnownTypeIndex::SplitOpenThemeAnimation;
        }
...
namespace DirectUI
{
    ...
    // care.
    class __declspec(novtable) SplitOpenThemeAnimationFactory:
       public ctl::BetterCoreObjectActivationFactory
        , public ABI::Microsoft::UI::Xaml::Media::Animation::ISplitOpenThemeAnimationStatics
    {
        BEGIN_INTERFACE_MAP(SplitOpenThemeAnimationFactory, ctl::BetterCoreObjectActivationFactory)
            INTERFACE_ENTRY(SplitOpenThemeAnimationFactory, ABI::Microsoft::UI::Xaml::Media::Animation::ISplitOpenThemeAnimationStatics)
        END_INTERFACE_MAP(SplitOpenThemeAnimationFactory, ctl::BetterCoreObjectActivationFactory)
