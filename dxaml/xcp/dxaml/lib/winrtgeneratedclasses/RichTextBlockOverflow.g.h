...
namespace DirectUI
{
    ...
    class __declspec(novtable) RichTextBlockOverflowFactory:
       public ctl::BetterAggregableCoreObjectActivationFactory
        , public ABI::Microsoft::UI::Xaml::Controls::IRichTextBlockOverflowFactory
        , public ABI::Microsoft::UI::Xaml::Controls::IRichTextBlockOverflowStatics
    {
        BEGIN_INTERFACE_MAP(RichTextBlockOverflowFactory, ctl::BetterAggregableCoreObjectActivationFactory)
            INTERFACE_ENTRY(RichTextBlockOverflowFactory, ABI::Microsoft::UI::Xaml::Controls::IRichTextBlockOverflowFactory)
            INTERFACE_ENTRY(RichTextBlockOverflowFactory, ABI::Microsoft::UI::Xaml::Controls::IRichTextBlockOverflowStatics)
        END_INTERFACE_MAP(RichTextBlockOverflowFactory, ctl::BetterAggregableCoreObjectActivationFactory)

    public:
        // Factory methods.
        IFACEMETHOD(CreateInstance)(_In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Controls::IRichTextBlockOverflow** ppInstance);
