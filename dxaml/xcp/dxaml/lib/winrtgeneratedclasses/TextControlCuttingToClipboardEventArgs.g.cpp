...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::TextControlCuttingToClipboardEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::TextControlCuttingToClipboardEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::ITextControlCuttingToClipboardEventArgs), sizeof(IID)) == 0)
    {
