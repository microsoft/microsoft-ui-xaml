...
#define __ScaleTransform_GUID "9392595f-8bdb-43df-b216-64f488c6549c"

namespace DirectUI
{
    class ScaleTransform;

    class __declspec(novtable) __declspec(uuid(__ScaleTransform_GUID)) ScaleTransform:
        public DirectUI::Transform
        , public ABI::Microsoft::UI::Xaml::Media::IScaleTransform
    {

        INSPECTABLE_CLASS(L"Microsoft.UI.Xaml.Media.ScaleTransform");

        BEGIN_INTERFACE_MAP(ScaleTransform, DirectUI::Transform)
            INTERFACE_ENTRY(ScaleTransform, ABI::Microsoft::UI::Xaml::Media::IScaleTransform)
        END_INTERFACE_MAP(ScaleTransform, DirectUI::Transform)
    ...
    public:
        ...
        {
            return KnownTypeIndex::ScaleTransform;
        }
...
namespace DirectUI
{
    ...
    // care.
    class __declspec(novtable) ScaleTransformFactory:
       public ctl::BetterCoreObjectActivationFactory
        , public ABI::Microsoft::UI::Xaml::Media::IScaleTransformStatics
    {
        BEGIN_INTERFACE_MAP(ScaleTransformFactory, ctl::BetterCoreObjectActivationFactory)
            INTERFACE_ENTRY(ScaleTransformFactory, ABI::Microsoft::UI::Xaml::Media::IScaleTransformStatics)
        END_INTERFACE_MAP(ScaleTransformFactory, ctl::BetterCoreObjectActivationFactory)
