...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::ExecuteRequestedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::ExecuteRequestedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Input::IExecuteRequestedEventArgs), sizeof(IID)) == 0)
    {
    ...
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Input::IExecuteRequestedEventArgsFeature_CommandingImprovements), sizeof(IID)) == 0 && Feature_CommandingImprovements::IsEnabled())
    {
