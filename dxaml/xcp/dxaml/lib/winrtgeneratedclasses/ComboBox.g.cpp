...
IFACEMETHODIMP DirectUI::ComboBoxGenerated::OnBackButtonPressed(_Out_ BOOLEAN* pResult)
{
    ...
    {
        ApiEtwStart(this, KnownMethodIndex::ComboBox_OnBackButtonPressed);
    }
...
IFACEMETHODIMP DirectUI::ComboBoxGenerated::OnDropDownClosed(_In_ IInspectable* pE)
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        ApiEtwStart(this, KnownMethodIndex::ComboBox_OnDropDownClosed);
    }
    ARG_NOTNULL(pE, "e");
    IFC(CheckThread());
    IFC(DefaultStrictApiCheck(this));
...
IFACEMETHODIMP DirectUI::ComboBoxGenerated::OnDropDownOpened(_In_ IInspectable* pE)
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        ApiEtwStart(this, KnownMethodIndex::ComboBox_OnDropDownOpened);
    }
    ARG_NOTNULL(pE, "e");
    IFC(CheckThread());
    IFC(DefaultStrictApiCheck(this));
