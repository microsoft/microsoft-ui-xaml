...
namespace DirectUI
{
    ...
    class __declspec(novtable) ImageFactory:
       public ctl::BetterAggregableCoreObjectActivationFactory
        , public ABI::Microsoft::UI::Xaml::Controls::IImageFactory
        , public ABI::Microsoft::UI::Xaml::Controls::IImageStatics
    {
        BEGIN_INTERFACE_MAP(ImageFactory, ctl::BetterAggregableCoreObjectActivationFactory)
            INTERFACE_ENTRY(ImageFactory, ABI::Microsoft::UI::Xaml::Controls::IImageFactory)
            INTERFACE_ENTRY(ImageFactory, ABI::Microsoft::UI::Xaml::Controls::IImageStatics)
        END_INTERFACE_MAP(ImageFactory, ctl::BetterAggregableCoreObjectActivationFactory)

    public:
        // Factory methods.
        IFACEMETHOD(CreateInstance)(_In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Controls::IImage** ppInstance);
