...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::Window), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::Window*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IWindow), sizeof(IID)) == 0)
    {
    ...
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IWindowPrivate), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::IWindowPrivate*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IWindow2), sizeof(IID)) == 0)
    {
        *ppObject = ctl::interface_cast<ABI::Microsoft::UI::Xaml::IWindow2>(this);
    }
#if WI_IS_FEATURE_PRESENT(Feature_ExperimentalApi)
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IWindowFeature_ExperimentalApi), sizeof(IID)) == 0 && Feature_ExperimentalApi::IsEnabled())
    {
...
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IWindowFactory), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::IWindowFactory*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::IWindowStatics), sizeof(IID)) == 0)
    {
