...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::BlockCollection), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::BlockCollection*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Windows::Foundation::Collections::IVector<ABI::Microsoft::UI::Xaml::Documents::Block*>), sizeof(IID)) == 0)
    {
