...
IFACEMETHODIMP DirectUI::CalendarLayoutStrategyGenerated::EstimatePanelExtent(ABI::Microsoft::UI::Xaml::Controls::EstimationReference lastHeaderReference, ABI::Microsoft::UI::Xaml::Controls::EstimationReference lastContainerReference, ABI::Windows::Foundation::Rect windowConstraint, _Out_ ABI::Windows::Foundation::Size* pResult)
{
    HRESULT hr = S_OK;
    if (EventEnabledApiFunctionCallStart())
    {
...
IFACEMETHODIMP DirectUI::CalendarLayoutStrategyGenerated::GetElementMeasureSize(ABI::Microsoft::UI::Xaml::Controls::ElementType elementType, INT elementIndex, ABI::Windows::Foundation::Rect windowConstraint, _Out_ ABI::Windows::Foundation::Size* pResult)
{
    HRESULT hr = S_OK;
    if (EventEnabledApiFunctionCallStart())
    {
...
IFACEMETHODIMP DirectUI::CalendarLayoutStrategyGenerated::GetElementTransitionsBounds(ABI::Microsoft::UI::Xaml::Controls::ElementType elementType, INT elementIndex, ABI::Windows::Foundation::Rect windowConstraint, _Out_ ABI::Windows::Foundation::Rect* pResult)
{
    HRESULT hr = S_OK;
    if (EventEnabledApiFunctionCallStart())
    {
...
IFACEMETHODIMP DirectUI::CalendarLayoutStrategyGenerated::HasIrregularSnapPoints(ABI::Microsoft::UI::Xaml::Controls::ElementType elementType, _Out_ BOOLEAN* pResult)
{
    HRESULT hr = S_OK;
    if (EventEnabledApiFunctionCallStart())
    {
...
IFACEMETHODIMP DirectUI::CalendarLayoutStrategyGenerated::HasSnapPointOnElement(ABI::Microsoft::UI::Xaml::Controls::ElementType elementType, INT elementIndex, _Out_ BOOLEAN* pResult)
{
    HRESULT hr = S_OK;
    if (EventEnabledApiFunctionCallStart())
    {
...
IFACEMETHODIMP DirectUI::CalendarLayoutStrategyGenerated::ShouldContinueFillingUpSpace(ABI::Microsoft::UI::Xaml::Controls::ElementType elementType, INT elementIndex, ABI::Microsoft::UI::Xaml::Controls::LayoutReference referenceInformation, ABI::Windows::Foundation::Rect windowToFill, _Out_ BOOLEAN* pResult)
{
    HRESULT hr = S_OK;
    if (EventEnabledApiFunctionCallStart())
    {
