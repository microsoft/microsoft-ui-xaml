...
namespace DirectUI
{
    ...
    class __declspec(novtable) ViewboxFactory:
       public ctl::BetterAggregableCoreObjectActivationFactory
        , public ABI::Microsoft::UI::Xaml::Controls::IViewboxFactory
        , public ABI::Microsoft::UI::Xaml::Controls::IViewboxStatics
    {
        BEGIN_INTERFACE_MAP(ViewboxFactory, ctl::BetterAggregableCoreObjectActivationFactory)
            INTERFACE_ENTRY(ViewboxFactory, ABI::Microsoft::UI::Xaml::Controls::IViewboxFactory)
            INTERFACE_ENTRY(ViewboxFactory, ABI::Microsoft::UI::Xaml::Controls::IViewboxStatics)
        END_INTERFACE_MAP(ViewboxFactory, ctl::BetterAggregableCoreObjectActivationFactory)

    public:
        // Factory methods.
        IFACEMETHOD(CreateInstance)(_In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Controls::IViewbox** ppInstance);
