...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::PerspectiveTransform3D), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::PerspectiveTransform3D*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Media::Media3D::IPerspectiveTransform3D), sizeof(IID)) == 0)
    {
