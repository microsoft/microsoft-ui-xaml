...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::QuadraticEase), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::QuadraticEase*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Media::Animation::IQuadraticEase), sizeof(IID)) == 0)
    {
