...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::SizeChangedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::SizeChangedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::ISizeChangedEventArgs), sizeof(IID)) == 0)
    {
