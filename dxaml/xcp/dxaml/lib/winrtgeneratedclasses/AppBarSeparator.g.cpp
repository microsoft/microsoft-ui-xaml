...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::AppBarSeparator), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::AppBarSeparator*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::IAppBarSeparator), sizeof(IID)) == 0)
    {
...
IFACEMETHODIMP DirectUI::AppBarSeparatorGenerated::put_DynamicOverflowOrder(INT value)
{
...
IFACEMETHODIMP DirectUI::AppBarSeparatorGenerated::put_IsCompact(BOOLEAN value)
{
    IFC_RETURN(DefaultStrictApiCheck(this));
...
IFACEMETHODIMP DirectUI::AppBarSeparatorGenerated::put_UseOverflowStyle(BOOLEAN value)
{
    IFC_RETURN(DefaultStrictApiCheck(this));
...
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::IAppBarSeparatorFactory), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<ABI::Microsoft::UI::Xaml::Controls::IAppBarSeparatorFactory*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::IAppBarSeparatorStatics), sizeof(IID)) == 0)
    {
