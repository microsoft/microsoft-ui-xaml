...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::ComboBoxAutomationPeer), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::ComboBoxAutomationPeer*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Automation::Peers::IComboBoxAutomationPeer), sizeof(IID)) == 0)
    {
...
IFACEMETHODIMP DirectUI::ComboBoxAutomationPeerGenerated::Close()
{
    ...
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_Close", 0);
    }
...
Cleanup:
    ...
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_Close", hr);
    }
    RRETURN(hr);
}
IFACEMETHODIMP DirectUI::ComboBoxAutomationPeerGenerated::Collapse()
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_Collapse", 0);
    }
...
Cleanup:
    if (EventEnabledApiFunctionCallStop())
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_Collapse", hr);
    }
    RRETURN(hr);
}
IFACEMETHODIMP DirectUI::ComboBoxAutomationPeerGenerated::Expand()
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_Expand", 0);
    }
...
Cleanup:
    if (EventEnabledApiFunctionCallStop())
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_Expand", hr);
    }
    RRETURN(hr);
}
IFACEMETHODIMP DirectUI::ComboBoxAutomationPeerGenerated::SetValue(_In_ HSTRING value)
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_SetValue", 0);
    }
...
Cleanup:
    if (EventEnabledApiFunctionCallStop())
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_SetValue", hr);
    }
    RRETURN(hr);
}
IFACEMETHODIMP DirectUI::ComboBoxAutomationPeerGenerated::SetVisualState(ABI::Microsoft::UI::Xaml::Automation::WindowVisualState state)
{
    ...
    if (EventEnabledApiFunctionCallStart())
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_SetVisualState", 0);
    }
...
Cleanup:
    if (EventEnabledApiFunctionCallStop())
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_SetVisualState", hr);
    }
    RRETURN(hr);
}
...
Cleanup:
    if (EventEnabledApiFunctionCallStop())
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "ComboBoxAutomationPeer_WaitForInputIdle", hr);
    }
    RRETURN(hr);
}
...
{
    if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Automation::Peers::IComboBoxAutomationPeerFactory), sizeof(IID)) == 0)
    {
