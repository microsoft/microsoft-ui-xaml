...
IFACEMETHODIMP DirectUI::SplitViewLightDismissAutomationPeerGenerated::Invoke()
{
    ...
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "SplitViewLightDismissAutomationPeer_Invoke", 0);
    }
...
Cleanup:
    ...
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "SplitViewLightDismissAutomationPeer_Invoke", hr);
    }
    RRETURN(hr);
}
