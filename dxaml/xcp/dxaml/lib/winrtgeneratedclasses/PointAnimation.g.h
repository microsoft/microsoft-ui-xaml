...
namespace DirectUI
{
    ...
    public:
        ...
        IFACEMETHOD(put_By)(ABI::Windows::Foundation::IReference<ABI::Windows::Foundation::Point>* pValue) override;
        ...
        IFACEMETHOD(put_From)(ABI::Windows::Foundation::IReference<ABI::Windows::Foundation::Point>* pValue) override;
        IFACEMETHOD(get_To)(_Out_ ABI::Windows::Foundation::IReference<ABI::Windows::Foundation::Point>** ppValue) override;
        IFACEMETHOD(put_To)(ABI::Windows::Foundation::IReference<ABI::Windows::Foundation::Point>* pValue) override;
