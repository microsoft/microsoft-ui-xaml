...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::DoubleTappedRoutedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::DoubleTappedRoutedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Input::IDoubleTappedRoutedEventArgs), sizeof(IID)) == 0)
    {
...
IFACEMETHODIMP DirectUI::DoubleTappedRoutedEventArgs::put_Handled(BOOLEAN value)
{
    HRESULT hr = S_OK;
    CEventArgs* pCoreEventArgsNoRef = nullptr;
