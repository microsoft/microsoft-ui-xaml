...
namespace DirectUI
{
    ...
    public:
        ...
        IFACEMETHOD(put_By)(ABI::Windows::Foundation::IReference<DOUBLE>* pValue) override;
        ...
        IFACEMETHOD(put_From)(ABI::Windows::Foundation::IReference<DOUBLE>* pValue) override;
        IFACEMETHOD(get_To)(_Out_ ABI::Windows::Foundation::IReference<DOUBLE>** ppValue) override;
        IFACEMETHOD(put_To)(ABI::Windows::Foundation::IReference<DOUBLE>* pValue) override;
