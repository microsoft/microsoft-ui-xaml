...
namespace DirectUI
{
    ...
    public:
        ...
        IFACEMETHOD(put_CanDragItems)(BOOLEAN value) override;
        IFACEMETHOD(get_CanReorderItems)(_Out_ BOOLEAN* pValue) override;
        IFACEMETHOD(put_CanReorderItems)(BOOLEAN value) override;
        IFACEMETHOD(get_DataFetchSize)(_Out_ DOUBLE* pValue) override;
        IFACEMETHOD(put_DataFetchSize)(DOUBLE value) override;
        ...
        IFACEMETHOD(put_IncrementalLoadingThreshold)(DOUBLE value) override;
        IFACEMETHOD(get_IncrementalLoadingTrigger)(_Out_ ABI::Microsoft::UI::Xaml::Controls::IncrementalLoadingTrigger* pValue) override;
        IFACEMETHOD(put_IncrementalLoadingTrigger)(ABI::Microsoft::UI::Xaml::Controls::IncrementalLoadingTrigger value) override;
        ...
        IFACEMETHOD(put_IsItemClickEnabled)(BOOLEAN value) override;
        IFACEMETHOD(get_IsMultiSelectCheckBoxEnabled)(_Out_ BOOLEAN* pValue) override;
        IFACEMETHOD(put_IsMultiSelectCheckBoxEnabled)(BOOLEAN value) override;
        ...
        IFACEMETHOD(put_IsSwipeEnabled)(BOOLEAN value) override;
        ...
        IFACEMETHOD(put_ReorderMode)(ABI::Microsoft::UI::Xaml::Controls::ListViewReorderMode value) override;
        ...
        IFACEMETHOD(put_SelectionMode)(ABI::Microsoft::UI::Xaml::Controls::ListViewSelectionMode value) override;
        ...
        IFACEMETHOD(put_ShowsScrollingPlaceholders)(BOOLEAN value) override;
        ...
        IFACEMETHOD(remove_ChoosingGroupHeaderContainer)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_ChoosingItemContainer)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_ContainerContentChanging)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_DragItemsCompleted)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_DragItemsStarting)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_ItemClick)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(ScrollIntoViewWithAlignment)(_In_ IInspectable* pItem, ABI::Microsoft::UI::Xaml::Controls::ScrollIntoViewAlignment alignment) override;
        IFACEMETHOD(ScrollIntoViewWithOptionalAnimation)(_In_ IInspectable* pItem, ABI::Microsoft::UI::Xaml::Controls::ScrollIntoViewAlignment alignment, BOOLEAN disableAnimation) override;
        ...
        IFACEMETHOD(SetDesiredContainerUpdateDuration)(ABI::Windows::Foundation::TimeSpan duration) override;
