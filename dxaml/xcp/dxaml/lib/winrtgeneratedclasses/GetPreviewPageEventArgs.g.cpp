...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::GetPreviewPageEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::GetPreviewPageEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Printing::IGetPreviewPageEventArgs), sizeof(IID)) == 0)
    {
