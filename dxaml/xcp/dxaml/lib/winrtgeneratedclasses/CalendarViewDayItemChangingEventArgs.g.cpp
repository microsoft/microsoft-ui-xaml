...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::CalendarViewDayItemChangingEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::CalendarViewDayItemChangingEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::ICalendarViewDayItemChangingEventArgs), sizeof(IID)) == 0)
    {
