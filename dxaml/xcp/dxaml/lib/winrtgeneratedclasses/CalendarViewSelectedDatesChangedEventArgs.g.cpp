...
{
    if (std::memcmp(&iid, &__uuidof(DirectUI::CalendarViewSelectedDatesChangedEventArgs), sizeof(IID)) == 0)
    {
        *ppObject = static_cast<DirectUI::CalendarViewSelectedDatesChangedEventArgs*>(this);
    }
    else if (std::memcmp(&iid, &__uuidof(ABI::Microsoft::UI::Xaml::Controls::ICalendarViewSelectedDatesChangedEventArgs), sizeof(IID)) == 0)
    {
