...
namespace DirectUI
{
    ...
    public:
        ...
        _Check_return_ HRESULT CreateIslandRootImpl(_Outptr_ xaml_hosting::IXamlIslandRoot** returnIsland);
        _Check_return_ HRESULT CreateIslandRootWithContentBridgeImpl(_In_ IInspectable* owner, _In_ IInspectable* contentBridge, _Outptr_ xaml_hosting::IXamlIslandRoot** returnValue);
        _Check_return_ HRESULT RemoveIslandImpl(_In_ xaml_hosting::IXamlIslandRoot* value);
        ...
        _Check_return_ HRESULT get_ShutdownModelImpl(_Out_ xaml::ShutdownModel* value);
        _Check_return_ HRESULT put_ShutdownModelImpl(_In_ xaml::ShutdownModel value);
        ...
        static xaml::ShutdownModel GetCurrentShutdownModel()
        {
            xaml::ShutdownModel model {DefaultShutdownModel};
            if (auto app = GetCurrentNoRef())
            {
                IFCFAILFAST(app->get_ShutdownModelImpl(&model));
            }
            return model;
        }
    ...
    private:
        ...
        static constexpr xaml::ShutdownModel DefaultShutdownModel { xaml::ShutdownModel_Version2 };
        xaml::ShutdownModel m_shutdownModel { DefaultShutdownModel };
    };
