...
_Check_return_ HRESULT FrameworkApplication::CreateIslandImpl(_Outptr_ xaml_hosting::IXamlIsland** returnValue)
{
    ...
    ctl::ComPtr<DirectUI::XamlIsland> newIsland;
    IFC_RETURN(ctl::make<DirectUI::XamlIsland>(nullptr, &newIsland));
...
_Check_return_ HRESULT FrameworkApplication::CreateIslandWithContentBridgeImpl(_In_ IInspectable* owner, _In_ IInspectable* contentBridge, _Outptr_ xaml_hosting::IXamlIsland** returnValue)
{
    auto dxamlCore = DXamlCore::GetCurrent();
    ...
    newIsland.Cast<DirectUI::XamlIsland>()->SetOwner(owner);

    return S_OK;
}

_Check_return_ HRESULT FrameworkApplication::RemoveIslandImpl(_In_ xaml_hosting::IXamlIsland* value)
{
    auto xamlIslandRoot = static_cast<CXamlIslandRoot*>(static_cast<DirectUI::XamlIsland*>(value)->GetHandle());
...
_Check_return_ HRESULT FrameworkApplication::put_FocusVisualKindImpl(_In_ xaml::FocusVisualKind value)
{
    if (m_focusVisualKind != value)
    {
        ...
        auto dxamlCore = DXamlCore::GetCurrent();
        if (dxamlCore) // May be null during initialization of XamlIsland in some legacy test scenarios.
        {
