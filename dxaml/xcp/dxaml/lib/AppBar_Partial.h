...
namespace DirectUI
{
    ...
    protected:
        ...
        _Check_return_ HRESULT GetShouldOpenUp(_Out_ bool* shouldOpenUp);

        virtual _Check_return_ HRESULT GetVerticalOffsetNeededToOpenInDefaultDirection(_Out_ double* neededOffset, _Out_ bool* opensWindowed);
