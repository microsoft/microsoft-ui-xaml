...
_Check_return_ HRESULT
CommandBar::GetVerticalOffsetNeededToOpenInDefaultDirection(_Out_ double* neededOffset, _Out_ bool* opensWindowed)
{
    IFC_RETURN(__super::GetVerticalOffsetNeededToOpenInDefaultDirection(neededOffset, opensWindowed));
