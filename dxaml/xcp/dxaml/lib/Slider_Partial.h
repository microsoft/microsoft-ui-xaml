...
namespace DirectUI
{
    ...
    private:
        ...
        BOOLEAN m_isSeekSlider{ false };
        wf::TimeSpan m_currentPosition;
        wf::TimeSpan m_currentDuration;
    ...
    public:
        ...
        void SetIsSeekSlider(_In_ BOOLEAN isSeekSlider);
        void SetCurrentPosition(_In_ const wf::TimeSpan& position, _In_ const wf::TimeSpan& duration);
        wf::TimeSpan GetCurrentPosition();
        wf::TimeSpan GetCurrentDuration();
