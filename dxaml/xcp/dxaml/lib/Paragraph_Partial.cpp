...
IFACEMETHODIMP
DirectUI::Paragraph::OnDisconnectVisualChildren()
{
    HRESULT hr = S_OK;
    ...
    IFC( ParagraphGenerated::OnDisconnectVisualChildren() );
...
_Check_return_ HRESULT Paragraph::AppendAutomationPeerChildren(_In_ wfc::IVector<xaml_automation_peers::AutomationPeer*>* pAutomationPeerChildren, _In_ INT startPos, _In_ INT endPos)
{
    HRESULT hr = S_OK;
    UINT count = 0;
