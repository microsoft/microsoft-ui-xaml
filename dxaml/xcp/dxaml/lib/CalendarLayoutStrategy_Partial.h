...
namespace DirectUI
{
    ...
    PARTIAL_CLASS(CalendarLayoutStrategy)
    {
    public:
        ...
        void SetViewportSize(_In_ wf::Size size, _Out_ bool* pNeedsRemeasure) { _layoutStrategyImpl.SetViewportSize(size, pNeedsRemeasure); }

        void SetItemMinimumSize(_In_ wf::Size size, _Out_ bool* pNeedsRemeasure) { _layoutStrategyImpl.SetItemMinimumSize(size, pNeedsRemeasure); }

        void SetRows(_In_ int rows) { _layoutStrategyImpl.SetRows(rows); }

        void SetCols(_In_ int cols) { _layoutStrategyImpl.SetCols(cols); }
        ...
        _Check_return_ HRESULT SetSnapPointFilterFunction(
            _In_ std::function<HRESULT(_In_ int itemIndex, _Out_ bool* pHasSnapPoint)> func);

    private:
        Components::Moco::CalendarLayoutStrategyImpl _layoutStrategyImpl;
