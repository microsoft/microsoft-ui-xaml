...
namespace DirectUI
{
    PARTIAL_CLASS(WrappingLayoutStrategy)
    {
    protected:
        WrappingLayoutStrategy() = default;
    ...
    public:
        ...
        DOUBLE GetItemsPerPage(_In_ wf::Rect window);
        ...
        void SetMaximumRowsOrColumns(_In_ INT maxRowsOrColumns) { _layoutStrategyImpl.SetMaximumRowsOrColumns(maxRowsOrColumns); }
        void SetItemWidth(_In_ DOUBLE itemWidth) { _layoutStrategyImpl.SetItemWidth(itemWidth); }
        void SetItemHeight(_In_ DOUBLE itemHeight) { _layoutStrategyImpl.SetItemHeight(itemHeight); }
    ...
    private:
        Components::Moco::WrappingLayoutStrategyImpl _layoutStrategyImpl;
