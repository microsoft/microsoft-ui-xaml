...
namespace DirectUI
{
    ...
    private:
        ...
        bool HasPrimaryCommands();

        _Check_return_ HRESULT HasSpaceForOverflowPopupToOpenDown(_Out_ bool* hasSpace);
        ...
        _Check_return_ HRESULT UpdateOverflowButtonAutomationSetNumbers(INT sizeOfSet);
        ...
        _Check_return_ HRESULT IsOverflowButtonVisible(
        ...
        // Last AutomationProperty::SizeInSet value recorded in UpdateOverflowButtonAutomationSetNumbers
        INT                                 m_automationSizeOfSet = 0;
