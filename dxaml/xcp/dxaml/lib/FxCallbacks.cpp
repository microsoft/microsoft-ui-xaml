...
namespace FxCallbacks
{
    ...
    void XamlIsland_OnSizeChanged(_In_ CXamlIslandRoot* xamlIsland)
        { DirectUI::XamlIsland::OnSizeChangedStatic(xamlIsland); }

    _Check_return_ HRESULT FrameworkApplication_RemoveIsland(_In_ xaml_hosting::IXamlIsland* island)
    {
    ...
    CXamlIslandRoot* GetXamlIslandRootFromXamlIsland(_In_ xaml_hosting::IXamlIsland* xamlIsland)
    {
        ctl::ComPtr<XamlIsland> spXamlIsland;
        IGNOREHR(ctl::do_query_interface(spXamlIsland, xamlIsland));
