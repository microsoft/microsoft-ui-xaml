...
namespace AccessKeys {
    _Check_return_ HRESULT UpdateIsDisplayModeEnabled(_Out_ bool* didDisplayModeForThreadChange)
    {
        ...
        else
        {
            ...
            if (const auto contentRoot = contentRootCoordinator->Unsafe_XamlIslandsIncompatible_CoreWindowContentRoot())
            {
...
_Check_return_ HRESULT AccessKeyManagerFactory::ExitDisplayModeImpl()
{
    ...
    else
    {
        ...
        const auto contentRoot = contentRootCoordinator->Unsafe_XamlIslandsIncompatible_CoreWindowContentRoot();
