...
namespace DirectUI
{
    ...
    public:
        ...
        _Check_return_ HRESULT SetFocusAfterExitingFullWindowMode();

        _Check_return_ HRESULT RemoveFromFullWindowMediaRoot();

        _Check_return_ HRESULT HandleSeekCompleted();
    ...
    private:
        ...
        _Check_return_ HRESULT UpdatePlayPauseButton(
    ...
    private:
        ...
        _Check_return_ HRESULT SubscribePositionChangedEvents();
        _Check_return_ HRESULT UnSubscribePositionChangedEvents();
        ...
        EventRegistrationToken m_mediaPlayerSeekCompletedToken;
