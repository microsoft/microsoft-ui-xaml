    ...
    case wfc::CollectionChange_ItemInserted:
        {
            ...
            if (m_iFocusedIndex >= static_cast<int>(itemIndex))
            {
                ...
                m_lastFocusedIndex = ++m_iFocusedIndex;
            }
    ...
    _In_ wfc::IVectorChangedEventArgs* e)
{
    ...
    switch (action)
    {
        case wfc::CollectionChange_ItemRemoved:
        {
            ...
            else if (m_iFocusedIndex == -1 && itemsCount > 0 && m_lastFocusedIndex >= static_cast<int>(itemsCount))
            {
                m_lastFocusedIndex = 0;
            }
        }
    ...
    _In_ xaml::Controls::IFocusEngagedEventArgs* pArgs)
{
    ...
    if (hasItems)
    {
        IFC_RETURN(SetFocusedItem(m_lastFocusedIndex, true /*shouldScrollIntoView*/, true /*forceFocus*/, xaml::FocusState_Keyboard));
    }
    ...
    _In_ UINT currentGroupIndex)
{
    ...
    // in this case containerRest will have positive offset. But for CarouselPanel we will have item0 after itemN and item0 will have positive offset too.
    ...
    if (isThinkingInLogicalUnits && !isFooter)
    {
        ...
        IFC(spItemsPresenter.Cast<ItemsPresenter>()->ScrollIntoView(index, isGroupItemIndex, isHeader, pixelOffset, alignment));
    }
    ...
    _Outptr_result_maybenull_ DependencyObject** ppFirstFocusable)
{
    ...
    *ppFirstFocusable = nullptr;
    ...
    if (!m_skipFocusSuggestion)
    {
        ...
        IFC(ContainerFromIndex(static_cast<INT>(m_lastFocusedIndex), &spFirstFocusableResult));
