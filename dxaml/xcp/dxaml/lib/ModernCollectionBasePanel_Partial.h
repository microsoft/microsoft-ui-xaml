...
namespace DirectUI
{
    ...
    private:
        ...
        _Check_return_ HRESULT LayoutPreloadedItems();

        wf::Point GetGarbageElementPosition(_In_ const ctl::ComPtr<IUIElement>& spElement) const;
...
public:
    ...
    public:
        // Currently, Hub wrapping is implemented as a one-off feature, with some specific demands
        // Someday, if we tackle generalized panel carouseling, and port it to Hub, we should be
        // able to remove this pseudo-hack
        void EnableCarouselPreload() { m_enableCarouselPreload = true; }
    ...
    private:
        ...
        // Control whether the panel preloads the first and last items in the collection to support hub wrapping
        // Ideally, once we get generalized carouselling, we can remove this pseudo-hack
        bool m_enableCarouselPreload;
