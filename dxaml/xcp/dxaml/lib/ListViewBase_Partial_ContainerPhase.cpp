...
#ifdef LVB_DEBUG
    IGNOREHR(gps->DebugTrace(XCP_TRACE_OUTPUT_MSG /*traceType*/, L"LVB(%s)[0x%p]: BuildTreeImpl. exit workLeft=%d", ctl::is<xaml_controls::IGridView>(this) ? L"GV" : L"LV", this, *workLeft));
#endif
