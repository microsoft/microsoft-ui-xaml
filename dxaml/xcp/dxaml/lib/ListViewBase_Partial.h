...
// Bug 45397110: Support TabNavigation=Local/Cycle
#define WINAPPSDK_CHANGEID_45397110 45397110
...
namespace DirectUI
{
        ...
        , private DirectManipulationStateChangeHandler
    {
        ...
        private:
            ...
            // that means that items/headers never got focus so far.
            bool m_wasItemOrHeaderFocussed;
            ...
            static bool IsTabNavigationFullySupported()
            {
        ...
        protected:
            ...
            // Handles keyboard navigation for the ListView.  By default this
            // will refer to the ItemsHost Panel to provide layout specific
            // knowledge of keyboard navigation, but also includes generic
            // StackPanel-like behavior if ListView is being used with an
