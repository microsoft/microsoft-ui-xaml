...
namespace DirectUI
{
    PARTIAL_CLASS(ContentDialogButtonClickDeferral)
    {
    public:
        ...
        _Check_return_ HRESULT Initialize(
            _In_ DeferralManager<ContentDialogButtonClickDeferral>* pManager,
    ...
    private:
        ctl::ComPtr<DeferralManager<ContentDialogButtonClickDeferral>> m_spManager;
        bool m_isComplete;
        ULONG m_generation;
    };
}
