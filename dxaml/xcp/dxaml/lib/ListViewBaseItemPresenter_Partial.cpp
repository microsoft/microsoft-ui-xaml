    ...
    _In_opt_ IInspectable* pUnused2)
{
    ...
    if (!m_multiSelectAnimation.pCommand ||
        !static_cast<ListViewBaseItemAnimationCommand_MultiSelect*>(m_multiSelectAnimation.pCommand)->m_entering)
    {
        CListViewBaseItemChrome* pChrome = static_cast<CListViewBaseItemChrome*>(GetHandle());
    ...
    _In_opt_ IInspectable* unused2)
{
    ...
    if (!m_selectionIndicatorAnimation.pCommand ||
        !static_cast<ListViewBaseItemAnimationCommand_SelectionIndicatorVisibility*>(m_selectionIndicatorAnimation.pCommand)->m_selected)
    {
        CListViewBaseItemChrome* chrome = static_cast<CListViewBaseItemChrome*>(GetHandle());
