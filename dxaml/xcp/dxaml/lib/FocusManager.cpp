     ...
     _Outptr_ IInspectable** ppCandidate)
 {
    ...
    *ppCandidate = nullptr;
    ...
    else
    {
        ...
        CContentRoot* contentRoot = contentRootCoordinator->Unsafe_XamlIslandsIncompatible_CoreWindowContentRoot();
    ...
    _Outptr_ xaml::IDependencyObject** ppReturnValue)
{
    ...
    {
        contentRoot = DXamlCore::GetCurrent()->GetHandle()->GetContentRootCoordinator()->Unsafe_XamlIslandsIncompatible_CoreWindowContentRoot();
    }
