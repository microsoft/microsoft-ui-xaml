...
namespace DirectUI
{
    // Represents the ListBoxAutomationPeer
    PARTIAL_CLASS(ListBoxAutomationPeer)
    {
        public:
            // Initializes a new instance of the LisBoxAutomationPeer class.
            ListBoxAutomationPeer();
            ~ListBoxAutomationPeer() override;
