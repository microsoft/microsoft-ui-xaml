...
#pragma warning( suppress: 26451 )  // PREfast does not know we already checked the size of sourceStringLen above. Abstain from adding casting to complicate the code only to make PREfast happy.
