...
XAML_ABI_NAMESPACE_BEGIN namespace Microsoft { namespace UI { namespace Xaml { namespace Controls
{
    class DatePickedEventArgs :
        public DatePickedEventArgsGenerated
    {
    public:
        DatePickedEventArgs() {}
    ...
    private:
        ...
        _Check_return_ HRESULT InitializeImpl() override
        {
            ...
            IFC(DatePickedEventArgsGenerated::InitializeImpl());
            ...
            IFC(spInnerFactory->CreateInstance(
                static_cast<IDatePickedEventArgs*>(this),
    ...
    ActivatableClass(DatePickedEventArgs)
