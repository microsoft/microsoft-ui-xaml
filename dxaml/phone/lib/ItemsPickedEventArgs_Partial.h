...
XAML_ABI_NAMESPACE_BEGIN namespace Microsoft { namespace UI { namespace Xaml { namespace Controls
{
    class ItemsPickedEventArgs :
        public ItemsPickedEventArgsGenerated
    {
    public:
    ...
    private:
        ...
        _Check_return_ HRESULT InitializeImpl() override
        {
            ...
            IFC(ItemsPickedEventArgsGenerated::InitializeImpl());
            ...
            IFC(spInnerFactory->CreateInstance(
                static_cast<IItemsPickedEventArgs*>(this),
    ...
    ActivatableClass(ItemsPickedEventArgs)
