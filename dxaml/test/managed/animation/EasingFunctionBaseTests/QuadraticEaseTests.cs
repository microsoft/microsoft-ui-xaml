...
{
    [TestClass]
    public class QuadraticEaseTests : EasingFunctionTestBase
    {
        [ClassInitialize]
        ...
        [TestMethod]
        [Description("Validates that QuadraticEase easing function can switch easing modes and provide correct output.")]
        public void VerifyQuadraticEase()
        {
            QuadraticEase quadraticEase = null;
            ...
            VerifyCanSwitchEasingModes(quadraticEase);
            ...
            easeGroundTruth.Add(5.0, Tuple.Create(25.0, -15.0, -31.0));
            ...
            VerifyEaseOutput(quadraticEase, easeGroundTruth);
        }
    }
}
