...
{
    [TestClass]
    public class RichTextBlockDerivationTests : XamlTestsBase
    {
        private sealed class DerivedRichTextBlock : XamlControls.RichTextBlock { }
        [ClassInitialize]
        ...
        [TestMethod] public void CanDeriveFromRichTextBlock() { UIExecutor.Execute(() => { _ = new DerivedRichTextBlock(); }); }
    }
}
