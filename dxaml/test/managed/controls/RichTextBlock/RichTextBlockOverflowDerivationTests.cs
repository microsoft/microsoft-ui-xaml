...
{
    [TestClass]
    public class RichTextBlockOverflowDerivationTests : XamlTestsBase
    {
        private sealed class DerivedRichTextBlockOverflow : XamlControls.RichTextBlockOverflow { }
        ...
        {
            UIExecutor.Execute(() => { _ = new DerivedRichTextBlockOverflow(); });
        }
    }
}