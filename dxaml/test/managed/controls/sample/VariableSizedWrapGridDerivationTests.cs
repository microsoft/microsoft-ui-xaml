...
{
    [TestClass]
    public class VariableSizedWrapGridDerivationTests : XamlTestsBase
    {
        private sealed class DerivedVariableSizedWrapGrid : XamlControls.VariableSizedWrapGrid { }
        ...
        {
            UIExecutor.Execute(() => { _ = new DerivedVariableSizedWrapGrid(); });
        }
    }
}