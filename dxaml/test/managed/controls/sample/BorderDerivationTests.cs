...
{
    [TestClass]
    public class BorderDerivationTests : XamlTestsBase
    {
        private sealed class DerivedBorder : XamlControls.Border { }
        ...
        [TestMethod]
        public void CanDeriveFromBorder()
        {
            UIExecutor.Execute(() => { _ = new DerivedBorder(); });
        }
    }
}
