...
{
    [TestClass]
    public class PickerFlyoutDerivationTests : XamlTestsBase
    {
        private sealed class DerivedPickerFlyout : XamlControls.PickerFlyout { }
        [ClassInitialize]
        ...
        {
            UIExecutor.Execute(() => { _ = new DerivedPickerFlyout(); });
        }
    }
}