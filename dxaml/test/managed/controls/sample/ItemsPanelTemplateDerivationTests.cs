...
{
    [TestClass]
    public class ItemsPanelTemplateDerivationTests : XamlTestsBase
    {
        private sealed class DerivedItemsPanelTemplate : XamlControls.ItemsPanelTemplate
        {
        }
        ...
        public void CanDerive()
        {
            UIExecutor.Execute(() =>
            {
                _ = new DerivedItemsPanelTemplate();
            });
        }
    }
}
