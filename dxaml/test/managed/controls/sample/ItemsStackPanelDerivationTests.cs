...
{
    [TestClass]
    public class ItemsStackPanelDerivationTests : XamlTestsBase
    {
        private sealed class DerivedItemsStackPanel : XamlControls.ItemsStackPanel { }
        ...
        {
            UIExecutor.Execute(() => { _ = new DerivedItemsStackPanel(); });
        }
    }
}
