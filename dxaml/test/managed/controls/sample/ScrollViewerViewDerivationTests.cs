...
{
    [TestClass]
    public class ScrollViewerViewDerivationTests : XamlTestsBase
    {
        private sealed class DerivedScrollViewerView : XamlControls.ScrollViewerView
        {
        }
