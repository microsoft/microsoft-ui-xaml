...
{
    [TestClass]
    public class SemanticZoomDerivationTests : XamlTestsBase
    {
        private sealed class DerivedSemanticZoom : XamlControls.SemanticZoom { }
        [ClassInitialize]
        ...
        {
            UIExecutor.Execute(() => { _ = new DerivedSemanticZoom(); });
        }
    }
}