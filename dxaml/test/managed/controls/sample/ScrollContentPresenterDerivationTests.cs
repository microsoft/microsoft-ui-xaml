...
{
    [TestClass]
    public class ScrollContentPresenterDerivationTests : XamlTestsBase
    {
        private sealed class DerivedScrollContentPresenter : XamlControls.ScrollContentPresenter { }
        [ClassInitialize]
        ...
        {
            UIExecutor.Execute(() => { _ = new DerivedScrollContentPresenter(); });
        }
    }
}