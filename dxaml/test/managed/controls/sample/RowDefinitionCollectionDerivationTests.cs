...
{
    [TestClass]
    public class RowDefinitionCollectionDerivationTests : XamlTestsBase
    {
        private sealed class DerivedRowDefinitionCollection : XamlControls.RowDefinitionCollection
        {
        }
        ...
        public void CanDerive()
        {
            UIExecutor.Execute(() =>
            {
                _ = new DerivedRowDefinitionCollection();
            });
        }
    }
}
