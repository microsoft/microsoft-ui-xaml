...
{
    [TestClass]
    public class MenuFlyoutSubItemDerivationTests : XamlTestsBase
    {
        private sealed class DerivedMenuFlyoutSubItem : XamlControls.MenuFlyoutSubItem { }
        [ClassInitialize]
        ...
        {
            UIExecutor.Execute(() => { _ = new DerivedMenuFlyoutSubItem(); });
        }
    }
}