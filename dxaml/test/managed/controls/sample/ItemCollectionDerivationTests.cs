...
{
    [TestClass]
    public class ItemCollectionDerivationTests : XamlTestsBase
    {
        private sealed class DerivedItemCollection : XamlControls.ItemCollection
        {
        }
