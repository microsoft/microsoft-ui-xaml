...
{
    [TestClass]
    public class TextBlockDerivationTests : XamlTestsBase
    {
        private sealed class DerivedTextBlock : XamlControls.TextBlock { }
        ...
        {
            UIExecutor.Execute(() => { _ = new DerivedTextBlock(); });
        }
    }
}