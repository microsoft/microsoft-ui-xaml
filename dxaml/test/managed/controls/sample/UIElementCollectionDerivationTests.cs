...
{
    [TestClass]
    public class UIElementCollectionDerivationTests : XamlTestsBase
    {
        private sealed class DerivedUIElementCollection : XamlControls.UIElementCollection
        {
        }
        ...
        public void CanDerive()
        {
            UIExecutor.Execute(() =>
            {
                _ = new DerivedUIElementCollection();
            });
        }
    }
}
