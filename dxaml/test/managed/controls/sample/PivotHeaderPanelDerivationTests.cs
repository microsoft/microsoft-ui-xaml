...
{
    [TestClass]
    public class PivotHeaderPanelDerivationTests : XamlTestsBase
    {
        private sealed class DerivedPivotHeaderPanel : XamlControls.PivotHeaderPanel
        {
        }
