...
{
    [TestClass]
    public class ScrollViewerDerivationTests : XamlTestsBase
    {
        private sealed class DerivedScrollViewer : XamlControls.ScrollViewer { }
        [ClassInitialize]
        ...
        {
            UIExecutor.Execute(() => { _ = new DerivedScrollViewer(); });
        }
    }
}