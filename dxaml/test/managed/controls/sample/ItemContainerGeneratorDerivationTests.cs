...
{
    [TestClass]
    public class ItemContainerGeneratorDerivationTests : XamlTestsBase
    {
        private sealed class DerivedItemContainerGenerator : XamlControls.ItemContainerGenerator
        {
        }
        ...
        public void CanDerive()
        {
            UIExecutor.Execute(() =>
            {
                _ = new DerivedItemContainerGenerator();
            });
        }
    }
}
