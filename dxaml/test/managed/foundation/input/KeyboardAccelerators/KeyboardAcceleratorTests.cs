...
namespace Microsoft.UI.Xaml.Tests.Input.KeyboardAcceleratorTests
{
    [TestClass]
    public partial class KeyboardAcceleratorTests : XamlTestsBase
    {
        [ClassInitialize]
        ...
        public void ValidateKeyboardAcceleratorToolTips()
        {
            {
                const string rootPanelXaml =
                        @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateToolTipForAcceleratorDefinedInCode()
        {
            StackPanel rootPanel = null;
            Button button1 = null;
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorPlacementMode()
        {
            {
                const string rootPanelXaml =
                        @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
        ...
        public void ValidateKeyboardAcceleratorPlacementModeInheritedByChildren()
        {
            {
                const string rootPanelXaml =
        ...
        public void ValidateKeyboardAcceleratorPlacementModeInheritedProperty()
        {
            {
                const string rootPanelXaml =
                        @"<StackPanel x:Name='outerPanel' Width='400' Height='400' xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                ...
                TestServices.WindowHelper.WaitForIdle();
                FocusHelper.EnsureFocus(outerButton, FocusState.Keyboard);
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorEventInvoked()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
        ...
        [TestProperty("Description", "Validates KeyboardAccelerators.Invoked event behavior.")]
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorEventNotInvokedWhenCollapsed()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
            ...
            using (var buttonClickTester = new EventTester<Button, RoutedEventArgs>(button, "Click"))
            {
                ...
                //Key up order should not affect accelerators
                TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_a#$u$_ctrlscan#$u$_a");
                keyboardAcceleratorInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                buttonClickTester.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                TestServices.WindowHelper.WaitForIdle();
            }
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateEqualsKeyCanBeAKeyboardAccelerator()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='button' Content='button'>
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorBehaviorWithNoModifiers()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='button' Content='button'>
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorBehaviorWithBackspace()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='button' Content='button'>
            ...
            FocusHelper.EnsureFocus(button, FocusState.Keyboard); // XAML Island explicitly needs focus to be set
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorBehaviorWithMultipleModifiers()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='button' Content='button'>
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorEventInvokedForCtrlTab()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='button' Content='button'>
        ...
        public void VerifyAcceleratorsWorkOnPivotControl()
        {
            const string rootPanelXaml =
                @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
            ...
            FocusHelper.EnsureFocus(pivot, FocusState.Keyboard);
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateOnProcessKeyboardAcceleratorsEventOrdering()
        {
            const string rootPanelXaml =
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateOnProcessKeyboardAcceleratorsEventOrderingWhenHandlingArgs()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml' x:Name='rootPanel'>
                    </StackPanel>";
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateOrderOfAcceleratorOperations()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml' x:Name='rootPanel'>
            ...
            UIExecutor.Execute(() =>
            {
                ...
                ownedCtrlAAccelerator = (KeyboardAccelerator)rootPanel.FindName("keyboardAccelerator");
            ...
            using (var keyboardAcceleratorOrdering = new KeyboardAcceleratorEventOrderingTester(elementList, button.eventOrder))
            {
                ...
                using (var rootPanelKeyDown = EventTester<UIElement, KeyRoutedEventArgs>.FromRoutedEvent(rootPanel, "KeyDown", (t, u) => { } /*No action required*/))
                {
                    ...
                    TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_a#$u$_ctrlscan#$u$_a");
                    keyboardAcceleratorInvoked.Wait();
                    button.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                    rootPanelKeyDown.Wait();
                    TestServices.WindowHelper.WaitForIdle();
                ...
                using (var rootPanelKeyDown = EventTester<UIElement, KeyRoutedEventArgs>.FromRoutedEvent(rootPanel, "KeyDown", (t, u) => { } /*No action required*/))
                {
                    ...
                    Log.Comment("Press accelerator sequence: Ctrl + A");
                    TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_a#$u$_ctrlscan#$u$_a");
                    ownedKeyboardAcceleratorInvoked.Wait();
                    keyboardAcceleratorInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                    button.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                    rootPanelKeyDown.Wait();
                    TestServices.WindowHelper.WaitForIdle();
                ...
                using (var ownedKeyboardAcceleratorInvoked = new EventTester<KeyboardAccelerator, KeyboardAcceleratorInvokedEventArgs>(ownedCtrlAAccelerator, "Invoked", ownedKeyboardAcceleratorInvokedHandler))
                {
                    ...
                    using (var rootPanelKeyDown = EventTester<UIElement, KeyRoutedEventArgs>.FromRoutedEvent(rootPanel, "KeyDown", (t, u) => { } /*No action required*/))
                    {
                        ...
                        ownedKeyboardAcceleratorInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                        keyboardAcceleratorInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                        button.Wait();
                        rootPanelKeyDown.Wait();
                        Verify.AreEqual("[buttonKeyDown:Control][rootPanelKeyDown:Control]" +
                    ...
                    using (var rootPanelKeyDown = EventTester<UIElement, KeyRoutedEventArgs>.FromRoutedEvent(rootPanel, "KeyDown", (t, u) => { } /*No action required*/))
                    {
                        ...
                        ownedKeyboardAcceleratorInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                        keyboardAcceleratorInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                        buttonProcessKeyboardAccelerators.Wait();
                        rootPanelKeyDown.Wait();
                        Verify.AreEqual("[buttonKeyDown:Control][rootPanelKeyDown:Control]" +
                                        "[buttonOnProcessKeyboardAccelerators:A:Control][buttonProcessKeyboardAccelerators:A:Control]" +
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorEventOrderingOnUIElement()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml' x:Name='rootPanel'>
            ...
            using (var rootPanelKeyUp = EventTester<UIElement, KeyRoutedEventArgs>.FromRoutedEvent(rootPanel, "KeyUp", (t, u) => { } /*No action required*/))
            {
                ...
                keyboardAcceleratorInvoked.Wait();
                rootPanelKeyUp.Wait();
                rootPanelProcessKeyboardAccelerators.Wait();
        ...
        [TestProperty("Description", "Validates KeyboardAccelerators.Invoked event behavior.")]
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateDisabledKeyboardAcceleratorNeverInvoked()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='button' Content='button'>
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateDisabledElementKeyboardAcceleratorNeverInvoked()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
        ...
        public void ValidateKeyboardAcceleratorsCanInvokeControlAutomationAction()
        {
            ...
            {
                rootPanel = new StackPanel();
                button = new Input.KeyboardAcceleratorTests.KeyboardAcceleratorTests.MyButton();
                rootPanel.Children.Add(button);
            ...
            using (var buttonClick = new EventTester<MyButton, RoutedEventArgs>(button, "Click"))
            {
                ...
                button.Wait();
                buttonClick.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
            }
        }
        ...
        [TestProperty("Description", "Validates that KeyboardAccelerators event gets invoked.")]
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateHandlingKeyboardAcceleratorsCanPreventAutomationAction()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='button' Content='button'>
        ...
        [TestProperty("Description", "Validates KeyboardAccelerators.Invoked event behavior.")]
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorsAreGlobalByDefault()
        {
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyButtonFlyoutWithMenuFlyoutCanInvokeAcceleratorDefinedOnMenuItem()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyAcceleratorsDefinedOnSubMenuItemInMenuFlyoutOnButton()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
            ...
            FocusHelper.EnsureFocus(ButtonWithFlyout, FocusState.Keyboard);
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyAcceleratorsDefinedOnSubMenuItemInMenuFlyoutOnMenuBar()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <MenuBar>
            ...
            FocusHelper.EnsureFocus(ButtonWithoutFlyout, FocusState.Keyboard);
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyAcceleratorDefinedOnMenuBarMenuItems()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
        ...
        public void VerifyAcceleratorDefinedOnMenuBarMenuItemsWhenItsOpened()
        {
            ...
            FocusHelper.EnsureFocus(fileMenu, FocusState.Keyboard);
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyStandarUICommandsDefinedOnMenuBarMenuItemsAfterSettingWindowContent()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                           <Button x:Name='focusButton' Content='FocusedButton'/> 
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyStandarUICommandsDefinedOnMenuBarMenuItems()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                           <Button x:Name='focusButton' Content='FocusedButton'/> 
        ...
        public void VerifyButtonFlyoutCanInvokeAcceleratorsDefinedOnFlyoutContent()
        {
            ...
            using (var keyboardAcceleratorInvoked2 = new EventTester<KeyboardAccelerator, KeyboardAcceleratorInvokedEventArgs>(ctrl2Accelerator, "Invoked", keyboardAcceleratorInvokedHandler2))
            {
                ...
                TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_2#$u$_2#$u$_ctrlscan");
                keyboardAcceleratorInvoked2.Wait();
            }
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyButtonContextFlyoutWithMenuFlyoutCanInvokeAcceleratorDefinedOnMenuFlyout()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorsWorkInCommandBarSecondaryCommands()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        [TestProperty("Ignore", "True")] // Keyboard accelerators applied to secondary items in a CommandBar can't be used after the CommandBar is opened and then closed
        public void ValidateKeyboardAcceleratorsWorkInCommandBarSecondaryCommandsAfterOpeningThemExplicitly()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='FocusButton'> Focus </Button>
        ...
        [TestProperty("Description", "Validates KeyboardAccelerators.Invoked event behavior in a commandbar.")]
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorsNotInvokedSecondaryCommandsOfACollapsedCommandBar()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='FocusButton'> Focus </Button>
            ...
            using (var keyboardAcceleratorInvoked = new EventTester<KeyboardAccelerator, KeyboardAcceleratorInvokedEventArgs>(ctrlQAccelerator, "Invoked", keyboardAcceleratorInvokedHandler))
            {
                Log.Comment("Press accelerator sequence: Ctrl + Q");
                TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_q#$u$_q#$u$_ctrlscan");
                keyboardAcceleratorInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(200));
            }
        }
        ...
        [TestProperty("Description", "Validates KeyboardAccelerators.Invoked event behavior in a commandbar.")]
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorsWorkInCommandBarPrimaryCommands()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='FocusButton'> Focus </Button>
        ...
        [TestProperty("Description", "Validates KeyboardAccelerators.Invoked event behavior.")]
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateKeyboardAcceleratorsCanBeScoped()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateProcessKeyboardAcceleratorsEventBehavior()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <StackPanel x:Name='parentPanel'>
            ...
            using (var keyboardAcceleratorInvoked = new EventTester<KeyboardAccelerator, KeyboardAcceleratorInvokedEventArgs>(ctrlQAccelerator, "Invoked", keyboardAcceleratorInvokedHandler))
            {
                ...
                TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_q#$u$_q#$u$_ctrlscan");
                keyboardAcceleratorInvoked.Wait();
                parentPanelProcessKeyboardAccelerators.WaitForNoThrow(TimeSpan.FromMilliseconds(200));
                TestServices.WindowHelper.WaitForIdle();
            }
        }
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateProcessKeyboardAcceleratorsEventBehaviorForControls()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <StackPanel x:Name='parentPanel'>
            ...
            using (var keyboardAcceleratorInvoked = new EventTester<KeyboardAccelerator, KeyboardAcceleratorInvokedEventArgs>(ctrlQAccelerator, "Invoked", keyboardAcceleratorInvokedHandler))
            {
                ...
                TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_q#$u$_q#$u$_ctrlscan");
                keyboardAcceleratorInvoked.Wait();
                button1ProcessKeyboardAccelerators.WaitForNoThrow(TimeSpan.FromMilliseconds(200));
                TestServices.WindowHelper.WaitForIdle();
            }
        }
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyParentOfDisabledControlCanBeInvoked()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <StackPanel x:Name='parentPanel'>
            ...
            using (var keyboardAccelerator2Invoked = new EventTester<KeyboardAccelerator, KeyboardAcceleratorInvokedEventArgs>(ctrlAAccelerator2, "Invoked", keyboardAcceleratorInvokedHandler))
            {
                Log.Comment("Press accelerator sequence: Ctrl + A");
                TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_a#$u$_a#$u$_ctrlscan");
                keyboardAccelerator1Invoked.Wait();
                keyboardAccelerator2Invoked.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyListViewContextFlyoutCanInvokeHiddenAccelerator()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
            ...
            FocusHelper.EnsureFocus(lvItem, FocusState.Keyboard);
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyTryInvokeKeyboardAcceleratorBehavior()
        {
            ...
            UIExecutor.Execute(() =>
            {
                ...
                ctrl1Accelerator = new KeyboardAccelerator() { Modifiers = global::Windows.System.VirtualKeyModifiers.Control,
                                                               Key = global::Windows.System.VirtualKey.Number1};
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyTryInvokeKeyboardAcceleratorBehaviorForLocallyScopedAccelerator()
        {
            ...
            using (var button2KeyboardAcceleratorInvoked = new EventTester<KeyboardAccelerator, KeyboardAcceleratorInvokedEventArgs>(ctrl1Button2Accelerator, "Invoked", button2KeyboardAcceleratorInvokedHandler))
            {
                Log.Comment("Press accelerator sequence: Ctrl + 1");
                TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_1#$u$_1#$u$_ctrlscan");
                button1KeyboardAcceleratorInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(200));
                button1GlobalKeyboardAcceleratorInvoked.Wait();
                button2KeyboardAcceleratorInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(200));
            }
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyListViewContextFlyoutCanNotInvokeHiddenLocallyScopedAccelerator()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <ListView x:Name='listView'>
            ...
            UIExecutor.Execute(() =>
            {
                ...
                lvItem = (ListViewItem)rootPanel.FindName("lvItem");
                contextFlyout = (FlyoutBase)rootPanel.FindName("flyout");
                ctrl1AcceleratorScopedtoContextFlyout = (KeyboardAccelerator)rootPanel.FindName("flyoutAccelerator");
                ctrl1AcceleratorScopedtoContextFlyout.ScopeOwner = contextFlyout;
                ctrl1AcceleratorScopedtoListView = (KeyboardAccelerator)rootPanel.FindName("listViewAccelerator");
                ...
                new EventTester<KeyboardAccelerator, KeyboardAcceleratorInvokedEventArgs>(ctrl1AcceleratorScopedtoListView, "Invoked", keyboardAcceleratorInvokedForListViewHandler))
            {
                Log.Comment("Press accelerator sequence: Ctrl + 1");
                TestServices.KeyboardHelper.PressKeySequence("$d$_ctrlscan#$d$_1#$u$_1#$u$_ctrlscan");
                keyboardAcceleratorScopedtoContextFlyoutInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(200));
                keyboardAcceleratorScopedtoListViewInvoked.Wait();
                TestServices.WindowHelper.WaitForIdle();
            }
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateContentDialogPreventsBackgroundAcceleratorInvoke()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <Button x:Name='button' Content='button'>
            ...
            FocusHelper.EnsureFocus(dialogButton, FocusState.Keyboard);
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void ValidateTextBoxInContentDialogReceivesInput()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
                        <ContentDialog x:Name='dialog'>
        ...
        public void ValidateTextInputAndKeyboardAccelerator()
        {
            ...
            using (var textChangedTester = new EventTester<TextBox, TextChangedEventArgs>(textBox, "TextChanged", textBoxTextChangedHandler))
            {
                ...
                keyboardAcceleratorAInvoked.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                TestServices.WindowHelper.WaitForIdle();
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyKeyboardAcceleratorCanOverrideControlAccelerator()
        {
            const string rootPanelXaml =
                    @"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'>
            ...
            using (var txb1SelectionChangedHandler = new EventTester<TextBox, RoutedEventArgs>(txb1, "SelectionChanged"))
            {
                ...
                txb1SelectionChangedHandler.WaitForNoThrow(TimeSpan.FromMilliseconds(100));
                TestServices.WindowHelper.WaitForIdle();
        ...
        [TestProperty("VelocityTestPass:OneCoreStrict", "Desktop")]
        public void VerifyAllVirtualKeysAccountedForInKeyboardAcceleratorStringRepresentations()
        {
        ...
        public partial class MyButton : Button
        {
            ...
            public void WaitForNoThrow(TimeSpan timeout)
            {
