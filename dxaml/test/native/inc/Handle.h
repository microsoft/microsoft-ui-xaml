...
//  This implementation of a RAII handle wrapper has been ported from the WEXTest
//  framework because they wish other teams to avoid taking a dependency on their
//  implementation.
#pragma once
...
#define DECLARE_AUTOHANDLE_CLASS(className, handlePolicy) \
    typedef Microsoft::UI::Xaml::Tests::Common::AutoHandle<handlePolicy> className; \
