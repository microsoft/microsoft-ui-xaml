...
private:
    ...
    class ConnectedAnimationTestsWpf : public WEX::TestClass<ConnectedAnimationTestsWpf>
    {
    public:
        BEGIN_TEST_CLASS(ConnectedAnimationTestsWpf)
        TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
        TEST_CLASS_PROPERTY(L"RunAs", L"UAP")
        TEST_CLASS_PROPERTY(L"Classification", L"Integration")
         TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"ConnectedAnimationTests")
