...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    ...
    class CaretBrowsingAutomationIntegrationTestsUap : public WEX::TestClass<CaretBrowsingAutomationIntegrationTestsUap>
    {
    public:
        BEGIN_TEST_CLASS(CaretBrowsingAutomationIntegrationTestsUap)
                TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
                TEST_CLASS_PROPERTY(L"RunAs", L"UAP")
                TEST_CLASS_PROPERTY(L"Classification", L"Integration")
                TEST_CLASS_PROPERTY(L"IsolationLevel", L"Test") //DCPP: Crash in Microsoft.UI.Input.dll!UIAutomationIslandForwarder::EnsureAutomationHostProvider(HWND__ * hwnd)
                ...
                TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"CaretBrowsingAutomationIntegrationTests")
        ...
        TEST_METHOD_PROPERTY(L"TestPass:IncludeOnlyOn", L"Desktop")
        // CaretBrowsingAutomationIntegrationTests::ReceivesFocus fails on WPF
        END_TEST_METHOD()
    };
    } }
} } } }
