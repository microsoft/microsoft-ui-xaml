...
public:
    ...
    class CompositionTargetTestsUap : public WEX::TestClass<CompositionTargetTestsUap>
    {
    public:
        BEGIN_TEST_CLASS(CompositionTargetTestsUap)
        TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
        TEST_CLASS_PROPERTY(L"RunAs", L"UAP")
        TEST_CLASS_PROPERTY(L"Classification", L"Integration")
        TEST_CLASS_PROPERTY(L"__ExecutionUnit", L"e6d4a8e5-be97-431f-871b-4937e816c8b3;24aa2bdf-d1ac-40bb-bb77-63c409a5da27;d04573b8-e899-4822-bb72-9f4743c89d36")
        TEST_CLASS_PROPERTY(L"VelocityTestPass:OneCoreStrict", L"Desktop")
        TEST_CLASS_PROPERTY(L"HelixWorkItemCreation", L"CreateWorkItemPerTestClass")
        TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"CompositionTargetTests")
    ...
    END_TEST_CLASS()
        ...
        // Passes first iteration but fails the rest - completedEvent was set and shouldn't be
        END_TEST_METHOD()
    };
