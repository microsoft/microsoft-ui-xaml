...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    namespace Foundation { namespace Graphics {
        ...
        private:
            ...
            friend class CaretBrowsingTestsWpf;

            static void CreateSingleLineTextBlock(xaml_controls::TextBlock^& textBlock);
            static void CreateTextBlockAndRichTextBlock(xaml_controls::RichTextBlock^& richTextBlock, xaml_controls::TextBlock^& textBlock);
            static void CreateNonSelectableTBAndSelectableRTB(xaml_controls::RichTextBlock^& richTextBlock, xaml_controls::TextBlock^& textBlock);
            static void VerifyTextBlockCaretPosition(xaml_controls::TextBlock^ textBlock, int offset);
            static void VerifyRichTextBlockCaretPosition(xaml_controls::RichTextBlock^ richTextBlock, int offset);
            static void VerifyRichTextBlockCaretPosition(xaml_controls::RichTextBlockOverflow^ richTextBlockOverflow, int offset);
        };

        class CaretBrowsingTestsWpf : public WEX::TestClass<CaretBrowsingTestsWpf>
        {
        public:
            BEGIN_TEST_CLASS(CaretBrowsingTestsWpf)
                TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
                TEST_CLASS_PROPERTY(L"RunAs", L"UAP")
                TEST_CLASS_PROPERTY(L"Classification", L"Integration")
                TEST_CLASS_PROPERTY(L"Ignore", L"TRUE")     // Some graphics tests are failing
                TEST_CLASS_PROPERTY(L"HelixWorkItemCreation", L"CreateWorkItemPerTestClass")
                TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"CaretBrowsingTests")
