...
private:
    ...
    friend class ThemeShadowTestsUap;

    static void ThemeShadowBasicNonPopupInternal(bool useLTE);
    static void ThemeShadowLoadTestImpl();
};

class ThemeShadowTestsUap : public WEX::TestClass<ThemeShadowTestsUap>
{
public:
    BEGIN_TEST_CLASS(ThemeShadowTestsUap)
        TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
        TEST_CLASS_PROPERTY(L"RunAs", L"UAP")
        TEST_CLASS_PROPERTY(L"Classification", L"Integration")
        TEST_CLASS_PROPERTY(L"HelixWorkItemCreation", L"CreateWorkItemPerTestClass")
        TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"ThemeShadowTests")
