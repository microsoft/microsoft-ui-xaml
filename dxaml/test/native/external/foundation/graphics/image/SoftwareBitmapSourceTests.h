...
private:
    ...
    class SoftwareBitmapSourceTestsUap : public WEX::TestClass<SoftwareBitmapSourceTestsUap>
    {
    public:
        BEGIN_TEST_CLASS(SoftwareBitmapSourceTestsUap)
        TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
        TEST_CLASS_PROPERTY(L"RunAs", L"UAP")
        ...
        TEST_CLASS_PROPERTY(L"VelocityTestPass:OneCoreStrict", L"Desktop")
        TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"SoftwareBitmapSourceTests")
