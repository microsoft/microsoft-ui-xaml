...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    namespace Foundation { namespace Graphics { namespace Image {
        ...
        public:
            ...
            BEGIN_TEST_METHOD(CreateFromUriWithSizeAndAtlasHint)
                ...
                // xaml::Window::Current does not exists on wpf/win32
                TEST_METHOD_PROPERTY(L"HasAssociatedMasterFile", L"True")
            END_TEST_METHOD()
            ...
            BEGIN_TEST_METHOD(LoadAfterDeviceLostOnStartup)
                TEST_METHOD_PROPERTY(L"VelocityTestPass:OneCoreStrict", L"Desktop")
                // Messes with the device to simulate a bad startup, AVs in WPF mode from disposing the compositor at a bad time.
            END_TEST_METHOD()
    ...
    class LoadedImageSurfaceTestsWpf : public WEX::TestClass<LoadedImageSurfaceTestsWpf>
    {
    public:
        BEGIN_TEST_CLASS(LoadedImageSurfaceTestsWpf)
                TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
                TEST_CLASS_PROPERTY(L"RunAs", L"UAP")

                TEST_CLASS_PROPERTY(L"Classification", L"Integration")
                TEST_CLASS_PROPERTY(L"__ExecutionUnit", L"02f4717a-a120-494b-a28e-9a2cbd41ca58;bd1463b3-e5f2-4d54-9394-63a431c53a6e;d04573b8-e899-4822-bb72-9f4743c89d36")
                TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"LoadedImageSurfaceTests")
