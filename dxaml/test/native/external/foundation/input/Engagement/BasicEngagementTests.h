...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    ...
    class BasicEngagementTestsUap : public WEX::TestClass<BasicEngagementTestsUap>
    {
    public:
        BEGIN_TEST_CLASS(BasicEngagementTestsUap)
                TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
                TEST_CLASS_PROPERTY(L"RunAs", L"UAP")

                TEST_CLASS_PROPERTY(L"Classification", L"Integration")
                TEST_CLASS_PROPERTY(L"__ExecutionUnit", L"1d91ef47-c885-45e2-a578-7aaf1a1b1296;df11dd90-2e1d-45ff-93cb-cd6c0b87e24d")
                TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"BasicEngagementTests")
    ...
    public:
        ...
        // Focus engagement bugs in lifted islands
        END_TEST_METHOD()
        ...
        TEST_METHOD_PROPERTY(L"VelocityTestPass:OneCoreStrict", L"Desktop")
        // XamlObjects events can be fired after its parent Island has been Dispose
        END_TEST_METHOD()
    };
