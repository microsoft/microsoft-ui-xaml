...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    namespace Foundation { namespace Input { namespace DManip {
        ...
        public:
            ...
            BEGIN_TEST_METHOD(Pan)
                ...
                // Poisons next test with crash in MockDComp
            ...
            BEGIN_TEST_METHOD(Zoom)
                ...
                // DManip transform off by 1 pixel
    ...
    class ListViewTestWpf : public WEX::TestClass<ListViewTestWpf>
    {
    public:
        BEGIN_TEST_CLASS(ListViewTestWpf)
                TEST_CLASS_PROPERTY(L"Classification", L"Integration")
                TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
                TEST_CLASS_PROPERTY(L"RunAs", L"UAP")

                TEST_CLASS_PROPERTY(L"__ExecutionUnit", L"aa6364d2-41fe-4bec-a849-584f1f309baf")
                TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"ListViewTest")
