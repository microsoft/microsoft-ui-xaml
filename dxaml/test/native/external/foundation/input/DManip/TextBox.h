...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    namespace Foundation { namespace Input { namespace DManip {
        class TextBoxTest : public WEX::TestClass<TextBoxTest>
        {
        public:
            BEGIN_TEST_CLASS(TextBoxTest)
            ...
            BEGIN_TEST_METHOD(Basics)
                TEST_METHOD_PROPERTY(L"Description", L"Creates a TextBox and validates the DComp tree with DManip-on-DComp enabled")
                TEST_METHOD_PROPERTY(L"VelocityTestPass:OneCoreStrict", L"Desktop")
                TEST_METHOD_PROPERTY(L"HasAssociatedMasterFile", L"True")
            END_TEST_METHOD()

            BEGIN_TEST_METHOD(Pan)
                TEST_METHOD_PROPERTY(L"Description", L"Pans a TextBox and validates the DComp tree with DManip-on-DComp enabled")
                TEST_METHOD_PROPERTY(L"HasAssociatedMasterFile", L"True")
            END_TEST_METHOD()
