...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    ...
    class RedirectionUap : public WEX::TestClass<RedirectionUap>
    {
    public:
        BEGIN_TEST_CLASS(RedirectionUap)
                TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
                TEST_CLASS_PROPERTY(L"RunAs", L"UAP")

                TEST_CLASS_PROPERTY(L"__ExecutionUnit", L"aa6364d2-41fe-4bec-a849-584f1f309baf;df11dd90-2e1d-45ff-93cb-cd6c0b87e24d")
                TEST_CLASS_PROPERTY(L"Classification", L"Integration")
                TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"Redirection")
    ...
    public:
        ...
        TEST_METHOD_PROPERTY(L"VelocityTestPass:OneCoreStrict", L"Desktop")
        // Test crash - Failed to assign Popup.Child
        TEST_METHOD_PROPERTY(L"HasAssociatedMasterFile", L"True")
        END_TEST_METHOD()
