...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    namespace Foundation { namespace Input { namespace DManip {
        ...
        bool AutoScrollBehaviorTestsWpf::ClassSetup()
        {
            XAML_HOSTING_MODE_CLASS_SETUP();
            return true;
        }

        bool AutoScrollBehaviorTestsWpf::TestSetup()
        {
            test_infra::TestServices::WindowHelper->InitializeXaml();
            return true;
        }

        bool AutoScrollBehaviorTestsWpf::TestCleanup()
        {
        ...
        Platform::String^ AutoScrollBehaviorTestsWpf::GetPathToFiles() const
        {
        ...
        void AutoScrollBehaviorTestsWpf::AutoScrollVerticallyInListView()
        {
        ...
        void AutoScrollBehaviorTestsWpf::AutoScrollVerticallyInListView(bool alsoScrollWithMouseWheel)
        {
            TestCleanupWrapper cleanup;
