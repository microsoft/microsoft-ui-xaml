...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    namespace Focus {
        ...
        class AllowFocusWhenDisabledIntegrationTestsUap : public WEX::TestClass<AllowFocusWhenDisabledIntegrationTestsUap>
        {
        public:
            BEGIN_TEST_CLASS(AllowFocusWhenDisabledIntegrationTestsUap)
                TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
                TEST_CLASS_PROPERTY(L"RunAs", L"UAP")
                TEST_CLASS_PROPERTY(L"Classification", L"Integration")
                TEST_CLASS_PROPERTY(L"VelocityTestPass:OneCoreStrict", L"Desktop")
                TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"AllowFocusWhenDisabledIntegrationTests")
            ...
            BEGIN_TEST_METHOD(SupportAllowFocusWhenDisabledOnAutoSuggestBox)
                ...
                // Input pane can't initialize with lifted islands
            END_TEST_METHOD()
