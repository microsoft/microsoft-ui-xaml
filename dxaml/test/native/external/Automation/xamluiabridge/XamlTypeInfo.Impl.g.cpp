...
#include "XamlTypeInfo.g.h"
        ...
        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::GetXamlTypeByType(::Windows::UI::Xaml::Interop::TypeName type)
        {
            auto xamlType = GetXamlTypeByName(type.Name);
            return xamlType;
        }

        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::GetXamlTypeByName(::Platform::String^ typeName)
        {
            ...
            ::Microsoft::UI::Xaml::Markup::IXamlType^ xamlType = nullptr;
            if (val != _xamlTypes.end())
            {
                xamlType = (val->second).Resolve<::Microsoft::UI::Xaml::Markup::IXamlType>();
                if(xamlType != nullptr)
                {
                    return xamlType;
                }
        ...
        ::Microsoft::UI::Xaml::Markup::IXamlMember^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::GetMemberByLongName(::Platform::String^ longMemberName)
        {
        ...
        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlSystemBaseType::BaseType::get()
        {
            throw ref new ::Platform::NotImplementedException;
        }

        ::Microsoft::UI::Xaml::Markup::IXamlMember^ ::XamlTypeInfo::InfoProvider::XamlSystemBaseType::ContentProperty::get()
        {
            throw ref new ::Platform::NotImplementedException;
        }
        ...
        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlSystemBaseType::ItemType::get()
        {
            throw ref new ::Platform::NotImplementedException;
        }

        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlSystemBaseType::KeyType::get()
        {
            throw ref new ::Platform::NotImplementedException;
        }

        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlSystemBaseType::BoxedType::get()
        {
            throw ref new ::Platform::NotImplementedException;
        }
        ...
        ::Microsoft::UI::Xaml::Markup::IXamlMember^ ::XamlTypeInfo::InfoProvider::XamlSystemBaseType::GetMember(::Platform::String^)
        {
            throw ref new ::Platform::NotImplementedException;
        }
        ...
        //XamlUserType
        ::XamlTypeInfo::InfoProvider::XamlUserType::XamlUserType(::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ provider, ::Platform::String^ fullName, ::Microsoft::UI::Xaml::Markup::IXamlType^ baseType) :
            _isArray(false),
        ...
        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlUserType::BaseType::get()
        {
            return _baseType;
        }
        ...
        ::Microsoft::UI::Xaml::Markup::IXamlMember^ ::XamlTypeInfo::InfoProvider::XamlUserType::ContentProperty::get()
        {
            return _provider->GetMemberByLongName(_contentPropertyName);
        }

        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlUserType::ItemType::get()
        {
            return _provider->GetXamlTypeByName(_itemTypeName);
        }

        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlUserType::KeyType::get()
        {
            return _provider->GetXamlTypeByName(_keyTypeName);
        }

        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlUserType::BoxedType::get()
        {
            throw ref new ::Platform::NotImplementedException;
        }

        ::Microsoft::UI::Xaml::Markup::IXamlMember^ ::XamlTypeInfo::InfoProvider::XamlUserType::GetMember(::Platform::String^ name)
        {
        ...
        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlMember::Type::get()
        {
        ...
        ::Microsoft::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlMember::TargetType::get()
        {
