...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests { namespace Automation { namespace RangeValue {
    ...
    class RangeValueIntegrationTests : public WEX::TestClass<RangeValueIntegrationTests>
    {
    public:
        BEGIN_TEST_CLASS(RangeValueIntegrationTests)
        ...
        BEGIN_TEST_METHOD(VerifyRangeValueProperties)
            TEST_METHOD_PROPERTY(L"Description", L"Verifies RangeValue pattern properties.")
        END_TEST_METHOD()
    };
