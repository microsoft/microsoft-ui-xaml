...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests { namespace Automation { namespace CustomNavigation {
    ...
    class CustomNavigationIntegrationTests : public WEX::TestClass<CustomNavigationIntegrationTests>
    {
    public:
        BEGIN_TEST_CLASS(CustomNavigationIntegrationTests)
        ...
        BEGIN_TEST_METHOD(TestCustomNavigationPatternAndElementProperties)
            TEST_METHOD_PROPERTY(L"Description", L"Validates End to End scenario for ICustomNavigationProvider.")
        END_TEST_METHOD()
    };
