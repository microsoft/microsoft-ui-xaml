...
namespace Tests { namespace Native { namespace External { namespace Framework { namespace Parser { 
    namespace Primitive
    {
    ...
    namespace Control
    {
        ...
        public ref class AwesomeParserButton sealed
            : public Tests::Native::External::Framework::Parser::Primitive::CustomButton
        {
        public:
            AwesomeParserButton() {}
        };
