...
namespace Tests { namespace Native { namespace External { namespace Framework {
    ...
    private:
        ...
        static Microsoft::UI::Xaml::DependencyProperty^ m_AttachedTagProperty;
        static Microsoft::UI::Xaml::DependencyProperty^ m_MyWidthProperty;
        static Microsoft::UI::Xaml::DependencyProperty^ m_VectorProperty;
        static Microsoft::UI::Xaml::DependencyProperty^ m_MyUriProperty;
        static Microsoft::UI::Xaml::DependencyProperty^ m_MyGuidProperty;
    ...
    public:
        ...
        static property Microsoft::UI::Xaml::DependencyProperty^ AttachedTagProperty
        {
            Microsoft::UI::Xaml::DependencyProperty^ get() { return m_AttachedTagProperty; }
        }
        static property Microsoft::UI::Xaml::DependencyProperty^ MyWidthProperty
        {
            Microsoft::UI::Xaml::DependencyProperty^ get() { return m_MyWidthProperty; }
        }
        static property Microsoft::UI::Xaml::DependencyProperty^ VectorProperty
        {
            Microsoft::UI::Xaml::DependencyProperty^ get() { return m_VectorProperty; }
        }
        static property Microsoft::UI::Xaml::DependencyProperty^ MyUriProperty
        {
            Microsoft::UI::Xaml::DependencyProperty^ get() { return m_MyUriProperty; }
        }
        static property Microsoft::UI::Xaml::DependencyProperty^ MyGuidProperty
        {
            Microsoft::UI::Xaml::DependencyProperty^ get() { return m_MyGuidProperty; }
        }
        ...
        {
            double get() { return safe_cast<double>(GetValue(MyWidthProperty)); }
            void set(double value) { SetValue(MyWidthProperty, value); }
        }

        property ::Windows::Foundation::Uri^ MyUri
        {
            ::Windows::Foundation::Uri^ get() { return safe_cast<::Windows::Foundation::Uri^>(GetValue(MyUriProperty)); }
            void set(::Windows::Foundation::Uri^ value) { SetValue(MyUriProperty, value); }
        }

        property Platform::Guid MyGuid
        {
            Platform::Guid get() { return safe_cast<Platform::Guid>(GetValue(MyGuidProperty)); }
            void set(Platform::Guid value) { SetValue(MyGuidProperty, value); }
        }

        property ::Windows::Foundation::Collections::IVector<CustomControl^>^ Vector
        {
            ::Windows::Foundation::Collections::IVector<CustomControl^>^ get() { return static_cast<::Windows::Foundation::Collections::IVector<CustomControl^>^>(GetValue(VectorProperty)); }
            void set(::Windows::Foundation::Collections::IVector<CustomControl^>^ value) { SetValue(VectorProperty, value); }
        }
        ...
        static void SetAttachedTag(Microsoft::UI::Xaml::Controls::Control^ target, Platform::Object^ value)
        {
            target->SetValue(m_AttachedTagProperty, value);
        }
        static Platform::Object^ GetAttachedTag(Microsoft::UI::Xaml::Controls::Control^ target)
        {
            return target->GetValue(m_AttachedTagProperty);
        }
    };
