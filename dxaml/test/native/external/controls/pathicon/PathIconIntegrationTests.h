...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests { namespace Controls { namespace PathIcon {
    ...
    class PathIconIntegrationTests : public WEX::TestClass<PathIconIntegrationTests>
    {
    public:
        BEGIN_TEST_CLASS(PathIconIntegrationTests)
        ...
        BEGIN_TEST_METHOD(CanInstantiate)
            TEST_METHOD_PROPERTY(L"Description", L"Validates that we can successfully create a PathIcon.")
        END_TEST_METHOD()

        BEGIN_TEST_METHOD(CanEnterAndLeaveLiveTree)
            TEST_METHOD_PROPERTY(L"Description", L"Validates that we can successfully add/remove a PathIcon from the live tree.")
        END_TEST_METHOD()
