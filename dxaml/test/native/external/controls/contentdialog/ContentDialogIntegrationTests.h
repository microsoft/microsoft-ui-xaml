...
private:
    friend class ContentDialogIntegrationTestsUap;
    ...
    static void CanOpenAndClose();
    static void VerifyContentDialogSmokeBackgroundPart(xaml_controls::ContentDialogPlacement placement);
};


class ContentDialogIntegrationTestsUap : public WEX::TestClass<ContentDialogIntegrationTestsUap>
{
public:
    BEGIN_TEST_CLASS(ContentDialogIntegrationTestsUap)
        TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"ContentDialogIntegrationTests")
        TEST_CLASS_PROPERTY(L"Classification", L"Integration")
        TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
        TEST_CLASS_PROPERTY(L"RunAs", L"UAP")
        TEST_CLASS_PROPERTY(L"__ExecutionUnit", L"c84f8180-05b4-44ec-9575-917de852b45f;88333911-8806-45c4-840a-99c755703018;cc5953d4-6553-42e5-8c02-80720aa9d842")
