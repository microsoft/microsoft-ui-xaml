...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests { namespace Controls { namespace StackPanel {
    ...
    class StackPanelIntegrationTestsUap : public WEX::TestClass<StackPanelIntegrationTestsUap>
    {
    public:
        BEGIN_TEST_CLASS(StackPanelIntegrationTestsUap)
            TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"StackPanelIntegrationTests")
            TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
            TEST_CLASS_PROPERTY(L"RunAs", L"UAP")
