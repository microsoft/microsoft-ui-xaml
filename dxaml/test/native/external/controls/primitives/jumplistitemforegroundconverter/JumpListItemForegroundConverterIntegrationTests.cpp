...
#include "pch.h"
#include "JumpListItemForegroundConverterIntegrationTests.h"
...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests { namespace Controls { namespace Primitives { namespace JumpListItemForegroundConverter {
    ...
    bool JumpListItemForegroundConverterIntegrationTests::ClassSetup()
    {
        CommonTestSetupHelper::CommonTestClassSetup();
        return true;
    }

    bool JumpListItemForegroundConverterIntegrationTests::TestSetup()
    {
        test_infra::TestServices::WindowHelper->InitializeXaml();
        return true;
    }

    bool JumpListItemForegroundConverterIntegrationTests::TestCleanup()
    {
    ...
    // Test Cases
    //
    void JumpListItemForegroundConverterIntegrationTests::CanInstantiate()
    {
        Generic::DependencyObjectTests<xaml_primitives::JumpListItemForegroundConverter>::CanInstantiate();
    }

    void JumpListItemForegroundConverterIntegrationTests::CanConvert()
    {
        TestCleanupWrapper cleanup;
        RunOnUIThread([&] ()
        {
            auto converter = ref new xaml_primitives::JumpListItemForegroundConverter();
