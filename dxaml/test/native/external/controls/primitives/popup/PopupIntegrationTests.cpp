...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests { namespace Controls { namespace Primitives { namespace Popup {
    ...
    bool PopupIntegrationTestsUap::ClassSetup()
    {
        XAML_HOSTING_MODE_CLASS_SETUP();
        return true;
    }

    bool PopupIntegrationTestsUap::TestSetup()
    {
        test_infra::TestServices::WindowHelper->InitializeXaml();
        return true;
    }

    bool PopupIntegrationTestsUap::TestCleanup()
    {
    ...
    void PopupIntegrationTestsUap::ReplayPointerUpdate_PopupClosedDuringReplay_DoesNotCrashHelper(size_t extraOpenPopupCount)
    {
    ...
    void PopupIntegrationTestsUap::WindowedPopupOpenAndCloseHelper()
    {
    ...
    void PopupIntegrationTestsUap::ReplayPointerUpdate_PopupClosedDuringReplay_DoesNotCrash()
    {
    ...
    void PopupIntegrationTestsUap::ReplayPointerUpdate_PopupClosedDuringReplay_WithManyOpenPopups_DoesNotCrash()
    {
    ...
    void PopupIntegrationTestsUap::PopupInHolographicModeOpenAndClose()
    {
    ...
    void PopupIntegrationTestsUap::DoesOverlaySizeWithWindow()
    {
        TestCleanupWrapper cleanup;
    ...
    void PopupIntegrationTestsUap::ValidateOverlayUIETree()
    {
        TestCleanupWrapper cleanup;
