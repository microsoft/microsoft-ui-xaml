...
namespace Microsoft { namespace UI { namespace Xaml { namespace Tests {
    ...
    class SampleIntegrationTestsUap : public WEX::TestClass<SampleIntegrationTestsUap>
    {
    public:
        BEGIN_TEST_CLASS(SampleIntegrationTestsUap)
                TEST_CLASS_PROPERTY(L"BinaryUnderTest", L"Microsoft.UI.Xaml.dll")
                TEST_CLASS_PROPERTY(L"RunAs", L"UAP")

                TEST_METHOD_PROPERTY(L"Classification", L"Integration")
                TEST_CLASS_PROPERTY(L"__ExecutionUnit", L"dad50b0b-4b6e-4b44-ae60-31e745fd8f74;2848f544-9be5-4b98-bd69-bf3f2a4a04f3;a6e2c276-e8c0-4d93-80de-8aeb6ef87fd7")
                TEST_CLASS_PROPERTY(L"MasterFile:ClassName", L"SampleIntegrationTests")
