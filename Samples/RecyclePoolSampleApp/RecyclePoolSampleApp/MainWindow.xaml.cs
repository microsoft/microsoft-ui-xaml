...
using RecyclePoolSampleApp.Pages;

namespace RecyclePoolSampleApp
{
    public sealed partial class MainWindow : Window
    {
        ...
        private void OnNavigationSelectionChanged(NavigationView sender, NavigationViewSelectionChangedEventArgs args)
        {
            if (args.SelectedItem is NavigationViewItem item && item.Tag is string tag)
            {
                ...
                {
                    "Pool" => typeof(RecyclePoolBasicsPage),
                    "Factory" => typeof(RecyclingElementFactoryPage),
                    "Custom" => typeof(CustomElementFactoryPage),
                    "Args" => typeof(SelectTemplateArgsPage),
                    "Shared" => typeof(SharedPoolPage),
                    "Markup" => typeof(MarkupPage),
                    _ => typeof(RecyclePoolBasicsPage),
                };
