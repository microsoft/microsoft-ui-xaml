...
namespace winrt::AppTestAutomationHelpers::implementation
{
    ...
    void TestAutomationHelpersPanel::OnUnhandledException(::Windows::Foundation::IInspectable const& /*sender*/, Microsoft::UI::Xaml::UnhandledExceptionEventArgs const& args)
    {
    ...
    void TestAutomationHelpersPanel::OnLoaded(::Windows::Foundation::IInspectable const& /*sender*/, Microsoft::UI::Xaml::RoutedEventArgs const& /*args*/)
    {
        ...
        auto workItem = winrt::Windows::System::Threading::WorkItemHandler([spThis, dispatcherQueue](winrt::Windows::Foundation::IAsyncAction workItem) mutable
            {
                ...
                dispatcherQueue.TryEnqueue(
                    ...
                    winrt::Microsoft::UI::Dispatching::DispatcherQueueHandler([spThis, errorString]()
                        {
    ...
    void TestAutomationHelpersPanel::WaitForDebuggerInvokerButton_Click(::Windows::Foundation::IInspectable const& /*sender*/, Microsoft::UI::Xaml::RoutedEventArgs const& /*args*/)
    {
        ...
        auto workItem = winrt::Windows::System::Threading::WorkItemHandler([spThis, dispatcherQueue](winrt::Windows::Foundation::IAsyncAction workItem) mutable
            {
                ...
                dispatcherQueue.TryEnqueue(
                    winrt::Microsoft::UI::Dispatching::DispatcherQueuePriority::Low,
                    winrt::Microsoft::UI::Dispatching::DispatcherQueueHandler([spThis]()
                        {
