...
namespace
{
    ...
    DWORD GetUIThreadId(winrt::Microsoft::UI::Dispatching::DispatcherQueue dispatcherQueue)
    {
        DWORD threadId = 0;
        ...
        {
            Event runCompleted;
            dispatcherQueue.TryEnqueue(winrt::Microsoft::UI::Dispatching::DispatcherQueuePriority::Normal,
                winrt::Microsoft::UI::Dispatching::DispatcherQueueHandler([&runCompleted, &threadId]()
                    {
                        threadId = ::GetCurrentThreadId();
                        runCompleted.Set();
                    }));
    ...
    inline Handle OpenNamedEvent(winrt::Microsoft::UI::Dispatching::DispatcherQueue dispatcherQueue, const wchar_t* eventNamePrefix)
    {
...
{
    IdleSynchronizer::IdleSynchronizer(winrt::Microsoft::UI::Dispatching::DispatcherQueue dispatcherQueue) 
...
#define ReturnIfFailed(errorString) { if (!errorString.empty()) { return errorString; } }
    ...
    void AddLog(IdleSynchronizer* pThis, PCWSTR formatMessage, ...)
    {
        ...
        StringCchPrintfW(szOutput, _countof(szOutput), L"%I64u: ", (GetTickCount64() - pThis->TickCountBegin));
    ...
    winrt::hstring IdleSynchronizer::WaitInternal()
    {
        ...
        while (!isIdle)
        {
            ...
            // TODO 27870237: Uncomment this once BuildTreeServiceDrained is properly signaled in WinUI desktop apps.
    ...
    void IdleSynchronizer::WaitForIdleDispatcher()
    {
        ...
        auto revoker = timer.Tick(winrt::auto_revoke_t(), winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueueTimer, IInspectable>(
            [&](winrt::Microsoft::UI::Dispatching::DispatcherQueueTimer, IInspectable)
            {
    ...
    winrt::hstring IdleSynchronizer::WaitForBuildTreeServiceWork(bool* pHadBuildTreeWork)
    {
        ...
        while (hasBuildTreeWork && waitCount-- > 0)
        {
            ...
            m_dispatcherQueue.TryEnqueue(winrt::Microsoft::UI::Dispatching::DispatcherQueuePriority::Normal,
                winrt::Microsoft::UI::Dispatching::DispatcherQueueHandler([&layoutUpdatedEvent]()
                    {
    ...
    void IdleSynchronizer::SynchronouslyTickUIThread(unsigned int ticks)
    {
        ...
        for (unsigned int i = 0; i < ticks; i++)
        {
            ...
            m_dispatcherQueue.TryEnqueue(winrt::Microsoft::UI::Dispatching::DispatcherQueuePriority::Normal,
                winrt::Microsoft::UI::Dispatching::DispatcherQueueHandler([&tickCompleteEvent, &renderingRevoker]()
                    {
                        renderingRevoker = winrt::Microsoft::UI::Xaml::Media::CompositionTarget::Rendering(winrt::auto_revoke, 
