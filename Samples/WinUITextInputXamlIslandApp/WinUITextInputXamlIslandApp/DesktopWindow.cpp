...
bool DesktopWindow::NavigateFocus(MSG* msg)
{
    ...
    else
    {
        ...
        const bool isDialogMessage = IsDialogMessage(m_hMainWnd.get(), msg) != 0;
...
HWND DesktopWindow::CreateDesktopWindowsXamlSource(DWORD dwStyle, UIElement content)
{
    DesktopWindowXamlSource desktopSource;

    // Parent the DesktopWindowXamlSource object to current window
    WindowId mainWndId = GetWindowIdFromWindow(m_hMainWnd.get());
