...
namespace ItemsViewIntegrationApp.Samples.Model
{
    public class Photo : INotifyPropertyChanged
    {
        ...
        {
            int imagesIndex = localPath.IndexOf("/Images/");

            if (imagesIndex == -1)
            {
                imagesIndex = localPath.IndexOf("\\Images\\");
            }

            string imagesFolder = localPath.Substring(imagesIndex);
            string imageName = imagesFolder.Substring(8);
