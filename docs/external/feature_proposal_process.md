...
This document outlines the process to propose or contribute new features.
...
- Changing any core functionality documented on learn.microsoft.com
...
Our contribution guidelines can be found [in this file](../CONTRIBUTING.md).
...
We will update the [documentation on learn.microsoft.com](https://learn.microsoft.com/windows/uwp) and if applicable add a sample to the [WinUI 3 Gallery](https://github.com/microsoft/WinUI-Gallery) app.
