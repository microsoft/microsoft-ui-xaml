...
You can contribute to WinUI with issues and Pull Requests. Simply filing issues for problems you encounter is a great way to contribute.
...
to validate more platforms, adding Debug and ARM. It is run after your changes are merged to main.
