...
- [Conceptual pages (How To)](#conceptual-pages-how-to)
  ...
  - [Layout examples](#layout-examples)
    - [Setting the scrollable content](#setting-the-scrollable-content)
    - [Vertical layout](#vertical-layout)
    - [Horizontal layout](#horizontal-layout)
    - [Two-dimensional (unconstrained) layout](#two-dimensional-unconstrained-layout)
    - [A Photo Viewer - Constrained to the Viewport Layout](#a-photo-viewer---constrained-to-the-viewport-layout)
    - [Controlling the presence of scroll bars](#controlling-the-presence-of-scroll-bars)
      - [Using the default Auto settings](#using-the-default-auto-settings)
      - [Hiding both scroll bars](#hiding-both-scroll-bars)
  - [Interactivity examples](#interactivity-examples)
    - [Controlling user's ability to zoom](#controlling-users-ability-to-zoom)
    - [Controlling the Minimum and Maximum Zoom Factor](#controlling-the-minimum-and-maximum-zoom-factor)
    - [Controlling the user's ability to scroll](#controlling-the-users-ability-to-scroll)
    - [Turning off built-in MouseWheel support](#turning-off-built-in-mousewheel-support)
    - [Turning off built-in Pen support](#turning-off-built-in-pen-support)
    - [Disabling scroll chaining](#disabling-scroll-chaining)
    - [Controlling zoom chaining between nested scrollers](#controlling-zoom-chaining-between-nested-scrollers)
    - [Controlling railing behavior](#controlling-railing-behavior)
    - [Using element anchoring](#using-element-anchoring)
  - [Using Layout-centric Properties and Events in Code](#using-layout-centric-properties-and-events-in-code)
    - [Shrink the extents by a certain percentage of the current factor](#shrink-the-extents-by-a-certain-percentage-of-the-current-factor)
    - [Incrementally load more data](#incrementally-load-more-data)
  - [Using Interaction-centric Properties and Events in Code](#using-interaction-centric-properties-and-events-in-code)
  - [Using View-centric Methods and Events in Code](#using-view-centric-methods-and-events-in-code)
    - [Changing the offsets](#changing-the-offsets)
      - [Immediately Jumping to an Offset](#immediately-jumping-to-an-offset)
      - [Animating to an offset](#animating-to-an-offset)
      - [Jump by some delta of the current offset (no animation)](#jump-by-some-delta-of-the-current-offset-no-animation)
      - [Animating with a custom curve to a new offset by some delta of the current](#animating-with-a-custom-curve-to-a-new-offset-by-some-delta-of-the-current)
      - [Animating the Offsets with Additional Velocity](#animating-the-offsets-with-additional-velocity)
    - [Changing the zoom factor](#changing-the-zoom-factor)
      - [Jumping to zoom factor](#jumping-to-zoom-factor)
      - [Animating to zoom factor](#animating-to-zoom-factor)
      - [Jumping by zoom factor delta](#jumping-by-zoom-factor-delta)
      - [Animate by zoom factor delta with custom animation](#animate-by-zoom-factor-delta-with-custom-animation)
      - [Animate zoom factor with additional velocity](#animate-zoom-factor-with-additional-velocity)
    - [Customizing the bring-into-view participation](#customizing-the-bring-into-view-participation)
      - [Adjust target offset for sticky headers](#adjust-target-offset-for-sticky-headers)
      - [Detect end of bring-into-view contribution](#detect-end-of-bring-into-view-contribution)
    - [Customize the anchor selection](#customize-the-anchor-selection)
      - [Set an explicit anchor element](#set-an-explicit-anchor-element)
      - [Populate the anchor candidates collection](#populate-the-anchor-candidates-collection)
    - [Consuming the ScrollView's Properties in Animations](#consuming-the-scrollviews-properties-in-animations)
      - [Vertical offset drives opacity](#vertical-offset-drives-opacity)
  - [Default ScrollView control template](#default-scrollview-control-template)
...
- [API pages](#api-pages)
  - [ScrollView class](#scrollview-class)
  - [ScrollView.Content property](#scrollviewcontent-property)
    - [Remark](#remark)
  - [ScrollView.ContentOrientation property](#scrollviewcontentorientation-property)
    - [Property Value](#property-value)
    - [Remarks](#remarks)
  - [ScrollView.HorizontalScrollMode (and VerticalScrollMode) property](#scrollviewhorizontalscrollmode-and-verticalscrollmode-property)
    - [Property Value](#property-value-1)
    - [Remarks](#remarks-1)
  - [ScrollView.ComputedHorizontalScrollMode (and ComputedVerticalScrollMode) property](#scrollviewcomputedhorizontalscrollmode-and-computedverticalscrollmode-property)
    - [Property Value](#property-value-2)
  - [ScrollView.IgnoredInputKinds property](#scrollviewignoredinputkinds-property)
    - [Property Value](#property-value-3)
    - [Remark](#remark-1)
  - [ScrollView.HorizontalScrollChainMode (and VerticalScrollChainMode) property](#scrollviewhorizontalscrollchainmode-and-verticalscrollchainmode-property)
    - [Property Value](#property-value-4)
    - [Remark](#remark-2)
  - [ScrollView.ZoomChainMode property](#scrollviewzoomchainmode-property)
    - [Property Value](#property-value-5)
    - [Remark](#remark-3)
  - [ScrollView.CurrentAnchor property](#scrollviewcurrentanchor-property)
  - [ScrollView.HorizontalAnchorRatio (and VerticalAnchorRatio) property](#scrollviewhorizontalanchorratio-and-verticalanchorratio-property)
    - [Property Value](#property-value-6)
    - [Remarks](#remarks-2)
  - [ScrollView.ScrollableWidth (and ScrollableHeight) property](#scrollviewscrollablewidth-and-scrollableheight-property)
    - [Property Value](#property-value-7)
    - [Remarks](#remarks-3)
  - [ScrollView.ScrollPresenter property](#scrollviewscrollpresenter-property)
    - [Property Value](#property-value-8)
    - [Example](#example)
  - [ScrollView.AddScrollVelocity method](#scrollviewaddscrollvelocity-method)
    - [Remarks](#remarks-4)
  - [ScrollView.AddZoomVelocity method](#scrollviewaddzoomvelocity-method)
    - [Remarks](#remarks-5)
  - [ScrollView.AnchorRequested event](#scrollviewanchorrequested-event)
    - [Remarks](#remarks-6)
  - [ScrollView, additional properties](#scrollview-additional-properties)
  - [ScrollView, additional events](#scrollview-additional-events)
  - [ScrollView, additional methods](#scrollview-additional-methods)
  - [ScrollingZoomOptions class](#scrollingzoomoptions-class)
    - [Remarks](#remarks-7)
  - [ScrollingZoomAnimationStartingEventArgs class](#scrollingzoomanimationstartingeventargs-class)
    - [Remarks](#remarks-8)
  - [ScrollingZoomCompletedEventArgs class](#scrollingzoomcompletedeventargs-class)
    - [Remarks](#remarks-9)
  - [ScrollingBringingIntoViewEventArgs class](#scrollingbringingintovieweventargs-class)
    - [Remarks](#remarks-10)
  - [ScrollingBringingIntoViewEventArgs.Cancel](#scrollingbringingintovieweventargscancel)
    - [Property Value](#property-value-9)
    - [Remark](#remark-4)
  - [ScrollingBringingIntoViewEventArgs class, additional details](#scrollingbringingintovieweventargs-class-additional-details)
  - [ScrollingAnchorRequestedEventArgs class](#scrollinganchorrequestedeventargs-class)
    - [Remarks](#remarks-11)
  - [ScrollingScrollOptions class](#scrollingscrolloptions-class)
    - [Remarks](#remarks-12)
  - [ScrollingScrollAnimationStartingEventArgs class](#scrollingscrollanimationstartingeventargs-class)
    - [Remarks](#remarks-13)
  - [ScrollingScrollCompletedEventArgs class](#scrollingscrollcompletedeventargs-class)
    - [Remarks](#remarks-14)
  - [Correlation ID](#correlation-id)
- [API Details](#api-details)
  - [Shared enumerations and structures](#shared-enumerations-and-structures)
  - [ScrollView enumerations](#scrollview-enumerations)
  - [Shared method argument classes](#shared-method-argument-classes)
  - [Shared event argument classes](#shared-event-argument-classes)
  - [ScrollView class](#scrollview-class-1)
- [Appendix](#appendix)
  - [Related Documents](#related-documents)
  - [Benefits of InteractionTracker](#benefits-of-interactiontracker)
  - [Goals and non-goals](#goals-and-non-goals)
    - [P1 Goals](#p1-goals)
    - [P2 Goals](#p2-goals)
    - [Non-Goals](#non-goals)
  - [`ScrollView` responsibilities](#scrollview-responsibilities)
  - [Future Supported Features with known scenarios](#future-supported-features-with-known-scenarios)
    - [Markup scenarios](#markup-scenarios)
      - [ScrollView.ContentOrientation attached dependency property](#scrollviewcontentorientation-attached-dependency-property)
      - [GetContentOrientation method](#getcontentorientation-method)
      - [SetContentOrientation method](#setcontentorientation-method)
        - [Example](#example-1)
      - [Other ScrollView attached properties](#other-scrollview-attached-properties)
      - [Clipping suppression](#clipping-suppression)
      - [Deferral of visual scrolling when interacting with scroll bar](#deferral-of-visual-scrolling-when-interacting-with-scroll-bar)
      - [Ability to define quadrants in content with various scrolling/zooming capabilities](#ability-to-define-quadrants-in-content-with-various-scrollingzooming-capabilities)
      - [Setting the scroll snap points type with the ScrollView.HorizontalSnapPointsType (and VerticalSnapPointsType) property](#setting-the-scroll-snap-points-type-with-the-scrollviewhorizontalsnappointstype-and-verticalsnappointstype-property)
      - [Setting the scroll snap points alignment with the ScrollView.HorizontalSnapPointsAlignment (and VerticalSnapPointsAlignment) property](#setting-the-scroll-snap-points-alignment-with-the-scrollviewhorizontalsnappointsalignment-and-verticalsnappointsalignment-property)
      - [Support for optional and single snap points](#support-for-optional-and-single-snap-points)
    - [Coding scenarios](#coding-scenarios)
      - [Controlling default inertia decelerations](#controlling-default-inertia-decelerations)
        - [Customizing the inertial scrolling decay](#customizing-the-inertial-scrolling-decay)
        - [Customize the inertial zooming decay](#customize-the-inertial-zooming-decay)
      - [Support for zoom snap points types](#support-for-zoom-snap-points-types)
      - [Consuming predicted end-of-inertia view](#consuming-predicted-end-of-inertia-view)
      - [Support for Virtual Content Extents](#support-for-virtual-content-extents)
  - [Unsupported features that would need justification](#unsupported-features-that-would-need-justification)
    - [Markup scenarios](#markup-scenarios-1)
      - [Ability to turn off inertia.](#ability-to-turn-off-inertia)
      - [Ability to turn off overpanning](#ability-to-turn-off-overpanning)
      - [Ability to turn off inertia bouncing](#ability-to-turn-off-inertia-bouncing)
      - [Viewport reduction for core input view occlusion](#viewport-reduction-for-core-input-view-occlusion)
    - [Coding scenarios](#coding-scenarios-1)
      - [Providing completion reason at the end of a view change](#providing-completion-reason-at-the-end-of-a-view-change)
      - [Support for mixed TIE / IT manipulations](#support-for-mixed-tie--it-manipulations)
...
Xaml has a [ScrollViewer](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.ScrollViewer)
control for scrolling content, using scroll bars and panning, etc. Typical uses are as the root of
a page whose content might not fit; and a ListView, which internally uses a `ScrollViewer` for its
list of items.
...
`ScrollView` will continue to be developed after its first release as part of the WinAppSDK.
...
`ScrollPresenter` is in a [separate spec](ScrollPresenter-spec.md).
...
to values chosen to match common usage, for example the basic `<ScrollView/>` is configured for vertical
scrolling.
...
The layout of the `ScrollView`'s content can be vertical, horizontal, both, or neither (for an example
of neither, see the later Photo Viewer example).
...
with an `ItemsRepeater` as the `ScrollView`'s `Content`. The `UniformGridLayout` for the `ItemsRepeater`
positions the items horizontally in a row until it runs out of space (500px in this example), then positions
...
```xml
<ScrollView Width="500" Height="400">
    <ItemsRepeater ItemsSource="{x:Bind Albums}" ItemTemplate="{StaticResource MyTemplate}">
...
- Setting the `ContentOrientation` to `None`, indicating that the content should be constrained to
fit within the `ScrollView`'s space
- Setting the `Image`'s `Stretch` to `Uniform`, indicating that it should stretch up or down to
fill its space without changing shape.
...
XAML
```xml
<ScrollView ContentOrientation="None" ZoomMode="Enabled">
...
could  be used. The content will be scaled to fit into the viewport, but the user can then zoom in
...
In the past this required inserting a `Viewbox` and binding its `MaxHeight`/`MaxWidth` to the
`ViewportHeight`/`ViewportWidth` of the `ScrollViewer` which is just trying to constrain the layout of
`Viewbox` to the size of the viewport. Having a `None` option on the `ScrollView`'s `ContentOrientation`
enables the same thing in a more performant way with less markup/code.
...
The default value of the `HorizontalScrollBarVisibility`/`VerticalScrollBarVisibility` properties is `Auto`.
The following pictures show examples of this default behavior for the scroll bars in a `ScrollView`.
...
XAML
```xml
<ScrollView Width="500" Height="400" ContentOrientation="Both" ZoomMode="Enabled">
    <Image Source="Assets/LargeParisMap.png"/>
</ScrollView>
```
...
XAML
```xml
<ScrollView Width="500" Height="400" ContentOrientation="Both"
    ZoomMode="Enabled"
...
The possible values are `Enabled`, `Auto` and `Disabled`, and the default value for both directions
is `Auto`.
...
However when the scroll mode is `Auto` and the content is smaller than the viewport, the user cannot
wiggle (overpan) the content with touch input. If the small content is zoomed-in and becomes larger
than the viewport, it becomes scrollable with touch input. As it is zoomed-out and its size is smaller
than the viewport again, it can no longer be wiggled (overpanned).
...
XAML
```xml
<ScrollView ContentOrientation="Both" IgnoredInputKinds="MouseWheel">
...
scroll horizontally with the mouse-wheel, but in this case the app wants the outer vertical `ScrollView`
to scroll instead. So instead set innerScrollView.IgnoredInputKinds = ScrollingInputKinds.MouseWheel.
...
XAML
```xml
<ScrollView Width="500" Height="400" ContentOrientation="Both" IgnoredInputKinds="Pen">
...
XAML
```xml
<ScrollView HorizontalScrollChainMode="Never">
...
XAML
```xml
<ScrollView ZoomMode="Enabled" ZoomChainMode="Never">
    <ItemsRepeater ItemsSource="{x:Bind Items}">
        <ItemsRepeater.Layout>
            <StackLayout/>
        </ItemsRepeater.Layout>
...
XAML
```xml
<ScrollView HorizontalScrollRailMode="Disabled" VerticalScrollRailMode="Disabled"
    ContentOrientation="Both">
...
XAML
```xml
<ScrollView VerticalAnchorRatio="0.5">
    <ItemsRepeater ItemsSource="{x:Bind Items}">
        <ItemsRepeater.Layout>
...
private void MainPage()
{
    _requestScrollTimer = new DispatcherTimer();
    _requestScrollTimer.Interval = new TimeSpan(0, 0, 0, 1); // 1 second interval
    _requestScrollTimer.Tick += RequestZoomTimer_Tick;
}
...
`ScrollView` uses a `ScrollPresenter` ([defined in this spec](ScrollPresenter-spec.md)), two `ScrollBar`s,
...
This example uses a custom `Microsoft.UI.Xaml.Controls.Primitives.IScrollController` implementation
by re-templating the `ScrollView` control. It uses an `AnnotatedScrollBar` control named
"PART_VerticalScrollBar" instead of a vertical `ScrollBar` in the custom `ScrollView` control template.
This works because the `AnnotatedScrollBar`control internally implements the `IScrollController` interface.
...
Provides scroll and zoom supports for content.
...
Gets or sets the preferred content orientation.

C#
```cs
public ScrollingContentOrientation ContentOrientation { get; set; }
```
...
Gets or sets the ability to scroll horizontally/vertically through user input.

C#
```cs
public ScrollingScrollMode HorizontalScrollMode { get; set; }
public ScrollingScrollMode VerticalScrollMode { get; set; }
```
...
When `HorizontalScrollMode` is set to `Enabled`, the user will be able to pan horizontally with
touch and a pen. The user can also scroll horizontally with the mouse wheel and scroll bar as long
as the `ScrollableWidth` property is strictly positive. Even when `ScrollableWidth` is zero, the
user still can wiggle (overpan) the content horizontally with touch.

The value `Auto` allows the same behavior as `Enabled` but touch input no longer wiggles
(overpans) the content when it is smaller than the viewport (i.e. `ScrollableWidth` is zero) and
`ZoomMode` is `Disabled`.

When `VerticalScrollMode` is set to `Enabled`, the user will be able to pan vertically with touch
and a pen. The user can also scroll vertically with the mouse wheel and scroll bar as long as the
`ScrollableHeight`property is strictly positive. Even when `ScrollableHeight` is zero, the user
still can wiggle (overpan) the content vertically with touch.

The value `Auto` allows the same behavior as `Enabled` but touch input no longer wiggles
(overpans) the content when it is smaller than the viewport (i.e. `ScrollableHeight` is zero) and
`ZoomMode` is `Disabled`.


## ScrollView.ComputedHorizontalScrollMode (and ComputedVerticalScrollMode) property
...
C#
```cs
public ScrollingInputKinds IgnoredInputKinds { get; set; }
```
...
C#
```cs
public ScrollingChainMode HorizontalScrollChainMode { get; set; }
public ScrollingChainMode VerticalScrollChainMode { get; set; }
```
...
C#
```cs
public ScrollingChainMode ZoomChainMode { get; set; }
```
...
Gets or sets ratio within the viewport where the anchor element is selected.
...
Gets the horizontal/vertical length of the content that can be scrolled.
...
The `ScrollPresenter` instance named "PART_ScrollPresenter" found in the `ScrollView` control template
after it was loaded.
...
The `ScrollView.ScrollPresenter` property is accessed to set its `VerticalScrollController` value.
...
The `State` property transitions to the `ScrollingInteractionState.Inertia`
...
Used as a parameter for the `ScrollView.ZoomTo` and `ScrollView.ZoomBy` methods.
...
Provides data for the `ScrollView.ZooomCompleted` event.
...
Used as a parameter for the `ScrollView.ScrollTo` and `ScrollView.ScrollBy` methods.
...
| `ScrollPresenter` API Specification | [ScrollPresenter API spec](ScrollPresenter-spec.md) |
...
<p> </p>
<p>On the other hand, feature requests for the InteractionTracker are more likely to be fulfilled.</p></td>
</tr>
</tbody>
</table>
...
`ScrollViewer`/`ScrollContentPresenter` do in Windows.UI.Xaml and Microsoft.UI.Xaml.
...
Here's a list:
  ...
  - Default chrome
      - Today:
          ...
          The IScrollController interface is detailed in the [ScrollPresenter spec](ScrollPresenter-spec.md).
...
_Spec note:_
_This new ScrollView attached dependency property allows to change the default ContentOrientation
property when the ItemsView.Layout uses a horizontal layout. The default being `Vertical`._

##### Example

In the following example, the `ItemsView` uses a `StackLayout` that stacks its children horizontally.
In order to allow the `ItemsView` content to grow indefinitely horizontally and be scrolled in that
direction, the `ContentOrientation` attached property is set to `Horizontal`.
...
`ContentOrientation` is the most likely property that a developer may want to override
when declaring an ItemsView.
...
[IScrollSnapPointsInfo](https://docs.microsoft.com/en-us/uwp/api/windows.ui.xaml.controls.primitives.iscrollsnappointsinfo)
interface.
...
XAML
```xml
<ScrollView VerticalSnapPointsType="Mandatory" Width="500" Height="400">
    <StackPanel>
...
XAML
```xml
<ScrollView HorizontalSnapPointsType="Mandatory" ContentOrientation="Horizontal" Width="500" Height="400">
    <StackPanel Orientation="Horizontal">
        <Button Width="300" Content="Button1"/>
        <Button Width="300" Content="Button2"/>
        <Button Width="300" Content="Button3"/>
...
XAML
```xml
<ScrollView HorizontalSnapPointsAlignment="Center"
