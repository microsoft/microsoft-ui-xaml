...
| Customer Capability                                                    | Preview 1/2 (May/July 2020) | Preview 3 (Nov 2020) | WinUI 3.0 (Early 2021) | Post-3.0 (Late 2021) | Notes                                                                                                                       |
|------------------------------------------------------------------------|-----------------------------|----------------------|------------------------|----------------------|-----------------------------------------------------------------------------------------------------------------------------|
| Ready for production apps                                              | Not included                | Not included         | Aspirational           | Will be included     |                                                                                                                             |
| SwapChainPanel                                                         | Included                    | Included             | Will be included       | Will be included     |                                                                                                                             |
|  Chromium-based WebView2                                               | Included                    | Included             | Will be included       | Will be included     |                                                                                                                             |
| WinUI in Desktop (Win32) apps                                          | Included                    | Included             | Will be included       | Will be included     | Single  content tree-only.  Supports C# or C++.  Includes VSIX-based project templates, xaml win32 appmodel support, etc.   |
| Supports MSIX Deployment                                               | Included                    | Included             | Will be included       | Will be included     |                                                                                                                             |
| WinUI works downlevel to Windows 10 version 1803 and above             | Included                    | Included             | Will be included       | Will be included     |                                                                                                                             |
| ARM64 support                                                          | Not included                | Aspirational         | Will be included       | Will be included     |                                                                                                                             |
| Drag and drop                                                          | Not included                | Unknown              | Unknown                | Aspirational         |                                                                                                                             |
| Acrylic material                                                       | Not included                | Not included         | Unlikely               | Will be included     |                                                                                                                             |
| Media Controls                                                         | Not included                | Not included         | Not included           | Will be included     |                                                                                                                             |
| Reveal Highlight                                                       | Not included                | Not included         | Unlikely               | Will be included     |                                                                                                                             |
| Supports non-MSIX deployment                                           | Not included                | Not included         | Not included           | Will be included     | Some means that you will not be able to reference a framework package so you must include the WinUI 3 binaries directly.    |
| .NET 5 Support for Desktop apps                                        | Included                    | Included             | Will be included       | Will be included     |                                                                                                                             |
| Fix multiple content tree restriction for Desktop apps                 | Not included                | Aspirational         | Will be included       | Will be included     |                                                                                                                             |
| Rounded corners                                                        | Not included                | Unknown              | Unknown                | Unknown              |                                                                                                                             |
| Easily customizable title bar for Desktop apps                         | Not included                | Some                 | Some                   | Unknown              |                                                                                                                             |
| Input validation for data fields                                       | Some                        | Some                 | Aspirational           | Will be included     |                                                                                                                             |
| Fluent Shadows                                                         | Not included                | Not included         | Unlikely               | Will be included     |                                                                                                                             |
| .NET 5 Support for UWP apps                                            | Not included                | Unknown              | Unknown                | Unknown              |                                                                                                                             |
| Title Bar customization for UWP apps                                   | Not included                | Not included         | Not included           | Aspirational         |                                                                                                                             |
| Windows 10X Support                                                    | Not included                | Not included         | Not included           | Will be included     |                                                                                                                             |
| Off-thread input for SwapChains                                        | Not included                | Not included         | Not included           | Unknown              |                                                                                                                             |
| XAML Islands                                                           | Not included                | Not included         | Not included           | Will be included     |                                                                                                                             |
| Xbox support                                                           | Not included                | Not included         | Not included           | Will be included     |                                                                                                                             |
| Map Control                                                            | Not included                | Not included         | Not included           | Will be included     |                                                                                                                             |
| Inking: <InkCanvas>                                                    | Not included                | Not included         | Not included           | Unknown              |                                                                                                                             |
| RenderTargetBitmap                                                     | Not included                | Not included         | Unlikely               | Unknown              |                                                                                                                             |
| Support for additional form factors (Xbox, HoloLens, IoT, Surface Hub) | Not included                | Not included         | Not included           | Will be included     |                                                                                                                             |