...
#if !ARM64 // CS7069: Reference to type 'BindingFlags' claims it is defined in 'System.Reflection', but it could not be found                    if (valueObject != null && mergedValueObject != null)
                    {
