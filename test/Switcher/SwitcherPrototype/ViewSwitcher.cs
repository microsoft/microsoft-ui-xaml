...
namespace SwitcherPrototype
{
    ...
    public sealed class ViewSwitcher : Control
    {
        public ViewSwitcher()
        {
            this.DefaultStyleKey = typeof(ViewSwitcher);
        }
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register("ItemsSource", typeof(object), typeof(ViewSwitcher), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty ItemTemplateProperty =
            DependencyProperty.Register("ItemTemplate", typeof(object), typeof(ViewSwitcher), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty SelectedIndexProperty =
            DependencyProperty.Register("SelectedIndex", typeof(int), typeof(ViewSwitcher), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty SelectedItemProperty =
            DependencyProperty.Register("SelectedItem", typeof(object), typeof(ViewSwitcher), new PropertyMetadata(0));
