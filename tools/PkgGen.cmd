...
if NOT DEFINED RELATIVEOUTPUTROOTALT (
    if '%BUILDPLATFORM%' == 'x64' set RELATIVEOUTPUTROOTALT=%BUILDCONFIGURATION%\amd64
    else set RELATIVEOUTPUTROOTALT=%BUILDCONFIGURATION%\%BUILDPLATFORM%
)
...
echo robocopy %XES_DFSDROP%\%RELATIVEOUTPUTROOT%\prebuilt %XES_DFSDROP%\spkg\%RELATIVEOUTPUTROOTALT%\prebuilt /E /R:50 /NP /XX
robocopy %XES_DFSDROP%\%RELATIVEOUTPUTROOT%\prebuilt %XES_DFSDROP%\spkg\%RELATIVEOUTPUTROOTALT%\prebuilt /E /R:50 /NP /XX
