...
for %%A IN (%~dp0MUXPGODatabase.??.??.*.nupkg) do (
    ...
    "T:\WinUICredential\NuGet.exe" push %%A -Source https://microsoft.pkgs.visualstudio.com/DefaultCollection/_packaging/DEPControls/nuget/v3/index.json -apikey VSTS
)
