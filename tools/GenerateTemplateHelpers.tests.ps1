...
Describe 'OutputBoilerPlate'{
    ...
    It 'Should write to file if it exists'{
        ...
        Get-Content $localTestPath | Should -be @('Previous Content', '// Copyright (c) Microsoft Corporation. All rights reserved.', '// Licensed under the MIT License. See LICENSE in the project root for license information.', '// Generated by microsoft-ui-xaml/tools/GenerateTemplateHelpers.ps1')
    }
}
