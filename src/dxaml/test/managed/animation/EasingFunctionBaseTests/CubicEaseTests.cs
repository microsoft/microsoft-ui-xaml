...
{
    [TestClass]
    public class CubicEaseTests : EasingFunctionTestBase
    {
        [ClassInitialize]
        ...
        [TestMethod]
        [Description("Validates that CubicEase easing function can switch easing modes and provide correct output.")]
        public void VerifyCubicEase()
        {
            CubicEase cubicEase = null;
            ...
            VerifyEaseOutput(cubicEase, easeGroundTruth);
        }
    }
}
