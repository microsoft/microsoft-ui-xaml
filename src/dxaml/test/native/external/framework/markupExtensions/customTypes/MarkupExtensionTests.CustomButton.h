...
namespace Private { namespace Tests { namespace Framework { 
    namespace MarkupExtensions
    {
        ...
        public:
            ...
            property PewPewExtension^ CustomProperty
            {
                PewPewExtension^ get() { return safe_cast<PewPewExtension^>(GetValue(CustomPropertyProperty)); }
                void set(PewPewExtension^ value) { SetValue(CustomPropertyProperty, value); }
            }
