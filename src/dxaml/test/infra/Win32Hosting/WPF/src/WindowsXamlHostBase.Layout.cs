...
namespace Microsoft.Toolkit.Wpf.UI.XamlHost
{
    ...
    partial class WindowsXamlHostBase
    {
        ...
        private bool IsXamlContentLoaded()
        {
            ...
            if (Microsoft.UI.Xaml.Media.VisualTreeHelper.GetParent(_xamlSource.Content) == null)
            {
        ...
        protected void XamlContentSizeChanged(object sender, WUX.SizeChangedEventArgs e)
        {
            InvalidateMeasure();
        }
    }
