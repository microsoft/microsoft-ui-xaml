...
namespace XamlGen.Templates.ModernIDL
{
    ...
    public partial class Struct : ModernIdlCodeGenerator<ClassDefinition>
    {
        /// <summary>
 ...
 this.WriteAttributes(Model); 
      ...
      foreach (var property in Model.IdlClassInfo.StructFields) { 
            this.Write("    ");
            this.Write(this.ToStringHelper.ToStringWithCulture(property.PropertyType.IdlTypeName));
            this.Write(" ");
 ...
 this.WriteRuntimeClassAttributes(Model); 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.IdlClassInfo.RuntimeClassName));
            this.Write("\r\n{\r\n");
