...
namespace XamlGen.Templates.Code.Phone.Bodies
{
    ...
    public partial class AttachedPropertySetterBodyReference : CppCodeGenerator<AttachedPropertyDefinition>
    {
        /// <summary>
        ...
        public override string TransformText()
        {
            ...
            this.Write("->QueryInterface(__uuidof(IInspectable), &spValueAsII));\r\nIFC(");
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.TargetType.AbiParameterName));
