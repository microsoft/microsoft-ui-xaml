...
#define WINAPPSDK_CHANGEID_56873234 56873234, WinAppSDK_1_7_1 // [Watson Failure] caused by ACCESS_VIOLATION_c0000005_Microsoft.UI.Xaml.dll!ctl::WeakReferenceSource::CheckThread
...
_Check_return_ HRESULT DesktopWindowImpl::OnActivate(WPARAM wParam, LPARAM lParam)
{
    ...
    if(WinAppSdk::Containment::IsChangeEnabled<WINAPPSDK_CHANGEID_56873234>())
    {
