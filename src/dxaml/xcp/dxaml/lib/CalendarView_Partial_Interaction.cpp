    ...
    _Out_ bool* pHandled)
{
    ...
    *pHandled = false;
    ...
    if (auto pPanel = spHost->GetPanel())
    {
        ...
        case wsy::VirtualKey_End:
        {
            auto newFocusedDate = key == wsy::VirtualKey_Home ?
        ...
        case wsy::VirtualKey_PageDown:
        {
            auto newFocusedDate = m_lastDisplayedDate;
        ...
        case wsy::VirtualKey_Down:
        {
            ...
            {
                newFocusedIndex = static_cast<int>(newFocusedIndexUint);
            }
        }
            break;
        default:
...
_Check_return_ HRESULT CalendarView::OnItemFocused(_In_ CalendarViewBaseItem* pItem)
{
    HRESULT hr = S_OK;
    wf::DateTime date;
    xaml_controls::CalendarViewDisplayMode mode = xaml_controls::CalendarViewDisplayMode_Month;
    ...
    _Out_ BOOLEAN* pIsCandidateTabStopOverridden)
{
    ...
    // ComPtr will do this in a smarter way - it always casts to IUnknown before release/addref so there is no ambiguity.
    ...
    *pIsCandidateTabStopOverridden = FALSE;
    ...
    if (spCandidateAsCalendarViewBaseItem)
    {
        ...
        if (!spFocusedAsCalendarViewBaseItem)
        {
            ...
            auto pScrollViewer = spHost->GetScrollViewer();
            if (pScrollViewer)
            {
