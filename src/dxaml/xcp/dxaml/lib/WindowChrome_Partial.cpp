...
//Bug 57693465: [1.7 Servicing][WASDK][Watson Failure] caused by STOWED_EXCEPTION_80070032_Microsoft.UI.Xaml.dll!DirectUI::WindowChrome::SetTitleBar
#define WINAPPSDK_CHANGEID_57693465 57693465, WinAppSDK_1_7_3
...
_Check_return_ HRESULT WindowChrome::SetTitleBar(_In_opt_ xaml::IUIElement* titleBar)
{
    ...
    if (!m_inputNonClientPtrSrc)
    {
        ...
        if (WinAppSdk::Containment::IsChangeEnabled<WINAPPSDK_CHANGEID_57693465>())
        {
