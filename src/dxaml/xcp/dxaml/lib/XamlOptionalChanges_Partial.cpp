...
// Bug 62738389: [2.x Servicing] XamlOptionalChanges breaking-change opt-in API
#define WINAPPSDK_CHANGEID_62738389 62738389
...
_Check_return_ HRESULT XamlOptionalChangesFactory::EnableChangeImpl(_In_ xaml_settings::XamlChangeId changeId, _Out_ BOOLEAN* pResult)
{
    *pResult = FALSE;
    ...
    if (!WinAppSdk::Containment::IsChangeEnabled<WINAPPSDK_CHANGEID_62738389>())
    {
        return E_NOTIMPL;
    }
