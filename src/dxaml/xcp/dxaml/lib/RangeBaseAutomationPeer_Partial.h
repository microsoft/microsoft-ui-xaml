...
namespace DirectUI
{
    ...
    PARTIAL_CLASS(RangeBaseAutomationPeer)
    {
        public:
            ...
            _Check_return_ HRESULT ForceRaiseValuePropertyChangedEvent();

    private:
        _Check_return_ HRESULT ReportValuePropertyChangedEvent(
            _In_ const CValue& oldValue,
            _In_ const CValue& newValue);
        ...
        bool m_currentValuePropertiesReported;
        DOUBLE m_currentOldValueProperty;
        DOUBLE m_currentNewValueProperty;
