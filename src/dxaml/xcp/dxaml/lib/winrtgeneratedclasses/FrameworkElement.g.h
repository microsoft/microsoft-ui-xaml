...
namespace DirectUI
{
    ...
    public:
        ...
        _Check_return_ HRESULT put_BringIntoViewDistanceX(DOUBLE value);
        _Check_return_ HRESULT get_BringIntoViewDistanceY(_Out_ DOUBLE* pValue);
        _Check_return_ HRESULT put_BringIntoViewDistanceY(DOUBLE value);
        ...
        _Check_return_ HRESULT put_EffectiveViewport(ABI::Windows::Foundation::Rect value);
        ...
        IFACEMETHOD(put_FocusVisualMargin)(ABI::Microsoft::UI::Xaml::Thickness value) override;
        ...
        IFACEMETHOD(put_FocusVisualPrimaryThickness)(ABI::Microsoft::UI::Xaml::Thickness value) override;
        ...
        IFACEMETHOD(put_FocusVisualSecondaryThickness)(ABI::Microsoft::UI::Xaml::Thickness value) override;
        IFACEMETHOD(get_Height)(_Out_ DOUBLE* pValue) override;
        IFACEMETHOD(put_Height)(DOUBLE value) override;
        IFACEMETHOD(get_HorizontalAlignment)(_Out_ ABI::Microsoft::UI::Xaml::HorizontalAlignment* pValue) override;
        IFACEMETHOD(put_HorizontalAlignment)(ABI::Microsoft::UI::Xaml::HorizontalAlignment value) override;
        ...
        _Check_return_ HRESULT put_IsTextScaleFactorEnabledInternal(BOOLEAN value);
        ...
        _Check_return_ HRESULT put_MaxViewport(ABI::Windows::Foundation::Rect value);
        IFACEMETHOD(get_MaxWidth)(_Out_ DOUBLE* pValue) override;
        IFACEMETHOD(put_MaxWidth)(DOUBLE value) override;
        ...
        IFACEMETHOD(put_MinWidth)(DOUBLE value) override;
        ...
        IFACEMETHOD(put_RequestedTheme)(ABI::Microsoft::UI::Xaml::ElementTheme value) override;
        ...
        IFACEMETHOD(put_VerticalAlignment)(ABI::Microsoft::UI::Xaml::VerticalAlignment value) override;
        IFACEMETHOD(get_Width)(_Out_ DOUBLE* pValue) override;
        IFACEMETHOD(put_Width)(DOUBLE value) override;
        ...
        IFACEMETHOD(remove_ActualThemeChanged)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_DataContextChanged)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_EffectiveViewportChanged)(EventRegistrationToken token) override;
        ...
        _Check_return_ HRESULT remove_HighContrastChanged(EventRegistrationToken token);
        ...
        IFACEMETHOD(remove_LayoutUpdated)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_Loaded)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_Loading)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_SizeChanged)(EventRegistrationToken token) override;
        ...
        IFACEMETHOD(remove_Unloaded)(EventRegistrationToken token) override;

        // Methods.
        IFACEMETHOD(ArrangeOverride)(ABI::Windows::Foundation::Size finalSize, _Out_ ABI::Windows::Foundation::Size* pReturnValue) override;
        _Check_return_ HRESULT ArrangeOverrideProtected(ABI::Windows::Foundation::Size finalSize, _Out_ ABI::Windows::Foundation::Size* pReturnValue);
        ...
        IFACEMETHOD(GoToElementStateCore)(_In_ HSTRING stateName, BOOLEAN useTransitions, _Out_ BOOLEAN* pReturnValue) override;
        _Check_return_ HRESULT GoToElementStateCoreProtected(_In_ HSTRING stateName, BOOLEAN useTransitions, _Out_ BOOLEAN* pReturnValue);
        IFACEMETHOD(InvalidateViewport)() override;
        _Check_return_ HRESULT InvokeApplyTemplate(_Out_ BOOLEAN* pReturnValue);
        _Check_return_ HRESULT InvokeFocus(ABI::Microsoft::UI::Xaml::FocusState value, _Out_ BOOLEAN* pReturnValue);
        IFACEMETHOD(MeasureOverride)(ABI::Windows::Foundation::Size availableSize, _Out_ ABI::Windows::Foundation::Size* pReturnValue) override;
        _Check_return_ HRESULT MeasureOverrideProtected(ABI::Windows::Foundation::Size availableSize, _Out_ ABI::Windows::Foundation::Size* pReturnValue);
