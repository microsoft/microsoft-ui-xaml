...
// Methods.
IFACEMETHODIMP DirectUI::IsApiContractPresentGenerated::Evaluate(_In_ ABI::Windows::Foundation::Collections::IVectorView<HSTRING>* pArguments, _Out_ BOOLEAN* pResult)
{
    HRESULT hr = S_OK;
    ...
    *pResult={};
    ...
    IFC(static_cast<IsApiContractPresent*>(this)->EvaluateImpl(pArguments, pResult));
Cleanup:
