...
// Factory methods.
IFACEMETHODIMP DirectUI::ThumbAutomationPeerFactory::CreateInstanceWithOwner(_In_ ABI::Microsoft::UI::Xaml::Controls::Primitives::IThumb* pOwner, _In_opt_ IInspectable* pOuter, _Outptr_ IInspectable** ppInner, _Outptr_ ABI::Microsoft::UI::Xaml::Automation::Peers::IThumbAutomationPeer** ppInstance)
{
    HRESULT hr = S_OK;
...
namespace DirectUI
{
    ...
    {
        RRETURN(ctl::ActivationFactoryCreator<ThumbAutomationPeerFactory>::CreateActivationFactory());
    }
}
