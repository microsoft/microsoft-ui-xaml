...
// Methods.
IFACEMETHODIMP DirectUI::IsTypeNotPresentGenerated::Evaluate(_In_ ABI::Windows::Foundation::Collections::IVectorView<HSTRING>* pArguments, _Out_ BOOLEAN* pResult)
{
    HRESULT hr = S_OK;
    if (EventEnabledApiFunctionCallStart())
    {
        XamlTelemetry::PublicApiCall(true, reinterpret_cast<uint64_t>(this), "IsTypeNotPresent_Evaluate", 0);
    }
    ...
    *pResult={};
    ...
    IFC(static_cast<IsTypeNotPresent*>(this)->EvaluateImpl(pArguments, pResult));
Cleanup:
    if (EventEnabledApiFunctionCallStop())
    {
        XamlTelemetry::PublicApiCall(false, reinterpret_cast<uint64_t>(this), "IsTypeNotPresent_Evaluate", hr);
    }
    RRETURN(hr);
}
