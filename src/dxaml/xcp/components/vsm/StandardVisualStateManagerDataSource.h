...
class StandardVisualStateManagerDataSource
    : public VisualStateManagerDataSource
{
public:
    StandardVisualStateManagerDataSource(CVisualStateGroupCollection* pGroupCollection);
...
protected:
    ...
    _Check_return_ HRESULT OnBeginTransitionToState(_In_ int groupIndex, _In_ int stateIndex) override;
    _Check_return_ HRESULT OnCompleteTransitionToState(_In_ int groupIndex) override;
