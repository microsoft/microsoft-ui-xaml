...
#define WINAPPSDK_CHANGEID_56633858 56633858 //[Watson Failure] caused by ACCESS_VIOLATION_c0000005_Microsoft.UI.Xaml.dll!CUIElement::FlushPendingKeepVisibleOperations
...
void CUIElement::FlushPendingKeepVisibleOperations()
{
    ...
    {
        CUIElementCollection* children = parent->GetChildren();
        if (WinAppSdk::Containment::IsChangeEnabled<WINAPPSDK_CHANGEID_56633858>())
        {
