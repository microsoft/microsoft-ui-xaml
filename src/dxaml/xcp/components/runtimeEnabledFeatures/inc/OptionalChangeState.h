...
namespace OptionalChangeState
{
    ...
    {
        return IsOptionalChangeEnabled(BitIndex_IconNoGridOptimization);
    }

    inline bool IsOptimizeApplyStylesEnabled()
    {
        return IsOptionalChangeEnabled(BitIndex_OptimizeApplyStyles);
    }
    ...
    {
        return IsOptionalChangeEnabled(BitIndex_DeferContextFlyoutInit);
    }
}
