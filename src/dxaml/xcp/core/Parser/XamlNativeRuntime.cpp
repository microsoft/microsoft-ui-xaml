            ...
            _In_ bool bBindTemplates )
{
    ...
    // helpful, property-named error instead - same treatment simple properties already get. Gated on
    // containment: when the feature is off this rejection doesn't apply, so binding handling is
