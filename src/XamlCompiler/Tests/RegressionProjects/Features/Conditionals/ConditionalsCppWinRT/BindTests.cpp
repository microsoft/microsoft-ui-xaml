...
namespace winrt::ConditionalsCppWinRT::implementation
{
    ...
    void BindTests::Click_V2(::winrt::Windows::Foundation::IInspectable const& sender, wux::RoutedEventArgs const&)
    {
        IVersionedProperties obj = (IVersionedProperties)sender.try_as<IVersionedProperties>();
        clickV2results().Text(obj.V2Property());
    }

    void BindTests::Click_V3(::winrt::Windows::Foundation::IInspectable const& sender, wux::RoutedEventArgs const&)
    {
        IVersionedProperties obj = (IVersionedProperties)sender.try_as<IVersionedProperties>();
