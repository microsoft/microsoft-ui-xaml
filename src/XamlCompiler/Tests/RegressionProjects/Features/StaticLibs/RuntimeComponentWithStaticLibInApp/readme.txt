========================================================================
    C++/WinRT RuntimeComponentWithStaticLibInApp Project Overview
========================================================================
...
2. Build the project once to generate implementation templates under 
    the "Generated Files" folder, as well as stub class definitions 
    under "Generated Files\sources".  
3. Use the stub class definitions for reference to implement your
