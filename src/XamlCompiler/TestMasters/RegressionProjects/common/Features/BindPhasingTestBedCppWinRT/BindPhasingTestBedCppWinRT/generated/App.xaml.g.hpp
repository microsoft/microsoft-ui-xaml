...
#endif
{
    ...
    ::winrt::Microsoft::UI::Xaml::Application::Start(
        [](auto&&)
        {
            ...
            if constexpr (has_parameterless_ctor_v<::winrt::BindPhasingTestBedCppWinRT::implementation::App>)
            {
                ::winrt::make<::winrt::BindPhasingTestBedCppWinRT::implementation::App>();
            }
#else
            ::winrt::make<::winrt::BindPhasingTestBedCppWinRT::implementation::App>();
#endif
