...
namespace winrt::BindTestbed::NamedRootsPage::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES NamedPageRootWithCompiledBindingUserChild_base : implements<D, BindTestbed::NamedRootsPage::NamedPageRootWithCompiledBindingUserChild, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = NamedPageRootWithCompiledBindingUserChild_base;
        using class_type = BindTestbed::NamedRootsPage::NamedPageRootWithCompiledBindingUserChild;
        using implements_type = typename NamedPageRootWithCompiledBindingUserChild_base::implements_type;
        ...
        {
            return L"BindTestbed.NamedRootsPage.NamedPageRootWithCompiledBindingUserChild";
        }
        NamedPageRootWithCompiledBindingUserChild_base()
        {
...
namespace winrt::BindTestbed::NamedRootsPage::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES NamedPageRootWithCompiledBindingUserChildT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::NamedRootsPage::NamedPageRootWithCompiledBindingUserChild;
...
#if defined(WINRT_FORCE_INCLUDE_NAMEDPAGEROOTWITHCOMPILEDBINDINGUSERCHILD_XAML_G_H) || __has_include("NamedRootsPage/NamedPageRootWithCompiledBindingUserChild.xaml.g.h")

#include "NamedRootsPage/NamedPageRootWithCompiledBindingUserChild.xaml.g.h"
...
{
    template <typename D, typename... I>
    using NamedPageRootWithCompiledBindingUserChildT = NamedPageRootWithCompiledBindingUserChild_base<D, I...>;
}
