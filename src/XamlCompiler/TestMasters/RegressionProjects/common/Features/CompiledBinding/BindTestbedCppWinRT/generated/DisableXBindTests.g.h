...
namespace winrt::BindTestbed::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES DisableXBindTests_base : implements<D, BindTestbed::DisableXBindTests, composing, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = DisableXBindTests_base;
        using class_type = BindTestbed::DisableXBindTests;
        using implements_type = typename DisableXBindTests_base::implements_type;
        ...
        {
            return L"BindTestbed.DisableXBindTests";
        }
        DisableXBindTests_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES DisableXBindTestsT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::DisableXBindTests;
...
#if defined(WINRT_FORCE_INCLUDE_DISABLEXBINDTESTS_XAML_G_H) || __has_include("DisableXBindTests.xaml.g.h")

#include "DisableXBindTests.xaml.g.h"
...
{
    template <typename D, typename... I>
    using DisableXBindTestsT = DisableXBindTests_base<D, I...>;
}
