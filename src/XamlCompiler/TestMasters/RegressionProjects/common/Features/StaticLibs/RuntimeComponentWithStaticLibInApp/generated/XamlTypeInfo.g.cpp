...
#endif
#if __has_include(<winrt/RuntimeComponentWithStaticLibInApp.h>)
...
using TypeKind = ::winrt::Windows::UI::Xaml::Interop::TypeKind;
    ...
    namespace XamlTypeInfo_staticasserts
    {
        ...
        static_assert( is_type_complete_v<::winrt::RuntimeComponentWithStaticLibInApp::MainPage>, "Please #include the implementation header for '::winrt::RuntimeComponentWithStaticLibInApp::MainPage' in your precompiled header 'pch.h'." );
...
const MemberInfo MemberInfos[] = 
{
    ...
    -1,
    true,  false, false,
    //   7 - RuntimeComponentWithStaticLibInApp.MainPage.Dummy
    L"Dummy",
