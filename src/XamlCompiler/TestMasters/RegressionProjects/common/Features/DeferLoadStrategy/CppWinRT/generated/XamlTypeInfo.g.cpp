...
#if __has_include(<winrt/CppWinRT.h>)
...
using TypeKind = ::winrt::Windows::UI::Xaml::Interop::TypeKind;
    ...
    namespace XamlTypeInfo_staticasserts
    {
        ...
        static_assert( is_type_complete_v<::winrt::CppWinRT::MainPage>, "Please #include the implementation header for '::winrt::CppWinRT::MainPage' in your precompiled header 'pch.h'." );
...
::winrt::Windows::Foundation::IInspectable GetValueTypeMember_CurrentYearAsInteger(::winrt::Windows::Foundation::IInspectable const& instance)
{
    return ::winrt::box_value<TValue>(instance.as<TDeclaringType>().CurrentYearAsInteger());
}
...
const TypeInfo TypeInfos[] = 
{
    ...
    -1,
    //   3
    L"CppWinRT.MainPage", L"",
    &ActivateLocalType<::winrt::CppWinRT::implementation::MainPage>, nullptr, nullptr, nullptr,
...
{
    //   0 - CppWinRT.MainPage.CurrentYearAsInteger
    L"CurrentYearAsInteger",
    &GetValueTypeMember_CurrentYearAsInteger<::winrt::CppWinRT::MainPage, int32_t>,
    nullptr,
    0, // Int32
    -1,
    true,  false, false,
