...
namespace winrt::CppWinRTComponent::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, CppWinRTComponent::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = CppWinRTComponent::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"CppWinRTComponent.XamlMetaDataProvider";
        }
    };
}
namespace winrt::CppWinRTComponent::factory_implementation
{
    ...
    {
        using instance_type = CppWinRTComponent::XamlMetaDataProvider;
