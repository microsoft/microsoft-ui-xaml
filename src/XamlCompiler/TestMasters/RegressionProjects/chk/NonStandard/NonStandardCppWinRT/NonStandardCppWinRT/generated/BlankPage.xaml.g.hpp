...
namespace winrt::NonStandardCppWinRT::implementation
{
    ...
    void BlankPageT<D, I...>::InitializeComponent()
    {
        ...
        {
            _contentLoaded = true;
            ::winrt::Windows::Foundation::Uri resourceLocator{ L"ms-appx:///BlankPage.xaml" };
            ::winrt::Microsoft::UI::Xaml::Application::LoadComponent(*this, resourceLocator, ComponentResourceLocation::Application);
        }
    }

    template <typename D, typename... I>
    void BlankPageT<D, I...>::Connect(int32_t, IInspectable const&)
    {
        _contentLoaded = true;
    }
    ...
    template <typename D, typename... I>
    IComponentConnector BlankPageT<D, I...>::GetBindingConnector(int32_t, IInspectable const&)
    {
        return nullptr;
    }
