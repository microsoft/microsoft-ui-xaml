...
namespace winrt::NonStandardCppWinRT::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES BlankPage_base : implements<D, NonStandardCppWinRT::BlankPage, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
        ...
        winrt::Microsoft::UI::Xaml::Controls::IPageOverridesT<D>, winrt::Microsoft::UI::Xaml::Controls::IControlOverridesT<D>, winrt::Microsoft::UI::Xaml::IFrameworkElementOverridesT<D>, winrt::Microsoft::UI::Xaml::IUIElementOverridesT<D>
    {
        ...
        using class_type = NonStandardCppWinRT::BlankPage;
        ...
        {
            return L"NonStandardCppWinRT.BlankPage";
        }
        BlankPage_base()
        {
...
namespace winrt::NonStandardCppWinRT::factory_implementation
{
    ...
    {
        using instance_type = NonStandardCppWinRT::BlankPage;
