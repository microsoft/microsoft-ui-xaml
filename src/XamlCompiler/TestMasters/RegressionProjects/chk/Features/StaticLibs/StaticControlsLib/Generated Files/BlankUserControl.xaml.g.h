...
namespace winrt::StaticControlsLib::implementation
{
    ...
    struct BlankUserControlT : public ::winrt::StaticControlsLib::implementation::BlankUserControl_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename BlankUserControlT::base_type;
        using base_type::base_type;
        using class_type = typename BlankUserControlT::class_type;
    ...
    private:
        struct BlankUserControl_obj1_Bindings;
