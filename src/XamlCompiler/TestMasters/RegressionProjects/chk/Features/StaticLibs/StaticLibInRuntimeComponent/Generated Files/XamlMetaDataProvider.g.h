...
namespace winrt::StaticLibInRuntimeComponent::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, StaticLibInRuntimeComponent::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = StaticLibInRuntimeComponent::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"StaticLibInRuntimeComponent.XamlMetaDataProvider";
        }
    };
}
namespace winrt::StaticLibInRuntimeComponent::factory_implementation
{
    ...
    {
        using instance_type = StaticLibInRuntimeComponent::XamlMetaDataProvider;
