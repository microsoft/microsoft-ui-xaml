...
#if defined(WINRT_FORCE_INCLUDE_BLANKUSERCONTROL_XAML_G_H) || __has_include("StaticControlsLib.BlankUserControl.xaml.g.h")

#include "StaticControlsLib.BlankUserControl.xaml.g.h"
