...
namespace winrt::BindTestbed::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES CastingModel_base : implements<D, BindTestbed::CastingModel, I...>
    {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES CastingModelT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
