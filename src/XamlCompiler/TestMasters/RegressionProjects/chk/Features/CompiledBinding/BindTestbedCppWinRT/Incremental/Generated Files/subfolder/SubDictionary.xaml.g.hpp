...
{
    instance.as<::winrt::BindTestbed::subfolder::SubDictionary>().Insert(::winrt::unbox_value<::winrt::Windows::Foundation::IInspectable>(key), ::winrt::unbox_value<::winrt::Windows::Foundation::IInspectable>(item));
}
