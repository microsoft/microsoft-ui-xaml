...
#endif
{
    ...
    ::winrt::Microsoft::UI::Xaml::Application::Start(
        [](auto&&)
        {
            ...
            if constexpr (has_parameterless_ctor_v<::winrt::MultipleViewsTestbedCppWinRT::implementation::App>)
            {
                ::winrt::make<::winrt::MultipleViewsTestbedCppWinRT::implementation::App>();
            }
#else
            ::winrt::make<::winrt::MultipleViewsTestbedCppWinRT::implementation::App>();
#endif
