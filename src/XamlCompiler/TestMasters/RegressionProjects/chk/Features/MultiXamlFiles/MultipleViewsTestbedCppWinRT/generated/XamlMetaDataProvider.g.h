...
namespace winrt::MultipleViewsTestbedCppWinRT::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, MultipleViewsTestbedCppWinRT::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = MultipleViewsTestbedCppWinRT::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"MultipleViewsTestbedCppWinRT.XamlMetaDataProvider";
        }
    };
}
namespace winrt::MultipleViewsTestbedCppWinRT::factory_implementation
{
    ...
    {
        using instance_type = MultipleViewsTestbedCppWinRT::XamlMetaDataProvider;
