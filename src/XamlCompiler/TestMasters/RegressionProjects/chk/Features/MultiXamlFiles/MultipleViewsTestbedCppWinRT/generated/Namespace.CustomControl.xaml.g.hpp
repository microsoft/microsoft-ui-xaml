...
namespace winrt::MultipleViewsTestbedCppWinRT::implementation
{
    ...
    void NamespaceT<D, I...>::InitializeComponent()
    {
        InitializeComponent(Uri(L"ms-appx:///Namespace.CustomControl.xaml"));
    }

    template <typename D, typename ... I>
    void NamespaceT<D, I...>::InitializeComponent(Uri const& resourceLocator)
    {
        if (!_contentLoaded)
        {
            _contentLoaded = true;
    ...
    template <typename D, typename... I>
    void NamespaceT<D, I...>::Connect(int32_t, IInspectable const&)
    {
        _contentLoaded = true;
    }

    template <typename D, typename ... I>
    void NamespaceT<D, I...>::DisconnectUnloadedObject(int32_t)
    {
        throw ::winrt::hresult_invalid_argument { L"No unloadable objects to disconnect." };
    }

    template <typename D, typename ... I>
    void NamespaceT<D, I...>::UnloadObject(DependencyObject const&)
    {
    ...
    template <typename D, typename... I>
    IComponentConnector NamespaceT<D, I...>::GetBindingConnector(int32_t, IInspectable const&)
    {
        return nullptr;
    }

    template struct NamespaceT<struct Namespace>;
}
