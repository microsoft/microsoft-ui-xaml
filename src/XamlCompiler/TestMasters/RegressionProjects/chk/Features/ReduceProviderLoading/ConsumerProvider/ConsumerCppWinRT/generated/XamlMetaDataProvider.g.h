...
namespace winrt::ConsumerCppWinRT::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, ConsumerCppWinRT::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = ConsumerCppWinRT::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"ConsumerCppWinRT.XamlMetaDataProvider";
        }
    };
}
namespace winrt::ConsumerCppWinRT::factory_implementation
{
    ...
    {
        using instance_type = ConsumerCppWinRT::XamlMetaDataProvider;
