...
namespace winrt::Simple::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES BlankPageBase_base : implements<D, Simple::BlankPageBase, composable, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = BlankPageBase_base;
        using class_type = Simple::BlankPageBase;
        using implements_type = typename BlankPageBase_base::implements_type;
...
namespace winrt::Simple::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES BlankPageBaseT : implements<D, winrt::Windows::Foundation::IActivationFactory, winrt::Simple::IBlankPageBaseFactory, I...>
    {
        using instance_type = Simple::BlankPageBase;
        ...
        {
            return impl::composable_factory<T>::template CreateInstance<winrt::Simple::BlankPageBase>(baseInterface, innerInterface);
        }
...
#if defined(WINRT_FORCE_INCLUDE_BLANKPAGEBASE_XAML_G_H) || __has_include("BlankPageBase.xaml.g.h")

#include "BlankPageBase.xaml.g.h"
...
{
    template <typename D, typename... I>
    using BlankPageBaseT = BlankPageBase_base<D, I...>;
}
