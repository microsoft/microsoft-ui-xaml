...
void* winrt_make_EventHandling_968976_XamlMetaDataProvider();
...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"EventHandling_968976.MainPage"))
    {
        return winrt_make_EventHandling_968976_MainPage();
    }

    if (requal(name, L"EventHandling_968976.MyUserControl"))
    {
        return winrt_make_EventHandling_968976_MyUserControl();
    }

    if (requal(name, L"EventHandling_968976.XamlMetaDataProvider"))
    {
        return winrt_make_EventHandling_968976_XamlMetaDataProvider();
    }
