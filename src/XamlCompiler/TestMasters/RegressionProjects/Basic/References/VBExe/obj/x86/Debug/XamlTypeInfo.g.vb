...
Namespace Global.VBExe
    ...
    Partial Public Class App
        ...
        Private __appProvider As Global.VBExe.VBExe_XamlTypeInfo.XamlMetaDataProvider

        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Windows.UI.Xaml.Build.Tasks", " 0.0.0.0")>  _
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private ReadOnly Property _AppProvider() As Global.VBExe.VBExe_XamlTypeInfo.XamlMetaDataProvider
            Get
                If __appProvider Is Nothing
                    __appProvider = New Global.VBExe.VBExe_XamlTypeInfo.XamlMetaDataProvider()
                End If
...
Namespace Global.VBExe.VBExe_XamlTypeInfo
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Windows.UI.Xaml.Build.Tasks", " 0.0.0.0")>  _
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
    Public NotInheritable Class XamlMetaDataProvider
        Implements Global.Windows.UI.Xaml.Markup.IXamlMetadataProvider
        Private _provider As Global.VBExe.VBExe_XamlTypeInfo.XamlTypeInfoProvider
        Private ReadOnly Property Provider As Global.VBExe.VBExe_XamlTypeInfo.XamlTypeInfoProvider
            Get
                If _provider Is Nothing
                    _provider = New Global.VBExe.VBExe_XamlTypeInfo.XamlTypeInfoProvider()
                End If
                Return _provider
            End Get
        End Property
    ...
    Friend Class XamlTypeInfoProvider
        Public Function GetXamlTypeByType(ByVal type As Global.System.Type) As Global.Windows.UI.Xaml.Markup.IXamlType
            ...
            SyncLock _xamlTypeCacheByType
                ...
                End If
                Dim userXamlType As Global.VBExe.VBExe_XamlTypeInfo.XamlUserType = TryCast(xamlType, Global.VBExe.VBExe_XamlTypeInfo.XamlUserType)
        ...
        Private _typeNameTable(7) As String
        Private _typeTable(7) As Global.System.Type
        ...
        Private Sub InitTypeTables()
            ...
            _typeNameTable(6) = "VBExe.MainPage"
            _typeNameTable(7) = "Windows.UI.Xaml.Controls.Page"
            _typeTable(0) = GetType(Global.CSharpLib.CSharpUserControlFromProjectLibrary)
            _typeTable(1) = GetType(Global.Windows.UI.Xaml.Controls.UserControl)
            _typeTable(2) = GetType(Global.CSharpWinrtComponent.CSharpUserControlFromProjectWinrtComponent)
            _typeTable(3) = GetType(Global.VbLib.VbUserControlFromProjectLibrary)
            _typeTable(4) = GetType(Global.VbWinrtComponent.VBUserControlFromWinrtComponent)
            _typeTable(5) = GetType(Global.VCWinrtComponent.VCUserControlFromWinrtComponent)
            _typeTable(6) = GetType(Global.VBExe.MainPage)
        ...
        Private Function Activate_0_CSharpUserControlFromProjectLibrary() As Global.System.Object
            Return New Global.CSharpLib.CSharpUserControlFromProjectLibrary()
        End Function

        Private Function Activate_2_CSharpUserControlFromProjectWinrtComponent() As Global.System.Object
            Return New Global.CSharpWinrtComponent.CSharpUserControlFromProjectWinrtComponent()
        End Function

        Private Function Activate_3_VbUserControlFromProjectLibrary() As Global.System.Object
            Return New Global.VbLib.VbUserControlFromProjectLibrary()
        End Function

        Private Function Activate_4_VBUserControlFromWinrtComponent() As Global.System.Object
            Return New Global.VbWinrtComponent.VBUserControlFromWinrtComponent()
        End Function

        Private Function Activate_5_VCUserControlFromWinrtComponent() As Global.System.Object
            Return New Global.VCWinrtComponent.VCUserControlFromWinrtComponent()
        End Function

        Private Function Activate_6_MainPage() As Global.System.Object
            Return New Global.VBExe.MainPage()
        End Function


        Private Function CreateXamlType(ByVal typeIndex As Integer) As Global.Windows.UI.Xaml.Markup.IXamlType
            Dim xamlType As Global.VBExe.VBExe_XamlTypeInfo.XamlSystemBaseType = Nothing
            Dim userType As Global.VBExe.VBExe_XamlTypeInfo.XamlUserType
            ...
            Case 0     ' CSharpLib.CSharpUserControlFromProjectLibrary
                userType = New Global.VBExe.VBExe_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.Activator = AddressOf Activate_0_CSharpUserControlFromProjectLibrary
                xamlType = userType

            Case 1     ' Windows.UI.Xaml.Controls.UserControl
                xamlType = New Global.VBExe.VBExe_XamlTypeInfo.XamlSystemBaseType(typeName, type)

            Case 2     ' CSharpWinrtComponent.CSharpUserControlFromProjectWinrtComponent
                userType = New Global.VBExe.VBExe_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.Activator = AddressOf Activate_2_CSharpUserControlFromProjectWinrtComponent
                xamlType = userType

            Case 3     ' VbLib.VbUserControlFromProjectLibrary
                userType = New Global.VBExe.VBExe_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.Activator = AddressOf Activate_3_VbUserControlFromProjectLibrary
                xamlType = userType

            Case 4     ' VbWinrtComponent.VBUserControlFromWinrtComponent
                userType = New Global.VBExe.VBExe_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.Activator = AddressOf Activate_4_VBUserControlFromWinrtComponent
                xamlType = userType

            Case 5     ' VCWinrtComponent.VCUserControlFromWinrtComponent
                userType = New Global.VBExe.VBExe_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.Activator = AddressOf Activate_5_VCUserControlFromWinrtComponent
                xamlType = userType

            Case 6     ' VBExe.MainPage
                userType = New Global.VBExe.VBExe_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
        ...
        Private ReadOnly Property OtherProviders As List(Of Global.Windows.UI.Xaml.Markup.IXamlMetadataProvider)
            Get
                If _otherProviders Is Nothing
                    ...
                    provider = New Global.CSharpLib.CSharpLib_XamlTypeInfo.XamlMetaDataProvider()
                    otherProvidersTmp.Add(provider)
                    provider = New Global.CSharpWinrtComponent.CSharpWinrtComponent_XamlTypeInfo.XamlMetaDataProvider()
                    otherProvidersTmp.Add(provider)
                    provider = New Global.VbLib.VbLib_XamlTypeInfo.XamlMetaDataProvider()
                    otherProvidersTmp.Add(provider)
                    provider = New Global.VbWinrtComponent.VbWinrtComponent_XamlTypeInfo.XamlMetaDataProvider()
                    otherProvidersTmp.Add(provider)
                    provider = New Global.VCWinrtComponent.VCWinrtComponent_XamlTypeInfo.XamlMetaDataProvider()
                    otherProvidersTmp.Add(provider)
        ...
        Private Function CreateXamlMember(ByVal longMemberName As String) As XamlMember
            Dim xamlMember As Global.VBExe.VBExe_XamlTypeInfo.XamlMember = Nothing
            ' No Local Properties
            Return xamlMember
        End Function
    ...
    Friend Class XamlUserType
        Inherits Global.VBExe.VBExe_XamlTypeInfo.XamlSystemBaseType
        ...
        Public Sub New(ByVal provider As Global.VBExe.VBExe_XamlTypeInfo.XamlTypeInfoProvider, ByVal fullName As String, ByVal fullType As Global.System.Type, ByVal baseType As Global.Windows.UI.Xaml.Markup.IXamlType)
    ...
    Friend Class XamlMember
        ...
        Public Sub New(ByVal provider As Global.VBExe.VBExe_XamlTypeInfo.XamlTypeInfoProvider, ByVal name As String, ByVal typeName As String)
            _name = name
            _typeName = typeName
            _provider = provider
        End Sub
