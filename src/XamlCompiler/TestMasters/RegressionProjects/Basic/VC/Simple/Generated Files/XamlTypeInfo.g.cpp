...
#include "CPPEventArgumentsTest.xaml.h"
#include "FieldModifierTests.xaml.h"
#include "App.xaml.h"
#include "MainPage.xaml.h"
#include "XamlBindingInfo.g.hpp"
#include "BlankPage.With.Dots.g.hpp"
#include "CPPEventArgumentsTest.g.hpp"
#include "FieldModifierTests.g.hpp"
#include "App.g.hpp"
...
::Platform::Object^ GetValueTypeMember_IntProp(::Platform::Object^ instance)
{
    return ref new ::Platform::Box<TValue>(safe_cast<TDeclaringType^>(instance)->IntProp);
}

template<typename TDeclaringType, typename TValue>
::Platform::Object^ GetValueTypeMember_DoubleProp(::Platform::Object^ instance)
{
    return ref new ::Platform::Box<TValue>(safe_cast<TDeclaringType^>(instance)->DoubleProp);
}

template<typename TDeclaringType, typename TValue>
::Platform::Object^ GetValueTypeMember_BooleanProp(::Platform::Object^ instance)
{
    return ref new ::Platform::Box<TValue>(safe_cast<TDeclaringType^>(instance)->BooleanProp);
}

template<typename TDeclaringType, typename TValue>
::Platform::Object^ GetValueTypeMember_Int16Prop(::Platform::Object^ instance)
{
    return ref new ::Platform::Box<TValue>(safe_cast<TDeclaringType^>(instance)->Int16Prop);
}
...
template<typename TDeclaringType>
::Platform::Object^ GetReferenceTypeMember_StringProp(::Platform::Object^ instance)
{
    return safe_cast<TDeclaringType^>(instance)->StringProp;
}

template<typename TDeclaringType, typename TValue>
void SetValueTypeMember_IntProp(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->IntProp = safe_cast<::Platform::IBox<TValue>^>(value)->Value;
}

template<typename TDeclaringType, typename TValue>
void SetValueTypeMember_DoubleProp(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->DoubleProp = safe_cast<::Platform::IBox<TValue>^>(value)->Value;
}

template<typename TDeclaringType, typename TValue>
void SetValueTypeMember_BooleanProp(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->BooleanProp = safe_cast<::Platform::IBox<TValue>^>(value)->Value;
}

template<typename TDeclaringType, typename TValue>
void SetValueTypeMember_Int16Prop(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->Int16Prop = safe_cast<::Platform::IBox<TValue>^>(value)->Value;
}

template<typename TDeclaringType, typename TValue>
void SetReferenceTypeMember_StringProp(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->StringProp = safe_cast<TValue^>(value);
}
...
const TypeInfo TypeInfos[] = 
{
    ...
    //   6
    L"Simple.MyGrid", L"",
    &ActivateType<::Simple::MyGrid>, nullptr, nullptr, nullptr,
    14, // Windows.UI.Xaml.Controls.Grid
    0, 0, -1, ::Windows::UI::Xaml::Interop::TypeKind::Custom,
    TypeInfo_Flags_IsLocalType | TypeInfo_Flags_None,
    -1,
    //   7
    L"Simple.MainPage", L"",
    &ActivateType<::Simple::MainPage>, nullptr, nullptr, nullptr,
    13, // Windows.UI.Xaml.Controls.Page
    0, 0, -1, ::Windows::UI::Xaml::Interop::TypeKind::Custom,
    TypeInfo_Flags_IsLocalType | TypeInfo_Flags_None,
    -1,
    //   8
    L"Simple.BlankPage", L"",
    &ActivateType<::Simple::BlankPage>, nullptr, nullptr, nullptr,
    10, // Simple.BlankPageBase
    0, 0, -1, ::Windows::UI::Xaml::Interop::TypeKind::Custom,
    TypeInfo_Flags_IsLocalType | TypeInfo_Flags_None,
    -1,
    //   9
    L"Simple.PropertyBag", L"",
    &ActivateType<::Simple::PropertyBag>, nullptr, nullptr, nullptr,
    3, // Object
    0, 0, -1, ::Windows::UI::Xaml::Interop::TypeKind::Custom,
    TypeInfo_Flags_IsLocalType | TypeInfo_Flags_None,
    -1,
    ...
    &ActivateType<::Simple::FieldModifierTests>, nullptr, nullptr, nullptr,
    13, // Windows.UI.Xaml.Controls.Page
    ...
    &ActivateType<::Simple::CPPEventArgumentsTest>, nullptr, nullptr, nullptr,
...
{
    //   0 - Simple.PropertyBag.StringProp
    L"StringProp",
    &GetReferenceTypeMember_StringProp<::Simple::PropertyBag>,
    &SetReferenceTypeMember_StringProp<::Simple::PropertyBag, ::Platform::String>,
    2, // String
    -1,
    false, false, false,
    //   1 - Simple.PropertyBag.IntProp
    L"IntProp",
    &GetValueTypeMember_IntProp<::Simple::PropertyBag, ::default::int32>,
    &SetValueTypeMember_IntProp<::Simple::PropertyBag, ::default::int32>,
    0, // Int32
    -1,
    false, false, false,
    //   2 - Simple.PropertyBag.DoubleProp
    L"DoubleProp",
    &GetValueTypeMember_DoubleProp<::Simple::PropertyBag, ::default::float64>,
    &SetValueTypeMember_DoubleProp<::Simple::PropertyBag, ::default::float64>,
    4, // Double
    -1,
    false, false, false,
    //   3 - Simple.PropertyBag.BooleanProp
    L"BooleanProp",
    &GetValueTypeMember_BooleanProp<::Simple::PropertyBag, ::Platform::Boolean>,
    &SetValueTypeMember_BooleanProp<::Simple::PropertyBag, ::Platform::Boolean>,
    5, // Boolean
    -1,
    false, false, false,
    //   4 - Simple.PropertyBag.Int16Prop
    L"Int16Prop",
    &GetValueTypeMember_Int16Prop<::Simple::PropertyBag, ::default::int16>,
    &SetValueTypeMember_Int16Prop<::Simple::PropertyBag, ::default::int16>,
    1, // Int16
    -1,
    false, false, false,
    //   5 - Simple.BlankPageBase.Foo
    L"Foo",
    &GetReferenceTypeMember_Foo<::Simple::BlankPageBase>,
    nullptr,
    2, // String
    -1,
    true,  false, false,
