...
struct WINRT_EBO NameEventsLoad_base : implements<D, ConditionalsCppWinRT::INameEventsLoad, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, composing, I...>,
...
{
    using base_type = NameEventsLoad_base;
    using class_type = ConditionalsCppWinRT::NameEventsLoad;
    using implements_type = typename NameEventsLoad_base::implements_type;
    ...
    {
        return L"ConditionalsCppWinRT.NameEventsLoad";
    }
    NameEventsLoad_base()
    {
...
struct WINRT_EBO NameEventsLoadT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
{
    using instance_type = ConditionalsCppWinRT::NameEventsLoad;
...
#if defined(WINRT_FORCE_INCLUDE_NAMEEVENTSLOAD_XAML_G_H) || __has_include("NameEventsLoad.xaml.g.h")

#include "NameEventsLoad.xaml.g.h"
...
{
    template <typename D, typename... I>
    using NameEventsLoadT = NameEventsLoad_base<D, I...>;
}
