...
namespace winrt::ConditionalsCppWinRT::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES NameEventsLoad_base : implements<D, ConditionalsCppWinRT::NameEventsLoad, composing, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
...
namespace winrt::ConditionalsCppWinRT::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES NameEventsLoadT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
