...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) EventTests_base : implements<D, BindTestbed::EventTests, composing, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = EventTests_base;
        using class_type = BindTestbed::EventTests;
        using implements_type = typename EventTests_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.EventTests";
        }
        EventTests_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) EventTestsT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::EventTests;
...
#if defined(WINRT_FORCE_INCLUDE_EVENTTESTS_XAML_G_H) || __has_include("EventTests.xaml.g.h")
#include "EventTests.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using EventTestsT = EventTests_base<D, I...>;
}
