...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) LonelyStaticBinding_base : implements<D, BindTestbed::LonelyStaticBinding, composing, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = LonelyStaticBinding_base;
        using class_type = BindTestbed::LonelyStaticBinding;
        using implements_type = typename LonelyStaticBinding_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.LonelyStaticBinding";
        }
        LonelyStaticBinding_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) LonelyStaticBindingT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::LonelyStaticBinding;
...
#if defined(WINRT_FORCE_INCLUDE_LONELYSTATICBINDING_XAML_G_H) || __has_include("LonelyStaticBinding.xaml.g.h")
#include "LonelyStaticBinding.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using LonelyStaticBindingT = LonelyStaticBinding_base<D, I...>;
}
