...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) DetectLeaksPage_base : implements<D, BindTestbed::DetectLeaksPage, composing, ::Windows::UI::Xaml::Controls::IPageOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = DetectLeaksPage_base;
        using class_type = BindTestbed::DetectLeaksPage;
        using implements_type = typename DetectLeaksPage_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.DetectLeaksPage";
        }
        DetectLeaksPage_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) DetectLeaksPageT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::DetectLeaksPage;
...
#if defined(WINRT_FORCE_INCLUDE_DETECTLEAKSPAGE_XAML_G_H) || __has_include("DetectLeaksPage.xaml.g.h")
#include "DetectLeaksPage.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using DetectLeaksPageT = DetectLeaksPage_base<D, I...>;
}
