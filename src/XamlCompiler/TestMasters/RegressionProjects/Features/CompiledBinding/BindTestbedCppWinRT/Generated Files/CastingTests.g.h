...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) CastingTests_base : implements<D, BindTestbed::CastingTests, composing, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = CastingTests_base;
        using class_type = BindTestbed::CastingTests;
        using implements_type = typename CastingTests_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.CastingTests";
        }
        CastingTests_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) CastingTestsT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::CastingTests;
...
#if defined(WINRT_FORCE_INCLUDE_CASTINGTESTS_XAML_G_H) || __has_include("CastingTests.xaml.g.h")
#include "CastingTests.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using CastingTestsT = CastingTests_base<D, I...>;
}
