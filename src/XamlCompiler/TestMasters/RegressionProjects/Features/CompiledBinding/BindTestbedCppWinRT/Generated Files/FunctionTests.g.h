...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) FunctionTests_base : implements<D, BindTestbed::FunctionTests, composing, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = FunctionTests_base;
        using class_type = BindTestbed::FunctionTests;
        using implements_type = typename FunctionTests_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.FunctionTests";
        }
        FunctionTests_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) FunctionTestsT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::FunctionTests;
...
#if defined(WINRT_FORCE_INCLUDE_FUNCTIONTESTS_XAML_G_H) || __has_include("FunctionTests.xaml.g.h")
#include "FunctionTests.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using FunctionTestsT = FunctionTests_base<D, I...>;
}
