...
namespace winrt::BindTestbed::subfolder::implementation
{
    ...
    struct SubDictionaryT : public ::winrt::BindTestbed::subfolder::implementation::SubDictionary_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename SubDictionaryT::base_type;
        using base_type::base_type;
        using class_type = typename SubDictionaryT::class_type;
    ...
    private:
        struct SubDictionary_obj3_Bindings;
        struct SubDictionary_obj1_Bindings;
