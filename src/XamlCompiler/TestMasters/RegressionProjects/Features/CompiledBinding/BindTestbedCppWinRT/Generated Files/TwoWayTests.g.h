...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) TwoWayTests_base : implements<D, BindTestbed::TwoWayTests, composing, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = TwoWayTests_base;
        using class_type = BindTestbed::TwoWayTests;
        using implements_type = typename TwoWayTests_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.TwoWayTests";
        }
        TwoWayTests_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) TwoWayTestsT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::TwoWayTests;
...
#if defined(WINRT_FORCE_INCLUDE_TWOWAYTESTS_XAML_G_H) || __has_include("TwoWayTests.xaml.g.h")
#include "TwoWayTests.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using TwoWayTestsT = TwoWayTests_base<D, I...>;
}
