...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) ListAndTemplateTests_base : implements<D, BindTestbed::ListAndTemplateTests, composing, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = ListAndTemplateTests_base;
        using class_type = BindTestbed::ListAndTemplateTests;
        using implements_type = typename ListAndTemplateTests_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.ListAndTemplateTests";
        }
        ListAndTemplateTests_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) ListAndTemplateTestsT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::ListAndTemplateTests;
...
#if defined(WINRT_FORCE_INCLUDE_LISTANDTEMPLATETESTS_XAML_G_H) || __has_include("ListAndTemplateTests.xaml.g.h")
#include "ListAndTemplateTests.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using ListAndTemplateTestsT = ListAndTemplateTests_base<D, I...>;
}
