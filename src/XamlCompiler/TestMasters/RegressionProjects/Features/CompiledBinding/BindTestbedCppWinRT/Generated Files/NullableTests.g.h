...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) NullableTests_base : implements<D, BindTestbed::NullableTests, composing, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = NullableTests_base;
        using class_type = BindTestbed::NullableTests;
        using implements_type = typename NullableTests_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.NullableTests";
        }
        NullableTests_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) NullableTestsT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::NullableTests;
...
#if defined(WINRT_FORCE_INCLUDE_NULLABLETESTS_XAML_G_H) || __has_include("NullableTests.xaml.g.h")
#include "NullableTests.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using NullableTestsT = NullableTests_base<D, I...>;
}
