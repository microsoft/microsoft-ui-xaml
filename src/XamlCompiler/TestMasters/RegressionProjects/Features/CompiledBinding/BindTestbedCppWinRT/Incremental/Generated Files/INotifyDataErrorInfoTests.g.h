...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) INotifyDataErrorInfoTests_base : implements<D, BindTestbed::INotifyDataErrorInfoTests, composing, ::Windows::UI::Xaml::Controls::IPageOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = INotifyDataErrorInfoTests_base;
        using class_type = BindTestbed::INotifyDataErrorInfoTests;
        using implements_type = typename INotifyDataErrorInfoTests_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.INotifyDataErrorInfoTests";
        }
        INotifyDataErrorInfoTests_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) INotifyDataErrorInfoTestsT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::INotifyDataErrorInfoTests;
...
#if defined(WINRT_FORCE_INCLUDE_INOTIFYDATAERRORINFOTESTS_XAML_G_H) || __has_include("INotifyDataErrorInfoTests.xaml.g.h")
#include "INotifyDataErrorInfoTests.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using INotifyDataErrorInfoTestsT = INotifyDataErrorInfoTests_base<D, I...>;
}
