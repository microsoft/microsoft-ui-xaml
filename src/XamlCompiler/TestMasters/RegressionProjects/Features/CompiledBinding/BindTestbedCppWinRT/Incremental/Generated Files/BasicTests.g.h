...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) BasicTests_base : implements<D, BindTestbed::BasicTests, composing, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) BasicTestsT : implements<D, ::Windows::Foundation::IActivationFactory, BindTestbed::IBasicTestsStatics, I...>
    {
        ...
        auto DPOnPageProperty()
        {
            return T::DPOnPageProperty();
        }
        auto DPOnPageProperty(::Windows::UI::Xaml::DependencyProperty const& value)
        {
            return T::DPOnPageProperty(value);
        }
    };
}
