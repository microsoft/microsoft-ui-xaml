...
namespace winrt::BindTestbed::implementation
{
    ...
    struct __declspec(empty_bases) TestsPage2_base : implements<D, BindTestbed::TestsPage2, composing, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = TestsPage2_base;
        using class_type = BindTestbed::TestsPage2;
        using implements_type = typename TestsPage2_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.TestsPage2";
        }
        TestsPage2_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) TestsPage2T : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::TestsPage2;
...
#if defined(WINRT_FORCE_INCLUDE_TESTSPAGE2_XAML_G_H) || __has_include("TestsPage2.xaml.g.h")
#include "TestsPage2.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using TestsPage2T = TestsPage2_base<D, I...>;
}
