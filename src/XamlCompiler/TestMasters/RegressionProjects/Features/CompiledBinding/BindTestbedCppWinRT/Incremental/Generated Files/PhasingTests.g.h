...
namespace winrt::BindTestbed::implementation
{
    ...
    {
        using base_type = PhasingTests_base;
        using class_type = BindTestbed::PhasingTests;
        using implements_type = typename PhasingTests_base::implements_type;
        using implements_type::implements_type;
        using composable_base = ::Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"BindTestbed.PhasingTests";
        }
        PhasingTests_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct __declspec(empty_bases) PhasingTestsT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::PhasingTests;
...
#if defined(WINRT_FORCE_INCLUDE_PHASINGTESTS_XAML_G_H) || __has_include("PhasingTests.xaml.g.h")
#include "PhasingTests.xaml.g.h"
#else

namespace winrt::BindTestbed::implementation
{
    template <typename D, typename... I>
    using PhasingTestsT = PhasingTests_base<D, I...>;
}
