...
void ::BindTestbed::MyUserControl1::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
/// </summary>
class BindTestbed::MyUserControl1::MyUserControl1_obj1_Bindings 
    : public ::XamlBindingInfo::ReferenceTypeXamlBindings<::BindTestbed::MyUserControl1, ::XamlBindingInfo::XamlBindingTrackingBase>
...
private:
    ...
    void Update_(::BindTestbed::MyUserControl1^ obj, int phase)
    {
    ...
    void DependencyPropertyChanged(::Windows::UI::Xaml::DependencyObject^ sender, ::Windows::UI::Xaml::DependencyProperty^ prop)
    {
        if (sender != nullptr)
        {
            ...
            {
                ::BindTestbed::MyUserControl1^ obj = safe_cast<::BindTestbed::MyUserControl1^>(sender);
                if (obj != nullptr)
                {
...
bool BindTestbed::MyUserControl1::MyUserControl1_obj1_Bindings::isobj5TextDisabled = false;

void ::BindTestbed::MyUserControl1::Connect(int __connectionId, ::Platform::Object^ __target)
{
    switch (__connectionId)
    {
    case 4:
        {
            ...
            (safe_cast<::Windows::UI::Xaml::Controls::TextBlock^>(element4))->Tapped += ref new ::Windows::UI::Xaml::Input::TappedEventHandler(this, (void (::BindTestbed::MyUserControl1::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::BindTestbed::MyUserControl1::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
