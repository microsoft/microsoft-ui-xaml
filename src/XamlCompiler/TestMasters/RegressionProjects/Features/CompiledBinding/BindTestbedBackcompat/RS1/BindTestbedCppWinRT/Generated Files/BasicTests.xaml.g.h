...
namespace winrt::BindTestbed::implementation
{
    ...
    struct BasicTestsT : public ::winrt::BindTestbed::implementation::BasicTests_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename BasicTestsT::base_type;
        using base_type::base_type;
        using class_type = typename BasicTestsT::class_type;
    ...
    private:
        struct BasicTests_obj1_Bindings;
