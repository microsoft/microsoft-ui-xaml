...
Namespace Global.ProviderVb.ProviderVb_XamlTypeInfo
    ...
    Public NotInheritable Class XamlMetaDataProvider
        ...
        Private _provider As Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlTypeInfoProvider
        Private ReadOnly Property Provider As Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlTypeInfoProvider
            Get
                If _provider Is Nothing
                    _provider = New Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlTypeInfoProvider()
                End If
                Return _provider
            End Get
        End Property
    ...
    Friend Class XamlTypeInfoProvider
        ...
        Private Sub InitTypeTables()
            _typeNameTable(0) = "ProviderVb.MainPage"
            _typeNameTable(1) = "Windows.UI.Xaml.Controls.Page"
            _typeNameTable(2) = "Windows.UI.Xaml.Controls.UserControl"
            _typeTable(0) = GetType(Global.ProviderVb.MainPage)
        ...
        Private Function Activate_0_MainPage() As Global.System.Object
            Return New Global.ProviderVb.MainPage()
        End Function


        Private Function CreateXamlType(ByVal typeIndex As Integer) As Global.Windows.UI.Xaml.Markup.IXamlType
            Dim xamlType As Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlSystemBaseType = Nothing
            Dim userType As Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlUserType
            Dim typeName As String = _typeNameTable(typeIndex)
            Dim type As Global.System.Type = _typeTable(typeIndex)

            Select Case typeIndex
            Case 0     ' ProviderVb.MainPage
                userType = New Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
                userType.Activator = AddressOf Activate_0_MainPage
                userType.SetIsLocalType()
                xamlType = userType

            Case 1     ' Windows.UI.Xaml.Controls.Page
                xamlType = New Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlSystemBaseType(typeName, type)
        ...
        Private Function CreateXamlMember(ByVal longMemberName As String) As XamlMember
            Dim xamlMember As Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlMember = Nothing
            ' No Local Properties
            Return xamlMember
        End Function
    ...
    Friend Class XamlUserType
        Inherits Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlSystemBaseType
        ...
        Public Sub New(ByVal provider As Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlTypeInfoProvider, ByVal fullName As String, ByVal fullType As Global.System.Type, ByVal baseType As Global.Windows.UI.Xaml.Markup.IXamlType)
    ...
    Friend Class XamlMember
        ...
        Public Sub New(ByVal provider As Global.ProviderVb.ProviderVb_XamlTypeInfo.XamlTypeInfoProvider, ByVal name As String, ByVal typeName As String)
            _name = name
            _typeName = typeName
            _provider = provider
        End Sub
