...
Public Class Program
    ...
    Shared Sub Main(ByVal args() As String)
        Global.Windows.UI.Xaml.Application.Start(Function(p) New Global.ConsumerVb.App())
    End Sub
...
Partial Class App
    ...
    End Sub
    Private Partial Sub _AddOtherProvider(otherProvider as Global.Windows.UI.Xaml.Markup.IXamlMetadataProvider)
    End Sub
