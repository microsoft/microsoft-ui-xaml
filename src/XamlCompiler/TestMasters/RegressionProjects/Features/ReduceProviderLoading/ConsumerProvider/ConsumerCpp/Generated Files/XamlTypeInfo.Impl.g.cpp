...
{
    namespace ConsumerCpp_XamlTypeInfo
    {
...
void ::ConsumerCpp::ConsumerCpp_XamlTypeInfo::XamlMetaDataProvider::AddOtherProvider(::Windows::UI::Xaml::Markup::IXamlMetadataProvider^ otherProvider)
{
    Provider->AddOtherProvider(otherProvider);
}

[::Windows::Foundation::Metadata::DefaultOverload]
::Windows::UI::Xaml::Markup::IXamlType^ ::ConsumerCpp::ConsumerCpp_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return Provider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::ConsumerCpp::ConsumerCpp_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(Platform::String^ fullName)
{
    return Provider->GetXamlTypeByName(fullName);
}

Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::ConsumerCpp::ConsumerCpp_XamlTypeInfo::XamlMetaDataProvider::GetXmlnsDefinitions()
{
    return ref new Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::ConsumerCpp::ConsumerCpp_XamlTypeInfo::XamlMetaDataProvider::Provider::get()
{
...
void ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::AddOtherProvider(::Windows::UI::Xaml::Markup::IXamlMetadataProvider^ otherProvider)
{
