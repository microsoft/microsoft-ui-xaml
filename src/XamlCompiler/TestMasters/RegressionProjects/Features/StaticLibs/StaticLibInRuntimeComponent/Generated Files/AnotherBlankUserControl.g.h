...
struct WINRT_EBO AnotherBlankUserControl_base : implements<D, StaticLibInRuntimeComponent::IAnotherBlankUserControl, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, composing, I...>,
...
struct WINRT_EBO AnotherBlankUserControlT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
{
