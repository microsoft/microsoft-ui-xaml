...
Namespace Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Windows.UI.Xaml.Build.Tasks", " 0.0.0.0")>  _
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
    <Global.Windows.UI.Xaml.Markup.FullXamlMetadataProvider()>  _
    Public NotInheritable Class XamlMetaDataProvider
        Implements Global.Windows.UI.Xaml.Markup.IXamlMetadataProvider
        Private _provider As Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlTypeInfoProvider
        Private ReadOnly Property Provider As Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlTypeInfoProvider
            Get
                If _provider Is Nothing
                    _provider = New Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlTypeInfoProvider()
                End If
                Return _provider
            End Get
        End Property
    ...
    Friend Class XamlTypeInfoProvider
        Public Function GetXamlTypeByType(ByVal type As Global.System.Type) As Global.Windows.UI.Xaml.Markup.IXamlType
            ...
            SyncLock _xamlTypeCacheByType
                ...
                End If
                Dim userXamlType As Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType = TryCast(xamlType, Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType)
        ...
        Private _typeNameTable(5) As String
        Private _typeTable(5) As Global.System.Type

        Private Sub InitTypeTables()
            _typeNameTable(1) = "Windows.UI.Xaml.Controls.UserControl"
            _typeNameTable(2) = "String"
            _typeNameTable(3) = "SubControlsVB.T"
            _typeNameTable(4) = "ControlsVB.A"
            _typeNameTable(5) = "ControlsVB.B"
            _typeTable(1) = GetType(Global.Windows.UI.Xaml.Controls.UserControl)
            _typeTable(2) = GetType(Global.System.String)
            _typeTable(3) = GetType(Global.SubControlsVB.T)
            _typeTable(4) = GetType(Global.ControlsVB.A)
            _typeTable(5) = GetType(Global.ControlsVB.B)
        End Sub
        ...
        Private Function Activate_3_T() As Global.System.Object
            Return New Global.SubControlsVB.T()
        End Function

        Private Function Activate_4_A() As Global.System.Object
            Return New Global.ControlsVB.A()
        End Function

        Private Function Activate_5_B() As Global.System.Object
            Return New Global.ControlsVB.B()
        End Function


        Private Function CreateXamlType(ByVal typeIndex As Integer) As Global.Windows.UI.Xaml.Markup.IXamlType
            Dim xamlType As Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlSystemBaseType = Nothing
            Dim userType As Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType
            ...
            Case 1     ' Windows.UI.Xaml.Controls.UserControl
                xamlType = New Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlSystemBaseType(typeName, type)

            Case 2     ' String
                xamlType = New Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlSystemBaseType(typeName, type)

            Case 3     ' SubControlsVB.T
                userType = New Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.SetIsReturnTypeStub()
                xamlType = userType

            Case 4     ' ControlsVB.A
                userType = New Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.Activator = AddressOf Activate_4_A
            ...
            Case 5     ' ControlsVB.B
                userType = New Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.Activator = AddressOf Activate_5_B
        ...
        Private ReadOnly Property OtherProviders As List(Of Global.Windows.UI.Xaml.Markup.IXamlMetadataProvider)
            Get
                If _otherProviders Is Nothing
                    ...
                    provider = New Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlMetaDataProvider()
        ...
        Private Function get_0_S_StringPropertyOnS(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.SubControlsVB.S = CType(instance, Global.SubControlsVB.S)
            Return that.StringPropertyOnS
        End Function
        Private Function get_1_S_TPropertyOnS(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.SubControlsVB.S = CType(instance, Global.SubControlsVB.S)
            Return that.TPropertyOnS
        End Function
        Private Function get_2_A_StringPropertyOnA(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.ControlsVB.A = CType(instance, Global.ControlsVB.A)
            Return that.StringPropertyOnA
        End Function
        Private Function get_3_A_BPropertyOnA(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.ControlsVB.A = CType(instance, Global.ControlsVB.A)
            Return that.BPropertyOnA
        End Function
        Private Function get_4_B_StringPropertyOnB(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.ControlsVB.B = CType(instance, Global.ControlsVB.B)
            Return that.StringPropertyOnB
        End Function

        Private Function CreateXamlMember(ByVal longMemberName As String) As XamlMember
            Dim xamlMember As Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlMember = Nothing
            Dim userType As Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType

            Select Case longMemberName
            Case "SubControlsVB.S.StringPropertyOnS"
                userType = CType(GetXamlTypeByName("SubControlsVB.S"), Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlMember(Me, "StringPropertyOnS", "String")
                xamlMember.Getter = AddressOf get_0_S_StringPropertyOnS
                xamlMember.SetIsReadOnly()
            Case "SubControlsVB.S.TPropertyOnS"
                userType = CType(GetXamlTypeByName("SubControlsVB.S"), Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlMember(Me, "TPropertyOnS", "SubControlsVB.T")
                xamlMember.Getter = AddressOf get_1_S_TPropertyOnS
                xamlMember.SetIsReadOnly()
            Case "ControlsVB.A.StringPropertyOnA"
                userType = CType(GetXamlTypeByName("ControlsVB.A"), Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlMember(Me, "StringPropertyOnA", "String")
                xamlMember.Getter = AddressOf get_2_A_StringPropertyOnA
                xamlMember.SetIsReadOnly()
            Case "ControlsVB.A.BPropertyOnA"
                userType = CType(GetXamlTypeByName("ControlsVB.A"), Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlMember(Me, "BPropertyOnA", "ControlsVB.B")
                xamlMember.Getter = AddressOf get_3_A_BPropertyOnA
                xamlMember.SetIsReadOnly()
            Case "ControlsVB.B.StringPropertyOnB"
                userType = CType(GetXamlTypeByName("ControlsVB.B"), Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlMember(Me, "StringPropertyOnB", "String")
                xamlMember.Getter = AddressOf get_4_B_StringPropertyOnB
                xamlMember.SetIsReadOnly()
            End Select
            Return xamlMember
        End Function
    ...
    Friend Class XamlUserType
        Inherits Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlSystemBaseType
        ...
        Public Sub New(ByVal provider As Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlTypeInfoProvider, ByVal fullName As String, ByVal fullType As Global.System.Type, ByVal baseType As Global.Windows.UI.Xaml.Markup.IXamlType)
    ...
    Friend Class XamlMember
        ...
        Public Sub New(ByVal provider As Global.ControlsVB.LinkedMdControlsVB_XamlTypeInfo.XamlTypeInfoProvider, ByVal name As String, ByVal typeName As String)
            _name = name
            _typeName = typeName
            _provider = provider
        End Sub
