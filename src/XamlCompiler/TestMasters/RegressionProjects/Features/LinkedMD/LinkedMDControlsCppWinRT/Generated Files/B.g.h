...
struct WINRT_EBO B_base : implements<D, LinkedMDControlsCppWinRT::IB, ::Windows::UI::Xaml::Controls::IControlOverrides, ::Windows::UI::Xaml::Controls::IControlOverrides6, ::Windows::UI::Xaml::Controls::IPageOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides, ::Windows::UI::Xaml::IFrameworkElementOverrides2, ::Windows::UI::Xaml::IUIElementOverrides, ::Windows::UI::Xaml::IUIElementOverrides7, ::Windows::UI::Xaml::IUIElementOverrides8, ::Windows::UI::Xaml::IUIElementOverrides9, composing, I...>,
...
{
    using base_type = B_base;
    using class_type = LinkedMDControlsCppWinRT::B;
    using implements_type = typename B_base::implements_type;
    ...
    {
        return L"LinkedMDControlsCppWinRT.B";
    }
    B_base()
    {
...
struct WINRT_EBO BT : implements<D, ::Windows::Foundation::IActivationFactory, I...>
{
    using instance_type = LinkedMDControlsCppWinRT::B;
...
#if defined(WINRT_FORCE_INCLUDE_B_XAML_G_H) || __has_include("B.xaml.g.h")
