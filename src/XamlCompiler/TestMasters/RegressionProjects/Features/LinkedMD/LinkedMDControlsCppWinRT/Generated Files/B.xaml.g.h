...
namespace winrt::LinkedMDControlsCppWinRT::implementation
{
    ...
    struct BT : public ::winrt::LinkedMDControlsCppWinRT::implementation::B_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename BT::base_type;
        using base_type::base_type;
        using class_type = typename BT::class_type;
