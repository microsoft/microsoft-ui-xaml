...
namespace winrt::LinkedMDSubControlsCppWinRT::implementation
{
    ...
    struct TT : public ::winrt::LinkedMDSubControlsCppWinRT::implementation::T_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename TT::base_type;
        using base_type::base_type;
        using class_type = typename TT::class_type;
