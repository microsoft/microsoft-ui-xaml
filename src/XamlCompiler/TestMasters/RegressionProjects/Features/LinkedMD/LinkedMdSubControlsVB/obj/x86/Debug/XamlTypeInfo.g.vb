...
Namespace Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo
    ...
    Public NotInheritable Class XamlMetaDataProvider
        ...
        Private _provider As Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlTypeInfoProvider
        Private ReadOnly Property Provider As Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlTypeInfoProvider
            Get
                If _provider Is Nothing
                    _provider = New Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlTypeInfoProvider()
                End If
                Return _provider
            End Get
        End Property
    ...
    Friend Class XamlTypeInfoProvider
        ...
        Private Sub InitTypeTables()
            _typeNameTable(0) = "SubControlsVB.S"
            _typeNameTable(1) = "Windows.UI.Xaml.Controls.UserControl"
            _typeNameTable(2) = "String"
            _typeNameTable(3) = "SubControlsVB.T"
            _typeTable(0) = GetType(Global.SubControlsVB.S)
        ...
        Private Function Activate_0_S() As Global.System.Object
            Return New Global.SubControlsVB.S()
        End Function
        ...
        Private Function CreateXamlType(ByVal typeIndex As Integer) As Global.Windows.UI.Xaml.Markup.IXamlType
            Dim xamlType As Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlSystemBaseType = Nothing
            Dim userType As Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlUserType
            Dim typeName As String = _typeNameTable(typeIndex)
            Dim type As Global.System.Type = _typeTable(typeIndex)

            Select Case typeIndex
            Case 0     ' SubControlsVB.S
                userType = New Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.Activator = AddressOf Activate_0_S
            ...
            Case 1     ' Windows.UI.Xaml.Controls.UserControl
                xamlType = New Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlSystemBaseType(typeName, type)
            ...
            Case 3     ' SubControlsVB.T
                userType = New Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"))
                userType.Activator = AddressOf Activate_3_T
        ...
        End Function
        Private Function get_2_T_StringPropertyOnT(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.SubControlsVB.T = CType(instance, Global.SubControlsVB.T)
            Return that.StringPropertyOnT
        End Function

        Private Function CreateXamlMember(ByVal longMemberName As String) As XamlMember
            Dim xamlMember As Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlMember = Nothing
            Dim userType As Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlUserType

            Select Case longMemberName
            Case "SubControlsVB.S.StringPropertyOnS"
                userType = CType(GetXamlTypeByName("SubControlsVB.S"), Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlMember(Me, "StringPropertyOnS", "String")
                xamlMember.Getter = AddressOf get_0_S_StringPropertyOnS
                xamlMember.SetIsReadOnly()
            Case "SubControlsVB.S.TPropertyOnS"
                userType = CType(GetXamlTypeByName("SubControlsVB.S"), Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlMember(Me, "TPropertyOnS", "SubControlsVB.T")
                xamlMember.Getter = AddressOf get_1_S_TPropertyOnS
                xamlMember.SetIsReadOnly()
            Case "SubControlsVB.T.StringPropertyOnT"
                userType = CType(GetXamlTypeByName("SubControlsVB.T"), Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlMember(Me, "StringPropertyOnT", "String")
                xamlMember.Getter = AddressOf get_2_T_StringPropertyOnT
                xamlMember.SetIsReadOnly()
            End Select
            Return xamlMember
        End Function
    ...
    Friend Class XamlUserType
        Inherits Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlSystemBaseType
        ...
        Public Sub New(ByVal provider As Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlTypeInfoProvider, ByVal fullName As String, ByVal fullType As Global.System.Type, ByVal baseType As Global.Windows.UI.Xaml.Markup.IXamlType)
    ...
    Friend Class XamlMember
        ...
        Public Sub New(ByVal provider As Global.SubControlsVB.LinkedMdSubControlsVB_XamlTypeInfo.XamlTypeInfoProvider, ByVal name As String, ByVal typeName As String)
            _name = name
            _typeName = typeName
            _provider = provider
        End Sub
