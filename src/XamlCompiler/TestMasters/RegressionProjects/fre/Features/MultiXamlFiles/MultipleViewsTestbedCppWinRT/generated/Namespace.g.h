...
namespace winrt::MultipleViewsTestbedCppWinRT::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Namespace_base : implements<D, MultipleViewsTestbedCppWinRT::Namespace, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = Namespace_base;
        using class_type = MultipleViewsTestbedCppWinRT::Namespace;
        using implements_type = typename Namespace_base::implements_type;
        ...
        {
            return L"MultipleViewsTestbedCppWinRT.Namespace";
        }
        Namespace_base()
        {
...
namespace winrt::MultipleViewsTestbedCppWinRT::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES NamespaceT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = MultipleViewsTestbedCppWinRT::Namespace;
...
#if defined(WINRT_FORCE_INCLUDE_NAMESPACE_XAML_G_H) || __has_include("Namespace.xaml.g.h")

#include "Namespace.xaml.g.h"
...
{
    template <typename D, typename... I>
    using NamespaceT = Namespace_base<D, I...>;
}
