...
namespace winrt::MultipleViewsTestbedCppWinRT::implementation
{
    ...
    struct NamespaceT : public ::winrt::MultipleViewsTestbedCppWinRT::implementation::Namespace_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename NamespaceT::base_type;
        using base_type::base_type;
        using class_type = typename NamespaceT::class_type;
    ...
    private:
        struct Namespace_obj1_Bindings;
        struct Namespace_obj2_Bindings;
