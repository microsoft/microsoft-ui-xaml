...
namespace winrt::BindTestbed::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MyInfo_base : implements<D, BindTestbed::MyInfo, I...>
    {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MyInfoT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
