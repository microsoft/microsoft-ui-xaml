...
namespace winrt::BindTestbed::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES xPropertiesTest_base : implements<D, BindTestbed::xPropertiesTest, composing, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = xPropertiesTest_base;
        using class_type = BindTestbed::xPropertiesTest;
        using implements_type = typename xPropertiesTest_base::implements_type;
        ...
        {
            return L"BindTestbed.xPropertiesTest";
        }
        xPropertiesTest_base()
        {
...
namespace winrt::BindTestbed::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES xPropertiesTestT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = BindTestbed::xPropertiesTest;
...
#if defined(WINRT_FORCE_INCLUDE_XPROPERTIESTEST_XAML_G_H) || __has_include("xPropertiesTest.xaml.g.h")

#include "xPropertiesTest.xaml.g.h"
...
{
    template <typename D, typename... I>
    using xPropertiesTestT = xPropertiesTest_base<D, I...>;
}
