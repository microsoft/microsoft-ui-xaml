...
namespace winrt::MetadataTestbedCppWinRT::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainPage_base : implements<D, MetadataTestbedCppWinRT::MainPage, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
        ...
        winrt::Microsoft::UI::Xaml::Controls::IPageOverridesT<D>, winrt::Microsoft::UI::Xaml::Controls::IControlOverridesT<D>, winrt::Microsoft::UI::Xaml::IFrameworkElementOverridesT<D>, winrt::Microsoft::UI::Xaml::IUIElementOverridesT<D>
    {
        ...
        using class_type = MetadataTestbedCppWinRT::MainPage;
        ...
        {
            return L"MetadataTestbedCppWinRT.MainPage";
        }
        MainPage_base()
        {
...
namespace winrt::MetadataTestbedCppWinRT::factory_implementation
{
    ...
    {
        using instance_type = MetadataTestbedCppWinRT::MainPage;
