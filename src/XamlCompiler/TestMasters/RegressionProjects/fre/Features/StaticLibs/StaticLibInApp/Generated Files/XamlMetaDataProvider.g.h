...
namespace winrt::StaticLibInApp::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, StaticLibInApp::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = StaticLibInApp::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"StaticLibInApp.XamlMetaDataProvider";
        }
    };
}
namespace winrt::StaticLibInApp::factory_implementation
{
    ...
    {
        using instance_type = StaticLibInApp::XamlMetaDataProvider;
