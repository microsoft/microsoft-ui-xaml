...
namespace winrt::ConsumerCppWinRT::implementation
{
    ...
    void XamlMetaDataProvider::AddOtherProvider(IXamlMetadataProvider otherProvider)
    {
    ...
    void XamlTypeInfoProvider::AddOtherProvider(IXamlMetadataProvider otherProvider)
    {
         std::lock_guard<std::recursive_mutex> lock(_xamlTypesCriticalSection);
