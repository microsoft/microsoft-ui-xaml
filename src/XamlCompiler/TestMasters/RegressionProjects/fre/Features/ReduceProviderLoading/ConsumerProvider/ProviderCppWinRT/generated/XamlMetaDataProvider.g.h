...
namespace winrt::ProviderCppWinRT::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, ProviderCppWinRT::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = ProviderCppWinRT::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"ProviderCppWinRT.XamlMetaDataProvider";
        }
    };
}
namespace winrt::ProviderCppWinRT::factory_implementation
{
    ...
    {
        using instance_type = ProviderCppWinRT::XamlMetaDataProvider;
