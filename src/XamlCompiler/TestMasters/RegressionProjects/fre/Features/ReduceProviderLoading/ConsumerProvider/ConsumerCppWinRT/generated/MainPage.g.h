...
#pragma once
#include "winrt/ConsumerCppWinRT.h"
...
namespace winrt::ConsumerCppWinRT::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainPage_base : implements<D, ConsumerCppWinRT::MainPage, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
        ...
        winrt::Microsoft::UI::Xaml::Controls::IPageOverridesT<D>, winrt::Microsoft::UI::Xaml::Controls::IControlOverridesT<D>, winrt::Microsoft::UI::Xaml::IFrameworkElementOverridesT<D>, winrt::Microsoft::UI::Xaml::IUIElementOverridesT<D>
    {
        ...
        using class_type = ConsumerCppWinRT::MainPage;
        ...
        {
            return L"ConsumerCppWinRT.MainPage";
        }
        MainPage_base()
        {
...
namespace winrt::ConsumerCppWinRT::factory_implementation
{
    ...
    {
        using instance_type = ConsumerCppWinRT::MainPage;
