...
namespace winrt::CppWinRTComponent::implementation
{
    ...
    void CppWinRTUserControlFromWinRTComponentT<D, I...>::InitializeComponent()
    {
        if (!_contentLoaded)
        {
            _contentLoaded = true;
            ::winrt::Windows::Foundation::Uri resourceLocator{ L"ms-appx:///CppWinRTComponent/CppWinRTUserControlFromWinRTComponent.xaml" };
            ::winrt::Microsoft::UI::Xaml::Application::LoadComponent(*this, resourceLocator, ComponentResourceLocation::Nested);
        }
    }

    template <typename D, typename... I>
    void CppWinRTUserControlFromWinRTComponentT<D, I...>::Connect(int32_t, IInspectable const&)
    {
        _contentLoaded = true;
    }

    template <typename D, typename ... I>
    void CppWinRTUserControlFromWinRTComponentT<D, I...>::DisconnectUnloadedObject(int32_t)
    {
        throw ::winrt::hresult_invalid_argument { L"No unloadable objects to disconnect." };
    }

    template <typename D, typename ... I>
    void CppWinRTUserControlFromWinRTComponentT<D, I...>::UnloadObject(DependencyObject const&)
    {
    ...
    template <typename D, typename... I>
    IComponentConnector CppWinRTUserControlFromWinRTComponentT<D, I...>::GetBindingConnector(int32_t, IInspectable const&)
    {
        return nullptr;
    }

    template struct CppWinRTUserControlFromWinRTComponentT<struct CppWinRTUserControlFromWinRTComponent>;
}
