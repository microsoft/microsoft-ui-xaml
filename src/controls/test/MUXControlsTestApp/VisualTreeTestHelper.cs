...
namespace Microsoft.UI.Xaml.Tests.MUXControls.ApiTests
{
    ...
    public class VisualTreeTestHelper
    {
        ...
        private class TestExecution
        {
            ...
            public void DumpAndVerifyVisualTree(UIElement root, string verificationFileNamePrefix, string messageOnError = null)
            {
                ...
                string result = new VisualTreeOutputCompare(expectedContent, content).ToString();
    ...
    class VerificationFileStorage
    {
        ...
        */
        ...
        private static readonly string VerificationFileFullPathPrefix = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "verification");

        private static async Task<string> GetVerificationFileContentAsync(string fileName)
        {
            var file = await StorageFile.GetFileFromPathAsync(Path.Combine(VerificationFileFullPathPrefix, fileName));
