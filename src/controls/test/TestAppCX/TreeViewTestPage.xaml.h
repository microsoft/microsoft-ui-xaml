...
namespace TestAppCX
{
    ...
    public:
        ...
        TreeViewTestPage();
    private:
        void ReplaceAll_Click(Platform::Object^ sender, Microsoft::UI::Xaml::RoutedEventArgs^ e);
        void Clear_Click(Platform::Object^ sender, Microsoft::UI::Xaml::RoutedEventArgs^ e);
    };
