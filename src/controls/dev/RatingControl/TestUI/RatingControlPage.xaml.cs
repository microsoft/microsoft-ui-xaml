...
namespace MUXControlsTestApp
{
    ...
    public sealed partial class RatingControlPage : TestPage
    {
        ...
        SolidColorBrush _tomato = new SolidColorBrush(Microsoft.UI.Colors.Tomato);
        SolidColorBrush _aqua = new SolidColorBrush(Microsoft.UI.Colors.Aqua);
        ...
        public RatingControlPage()
        {
            ...
            Loaded += RatingControlPage_Loaded;
        }

        private void RatingControlPage_Loaded(object sender, RoutedEventArgs e)
        {
