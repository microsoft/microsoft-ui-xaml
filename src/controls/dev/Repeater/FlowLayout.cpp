...
void FlowLayout::InitializeForContextCore(
...
void FlowLayout::UninitializeForContextCore(
    winrt::VirtualizingLayoutContext const& context)
{
    ...
    winrt::Rect const& lastRealizedLayoutBounds)
{
    ...
    if (itemsCount > 0)
    {
        ...
        ITEMSREPEATER_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_IND_STR_STR_FLT_FLT, METH_NAME, this,
            indentDbg, LayoutId().data(),
            L"Extent:", extent.Width, extent.Height);
        ITEMSREPEATER_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_IND_STR_STR_FLT, METH_NAME, this,
            indentDbg, LayoutId().data(),
            L"Based on average line size:", averageLineSize);
        ITEMSREPEATER_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_IND_STR_STR_FLT_FLT, METH_NAME, this,
            indentDbg, LayoutId().data(),
            L"Based on average items per line:", averageItemsPerLine);
#endif // DBG
    }
    else
    {
        ...
        ITEMSREPEATER_TRACE_INFO_DBG(nullptr, TRACE_MSG_METH_IND_STR_STR_FLT_FLT, METH_NAME, this,
            winrt::get_self<VirtualizingLayoutContext>(context)->Indent(), LayoutId().data(),
            L"ItemCount is 0. Extent:", extent.Width, extent.Height);
    }
    ...
    winrt::VirtualizingLayoutContext const& context)
{
    ...
    ITEMSREPEATER_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_IND_STR_STR_INT, METH_NAME, this, indentDbg, LayoutId().data(), L"startIndex", startIndex);
    ITEMSREPEATER_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_IND_STR_STR_INT, METH_NAME, this, indentDbg, LayoutId().data(), L"Count", countInLine);
    ITEMSREPEATER_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_IND_STR_STR_INT, METH_NAME, this, indentDbg, LayoutId().data(), L"LineHeight", lineSize);
#endif
...
winrt::Size FlowLayout::Algorithm_GetMeasureSize(
    int index,
...
bool FlowLayout::Algorithm_ShouldBreakLine(
    int index,
    double remainingSpace)
{
...
void FlowLayout::UpdateIndexBasedLayoutOrientation(const winrt::Orientation& orientation)
{
