...
namespace Microsoft.UI.Xaml.Tests.MUXControls.ApiTests.RepeaterTests
{
    ...
    public class InspectingDataSourceTests : ApiTestBase
    {
        ...
        [TestMethod]
        [TestProperty("Ignore", "True")] // TODO 33571470: MUXC desktop disabled test: CanCreateFromIObservableVector
        ...
        public void VerifyCallingResetMultipleTimesOnUniqueIdItemsSource()
        {
            RunOnUIThread.Execute(() =>
            {
                ...
                {
                    ItemsSource = data,
                    ItemTransitionProvider = new DefaultItemCollectionTransitionProvider()
                };
        ...
        [TestMethod]
        [TestProperty("Ignore", "True")] // TODO 31348426: Re-enable when fixed.
        ...
        private static int GetCount(IList vector)
        {
            return vector == null ? -1 : (int)vector.Count;
        }
        ...
        class CollectionChangeRecorder
        {
            ...
            private static NotifyCollectionChangedEventArgs Clone(NotifyCollectionChangedEventArgs args)
            {
                return CollectionChangeEventArgsConverters.CreateNotifyArgs(
                    ...
                    args.OldItems == null ? -1 : (int)args.OldItems.Count,
                    args.NewStartingIndex,
                    args.NewItems == null ? -1 : (int)args.NewItems.Count);
            }
        }
