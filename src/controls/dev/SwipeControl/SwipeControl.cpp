    ...
    const winrt::PointerRoutedEventArgs& args)
{
    ...
    if (args.Pointer().PointerDeviceType() == winrt::PointerDeviceType::Touch && m_visualInteractionSource)
    {
        if (m_currentItems &&
...
void SwipeControl::GetTemplateParts()
{
    ...
    {
        m_swipeItemStyle.set(lookedUpStyle.try_as<winrt::Style>());
    }
}
...
void SwipeControl::EnsureClip()
{
    ...
    winrt::Microsoft::UI::Xaml::Media::RectangleGeometry rectangleGeometry;
