...
{
    SCROLLPRESENTER_TRACE_VERBOSE_DBG(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"m_anchorCandidates cleared. m_isAnchorElementDirty set.");
...
void ScrollPresenter::ResetAnchorElement()
{
    if (m_anchorElement.get())
    {
        SCROLLPRESENTER_TRACE_VERBOSE_DBG(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"m_anchorElement, m_anchorElementBounds, m_isAnchorElementDirty reset.");
...
void ScrollPresenter::EnsureAnchorElementSelection()
{
    ...
    {
        SCROLLPRESENTER_TRACE_VERBOSE_DBG(*this, TRACE_MSG_METH_PTR_STR, METH_NAME, this, m_anchorElement.get(), L"Early exit as m_isAnchorElementDirty==False.");
