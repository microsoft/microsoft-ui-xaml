...
#pragma region Invoked by ScrollPresenterTestHooks
    float GetContentLayoutOffsetXDbg() const
    {
        return m_contentLayoutOffsetX;
    }

    float GetContentLayoutOffsetYDbg() const
    {
        return m_contentLayoutOffsetY;
    }

    void SetContentLayoutOffsetXDbg(float contentLayoutOffsetX);
    void SetContentLayoutOffsetYDbg(float contentLayoutOffsetY);

    winrt::hstring GetTransformExpressionAnimationExpressionDbg() const;
    void SetTransformExpressionAnimationExpressionDbg(winrt::hstring const& transformExpressionAnimationExpression);

    winrt::hstring GetMinPositionExpressionAnimationExpressionDbg() const;
    void SetMinPositionExpressionAnimationExpressionDbg(winrt::hstring const& minPositionExpressionAnimationExpression);

    winrt::hstring GetMaxPositionExpressionAnimationExpressionDbg() const;
    void SetMaxPositionExpressionAnimationExpressionDbg(winrt::hstring const& maxPositionExpressionAnimationExpression);

    winrt::float2 GetArrangeRenderSizesDeltaDbg();

    winrt::float2 GetPositionDbg();
    winrt::float2 GetMinPositionDbg();
    void SetMinPositionDbg(winrt::float2 minPosition);
    winrt::float2 GetMaxPositionDbg();
    void SetMaxPositionDbg(winrt::float2 maxPosition);

    winrt::IVector<winrt::ScrollSnapPointBase> GetConsolidatedHorizontalScrollSnapPointsDbg()
    {
        return GetConsolidatedScrollSnapPointsDbg(ScrollPresenterDimension::HorizontalScroll);
    }

    winrt::IVector<winrt::ScrollSnapPointBase> GetConsolidatedVerticalScrollSnapPointsDbg()
    {
        return GetConsolidatedScrollSnapPointsDbg(ScrollPresenterDimension::VerticalScroll);
    }

    winrt::IVector<winrt::ScrollSnapPointBase> GetConsolidatedScrollSnapPointsDbg(ScrollPresenterDimension dimension);
    winrt::IVector<winrt::ZoomSnapPointBase> GetConsolidatedZoomSnapPointsDbg();

    std::shared_ptr<SnapPointWrapper<winrt::ScrollSnapPointBase>> GetHorizontalSnapPointWrapperDbg(winrt::ScrollSnapPointBase const& scrollSnapPoint)
    {
        return GetScrollSnapPointWrapperDbg(ScrollPresenterDimension::HorizontalScroll, scrollSnapPoint);
    }

    std::shared_ptr<SnapPointWrapper<winrt::ScrollSnapPointBase>> GetVerticalSnapPointWrapperDbg(winrt::ScrollSnapPointBase const& scrollSnapPoint)
    {
        return GetScrollSnapPointWrapperDbg(ScrollPresenterDimension::VerticalScroll, scrollSnapPoint);
    }

    std::shared_ptr<SnapPointWrapper<winrt::ScrollSnapPointBase>> GetScrollSnapPointWrapperDbg(ScrollPresenterDimension dimension, winrt::ScrollSnapPointBase const& scrollSnapPoint);
    std::shared_ptr<SnapPointWrapper<winrt::ZoomSnapPointBase>> GetZoomSnapPointWrapperDbg(winrt::ZoomSnapPointBase const& zoomSnapPoint);
#pragma endregion
...
private:
    ...
    void ComputeBringIntoViewTargetOffsetsFromRequestEventArgs(
        const winrt::UIElement& content,
    ...
    void ComputeBringIntoViewUpdatedTargetOffsets(
        const winrt::UIElement& content,
        const winrt::UIElement& element,
    ...
    int GetInteractionTrackerOperationsTicksCountdown() const;
...
private:
#ifdef DBG
    winrt::float2 m_minPositionOverrideDbg{ FloatUtil::NaN, FloatUtil::NaN };
    winrt::float2 m_maxPositionOverrideDbg{ FloatUtil::NaN, FloatUtil::NaN };
#endif // DBG
    ...
    tracker_ref<winrt::IScrollControllerPanningInfo> m_horizontalScrollControllerPanningInfo{ this };
    tracker_ref<winrt::IScrollControllerPanningInfo> m_verticalScrollControllerPanningInfo{ this };
    ...
    winrt::IScrollControllerPanningInfo::Changed_revoker m_horizontalScrollControllerPanningInfoChangedRevoker{};
    winrt::IScrollControllerPanningInfo::PanRequested_revoker m_horizontalScrollControllerPanningInfoPanRequestedRevoker{};
    ...
    winrt::IScrollControllerPanningInfo::Changed_revoker m_verticalScrollControllerPanningInfoChangedRevoker{};
    winrt::IScrollControllerPanningInfo::PanRequested_revoker m_verticalScrollControllerPanningInfoPanRequestedRevoker{};
