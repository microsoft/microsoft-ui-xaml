...
void TestAppCX::BackdropMaterialTestPage::ToggleTheme(Platform::Object^ sender, Microsoft::UI::Xaml::RoutedEventArgs^ e)
{
...
void TestAppCX::BackdropMaterialTestPage::NewView(Platform::Object^ sender, Microsoft::UI::Xaml::RoutedEventArgs^ e)
{
    ...
    {
        auto frame = ref new Microsoft::UI::Xaml::Controls::Frame();
...
void TestAppCX::BackdropMaterialTestPage::CloseWindow(Platform::Object^ sender, Microsoft::UI::Xaml::RoutedEventArgs^ e)
{
