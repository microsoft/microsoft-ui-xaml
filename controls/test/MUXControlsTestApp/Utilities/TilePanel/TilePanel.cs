    ...
    public class TilePanel : Panel
    {
        ...
        public static readonly DependencyProperty TileColorProperty =
            DependencyProperty.Register(
                ...
                typeof(Color),
                typeof(TilePanel),
                new PropertyMetadata(Microsoft.UI.Colors.DarkGray, new PropertyChangedCallback(OnPropertyChanged)));
        ...
        private void SetRectangleColor(Rectangle rectangle)
        {
            ...
            GradientStop gs = new GradientStop() { Color = Microsoft.UI.Colors.LightGray, Offset = 0.0 };
