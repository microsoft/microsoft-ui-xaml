        ...
        private void GenerateUI()
        {
            ...
            for (int level = _level; level > 0; level--)
            {
                ...
                if (_level > 1 && this.ShowLevelSeparators)
                {
                    ...
                    label.Foreground = new SolidColorBrush(Microsoft.UI.Colors.LightGray);
                    ...
                    levelSeparator.Fill = new SolidColorBrush(Microsoft.UI.Colors.LightGray);
                ...
                foreach (PropertyInfo propertyInfo in typeEntity.GetProperties(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Public))
                {
                    ...
                    if (!skipUIAutoGeneration)
                    {
                            ...
                            if (propertyControl == null)
                            {
                                ...
                                try
                                {
                                    switch (type.FullName)
                                    {
                                        ...
                                        case "Microsoft.UI.Xaml.Media.Brush":
                                            {
                                                propertyControl = GenerateBrushUI(propertyInfo, binding);
                                                break;
                                            }
                                        case "Microsoft.UI.Xaml.Data.Binding":
                                            {
                                        ...
                                        default:
                                            ...
                                            {
                                                // Examples: "Windows.UI.Text.FontStyle" / "Microsoft.UI.Xaml.Controls.ScrollBarVisibility"
                        ...
                        if (this.ShowPropertySeparators)
                        {
                            ...
                            propertySeparator.Fill = new SolidColorBrush(Microsoft.UI.Colors.LightGray);
