...
namespace Microsoft.UI.Xaml.Tests.MUXControls.InteractionTests.Common
{
    ...
    public class KeyboardHelper
    {
        ...
        public static void PressKey(Key key, ModifierKey modifierKey = ModifierKey.None, uint numPresses = 1, bool skipWait = false)
        {
        ...
        public static void PressDownModifierKey(ModifierKey modifierKey, bool silent = false, bool waitForIdle = true)
        {
        ...
        public static void ReleaseModifierKey(ModifierKey modifierKey, bool silent = false, bool waitForIdle = true)
        {
