                ...
                if (packageFile?.Exists == true)
                {
                    ...
                    foreach (var installedPackage in installedPackages)
                    {
                        ...
                        //        Helix\scripts\TestPass-OneTimeMachineSetup.ps1
                            ...
                            (installedPackage.Id.Name == "WinUICppUWPSampleApp") ||
                            (installedPackage.Id.Name == "WinUICsDesktopSampleApp") ||
                            (installedPackage.Id.Name == "WinUICsUWPSampleApp") ||
                            (installedPackage.Id.Name == "Microsoft.WinUI3ControlsGallery.Desktop"))
                        {
