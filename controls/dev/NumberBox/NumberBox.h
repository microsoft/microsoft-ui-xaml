...
private:
    ...
    void OnAutomationPropertiesLabeledByPropertyChanged(const winrt::DependencyObject&, const winrt::DependencyProperty&);
    ...
    winrt::FrameworkElement::Loaded_revoker m_textBoxLoadedRevoker{};
