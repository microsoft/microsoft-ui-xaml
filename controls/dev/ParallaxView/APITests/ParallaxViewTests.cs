    ...
    public class ParallaxViewTests : ApiTestBase
    {
        ...
        public void VerifyParallaxingWithZooming()
        {
            ...
            RunOnUIThread.Execute(() =>
            {
                ...
                scrollViewer.ZoomMode = Microsoft.UI.Xaml.Controls.ZoomMode.Enabled;
            });
        ...
        [TestProperty("Ignore", "True")] // TODO 29556617: Disabled after converting MUXControlsTestApp to a desktop .NET 5 app.  Re-enable when fixed.
            ...
            AutoResetEvent scrollViewerLoadedEvent)
        {
            ...
            scrollViewer.ZoomMode = Microsoft.UI.Xaml.Controls.ZoomMode.Disabled;
