...
namespace MUXControlsTestApp
{
    public sealed partial class DynamicPage : TestPage
    {
        ...
        private void SetupAnimatedValuesSpy()
        {
            ...
            {
                string visualHorizontalTargetedPropertyName = "visual.Translation.X";
                string visualVerticalTargetedPropertyName = "visual.Translation.Y";
        ...
        private void cmbHorizontalScrollMode_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (this.ScrollViewer != null)
            {
                this.ScrollViewer.HorizontalScrollMode = (Microsoft.UI.Xaml.Controls.ScrollMode)this.cmbHorizontalScrollMode.SelectedIndex;
            }
            else if (this.ScrollPresenter != null)
            {
                switch (this.cmbHorizontalScrollMode.SelectedIndex)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        this.ScrollPresenter.HorizontalScrollMode = ScrollingScrollMode.Auto;
                        break;
                }
            }
        }
        ...
        private void cmbVerticalScrollMode_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (this.ScrollViewer != null)
            {
                this.ScrollViewer.VerticalScrollMode = (Microsoft.UI.Xaml.Controls.ScrollMode)this.cmbVerticalScrollMode.SelectedIndex;
            }
            else if (this.ScrollPresenter != null)
            {
                switch (this.cmbVerticalScrollMode.SelectedIndex)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        this.ScrollPresenter.VerticalScrollMode = ScrollingScrollMode.Auto;
                        break;
                }
            }
        }
        ...
        private void cmbZoomMode_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (this.ScrollViewer != null)
            {
                this.ScrollViewer.ZoomMode = (Microsoft.UI.Xaml.Controls.ZoomMode)this.cmbZoomMode.SelectedIndex;
            }
            else if (this.ScrollPresenter != null)
            {
        ...
        private void SetupScrollPresenter()
        {
            ...
            GradientStop blueGS = new GradientStop() { Color = Microsoft.UI.Colors.Blue, Offset = 0.0 };
            threeColorsLGB.GradientStops.Add(blueGS);

            GradientStop yellowGS = new GradientStop() { Color = Microsoft.UI.Colors.Yellow, Offset = 0.5 };
            threeColorsLGB.GradientStops.Add(yellowGS);

            GradientStop redGS = new GradientStop() { Color = Microsoft.UI.Colors.Red, Offset = 1.0 };
            ...
            this.scrollPresenter.Background = new SolidColorBrush(Microsoft.UI.Colors.Magenta);
