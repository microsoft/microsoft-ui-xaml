        ...
        []()
        {
            auto xamlType = winrt::make_self<XamlType>(
                ...
                (std::function<void(XamlTypeBase&)>)[](XamlTypeBase& xamlType)
                {
                    ...
                    winrt::IAnnotatedScrollBarStatics2 statics2 = GetFactory<winrt::IAnnotatedScrollBarStatics2>(L"Microsoft.UI.Xaml.Controls.AnnotatedScrollBar");
                    {
                        xamlType.AddDPMember(L"IsValueScrollOffset", L"Boolean", statics2.IsValueScrollOffsetProperty(), false /* isContent */);
                        xamlType.AddDPMember(L"LabelContentAreaSize", L"Double", statics2.LabelContentAreaSizeProperty(), false /* isContent */);
                        xamlType.AddDPMember(L"ScrollOffsetToLabelOffsetFactor", L"Double", statics2.ScrollOffsetToLabelOffsetFactorProperty(), false /* isContent */);
                    }
