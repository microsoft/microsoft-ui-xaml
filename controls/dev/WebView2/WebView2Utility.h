...
namespace WebView2Utility
{
    ...
    LPARAM PackIntoWin32StylePointerArgs_lparam(
        const UINT message,
        const winrt::Microsoft::UI::Xaml::Input::PointerRoutedEventArgs& args, winrt::Windows::Foundation::Point point)
    {
    ...
    WPARAM PackIntoWin32StyleMouseArgs_wparam(
        const UINT message,
        const winrt::Microsoft::UI::Xaml::Input::PointerRoutedEventArgs& args, winrt::PointerPoint pointerPoint)
    {
        ...
        else if (message == WM_XBUTTONDOWN || message == WM_XBUTTONUP)
        {
            ...
            winrt::PointerUpdateKind pointerUpdateKind{ properties.PointerUpdateKind() };
