...
namespace MUXControlsTestApp
{
    ...
    public sealed partial class WebView2BasicPage : TestPage
    {
        ...
        {
            string navigateToStringString = NavigateToStringString.Text;
            var MyWebView2 = FindName("MyWebView2") as WebView2;
            MyWebView2.NavigateToString(NavigateToStringString.Text);
        }
        ...
        {
            TextBlock draggableTexTextBlock = sender as TextBlock;
            args.Data.SetText(draggableTexTextBlock.Text);
        ...
        bool IsTransientWebMessage(string webMessageAsString)
        {
            ...
            return isTapWhenWaitingForSomethingElse || 
                   isInitialResize ||
        ...
        public void VerifyWebMessageBasedTest(string stringResult, string jsonResult)
        {
            ...
            using (var logger = new ResultsLogger(selectedTest.ToString(), TestResult))
            {
                ...
                switch (selectedTest)
                {
                    ...
                    case TestList.DragDropIntoWebView2Test:
                        expectedStringResult = "Input on w2: Draggable Text";
                        break;
                    ...
                    case TestList.MoveTest:
                        {
                            ...
                            // specifically TestPage panel, which has its top at 60px, and the title bar.
                    ...
                    case TestList.CursorClickUpdateTest:
                        {
                            ...
                            Microsoft.UI.Input.InputCursor cursor = webviewWithCursor.WrappedProtectedCursor;
                            logger.Verify(cursor != null, "ProtectedCursor was null");
                            if (cursor == null) break;
                            Microsoft.UI.Input.InputSystemCursor cursorAsInputSystemCursor = cursor.As<Microsoft.UI.Input.InputSystemCursor>();
                            var actualCursorType = cursorAsInputSystemCursor.CursorShape;
                            var expectedCursorType = Microsoft.UI.Input.InputSystemCursorShape.Hand;
                    ...
                    case TestList.AddHostObjectToScriptTest:
                        {
                            ...
                            var interop = core_wv2.As<ICoreWebView2Interop>();
                            try
                            {
