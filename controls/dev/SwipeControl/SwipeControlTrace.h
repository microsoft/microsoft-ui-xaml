...
#ifdef DBG
#define SWIPECONTROL_TRACE_INFO_DBG(sender, message, ...)    SWIPECONTROL_TRACE_INFO(sender, message, __VA_ARGS__)
#define SWIPECONTROL_TRACE_VERBOSE_DBG(sender, message, ...) SWIPECONTROL_TRACE_VERBOSE(sender, message, __VA_ARGS__)
#define SWIPECONTROL_TRACE_PERF_DBG(info)                    SWIPECONTROL_TRACE_PERF(info)
#else
#define SWIPECONTROL_TRACE_INFO_DBG(sender, message, ...)
#define SWIPECONTROL_TRACE_VERBOSE_DBG(sender, message, ...)
#define SWIPECONTROL_TRACE_PERF_DBG(info)
#endif // DBG
