...
namespace MUXControlsTestApp
{
    ...
    public sealed partial class InfoBarPage : TestPage
    {
        ...
        {
            TestInfoBar.Foreground = new SolidColorBrush(Microsoft.UI.Colors.Red);
        }
        ...
        public void CustomBackgroundChanged(object sender, object args)
        {
            ...
            {
                TestInfoBar.Background = new SolidColorBrush(Microsoft.UI.Colors.Purple);
            }
            else
            {
                TestInfoBar.Background = new SolidColorBrush(Microsoft.UI.Colors.Transparent);
            }
        }
    }
}
