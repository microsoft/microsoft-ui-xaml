    ...
    public class ScrollPresenterTestsWithInputHelper : ScrollPresenterTestsBase
    {
        ...
        public void PanWithRailing()
        {
            ...
            using (var setup = new TestSetupHelper("ScrollPresenter Tests"))
            {
                ...
                bool success = WaitForManipulationEnd("scrollPresenter11", "txtScrollPresenterState", failOnError: true, logTraces: true);
        ...
        public void PanWithoutRailing()
        {
            ...
            using (var setup = new TestSetupHelper("ScrollPresenter Tests"))
            {
                ...
                bool success = WaitForManipulationEnd("scrollPresenter51", "txtScrollPresenterState", failOnError: true, logTraces: true);
        ...
        [TestProperty("Ignore", "True")] // Disabled due to: ScrollPresenterTestsWithInputHelper Pinch/Stretch tests fail on RS5 in Helix #132
        [TestProperty("TestPass:MinOSVer", WindowsOSVersion.RS5)] // Touch input injection is only supported on RS5 and up
        public void PinchRectangle()
        {
            ...
            using (var setup = new TestSetupHelper("ScrollPresenter Tests"))
            {
                ...
                bool success = WaitForManipulationEnd("scrollPresenter12", "txtScrollPresenterState", failOnError: true, logTraces: true);
                ...
                // scrollPresenter12's MinZoomFactor is 0.5.
                double horizontalOffset;
                double verticalOffset;
                float zoomFactor;
        ...
        public void StretchImage()
        {
            ...
            using (var setup = new TestSetupHelper("ScrollPresenter Tests"))
            {
                ...
                bool success = WaitForManipulationEnd("scrollPresenter52", "txtScrollPresenterState", failOnError: true, logTraces: true);
        ...
        public void PinchRectangleWithMouseWheel()
        {
            ...
            using (var setup = new TestSetupHelper("ScrollPresenter Tests"))
            {
                ...
                // The InteractionTracker changes the scale by a factor of 1.1 for each 60 mouse wheel delta.
                InputHelper.RotateWheel(scrollPresenter12UIObject, (int) (-mouseWheelDeltaForVelocityUnit / 2));
        ...
        public void StretchImageWithMouseWheel()
        {
            ...
            using (var setup = new TestSetupHelper("ScrollPresenter Tests"))
            {
                ...
                KeyboardHelper.PressDownModifierKey(ModifierKey.Control);
                // The InteractionTracker changes the scale by a factor of 1.1 for each 60 mouse wheel delta.
                InputHelper.RotateWheel(scrollPresenter52UIObject, mouseWheelDeltaForVelocityUnit / 2);
                KeyboardHelper.ReleaseModifierKey(ModifierKey.Control);
        ...
        public void PanWithChainingFromScrollViewerToScrollPresenter()
        {
            ...
            using (var setup = new TestSetupHelper("ScrollPresenter Tests"))
            {
                ...
                bool success = WaitForManipulationEnd("scrollViewer2", "txtScrollViewer2State", failOnError: true, logTraces: true);
        ...
        public void PanWithChainingFromScrollPresenterToScrollViewerWithChainingMode(bool useChainingModeAlways)
        {
            ...
            using (var setup = new TestSetupHelper("ScrollPresenter Tests"))
            {
                ...
                bool success = WaitForManipulationEnd("scrollPresenter1", "txtScrollPresenter1State", failOnError: true, logTraces: true);
        ...
        public void ScrollWithNonSystemManipulationMode()
        {
            ...
            using (var setup = new TestSetupHelper("ScrollPresenter Tests"))
            {
                ...
                bool success = WaitForManipulationEnd("scrollPresenter0", "txtScrollPresenter0State", failOnError: true, logTraces: true);
                ...
                Log.Comment("Waiting for scrollPresenter0 pan completion");
                success &= WaitForManipulationEnd("scrollPresenter0", "txtScrollPresenter0State", failOnError: true, logTraces: true);
        ...
        public void PanTowardsTwoManditoryIrregularSnapPoint_Near()
        {
        ...
        [TestMethod]
        [TestProperty("TestPass:MinOSVer", WindowsOSVersion.RS5)] // Touch input injection is only supported on RS5 and up
        public void PanTowardsTwoManditoryIrregularSnapPoint_Center()
        {
        ...
        [TestMethod]
        [TestProperty("TestPass:MinOSVer", WindowsOSVersion.RS5)] // Touch input injection is only supported on RS5 and up
        public void PanTowardsTwoManditoryIrregularSnapPoint_Far()
        {
        ...
        [TestProperty("TestPass:MinOSVer", WindowsOSVersion.RS5)] // Touch input injection is only supported on RS5 and up
        public void PanWithinARepeatedMandatorySnapPoint_Near()
        {
        ...
        [TestProperty("Description", "Apply a single mandatory repeated snap point across the extent, with Offset equal to Start, and pan within it.")]
        [TestProperty("TestPass:MinOSVer", WindowsOSVersion.RS5)] // Touch input injection is only supported on RS5 and up
        public void PanWithinARepeatedMandatorySnapPoint_Center()
        {
        ...
        [TestProperty("Description", "Apply a single mandatory repeated snap point across the extent, with Offset equal to Start, and pan within it.")]
        [TestProperty("TestPass:MinOSVer", WindowsOSVersion.RS5)] // Touch input injection is only supported on RS5 and up
        public void PanWithinARepeatedMandatorySnapPoint_Far()
        {
        ...
        [TestProperty("TestPass:MinOSVer", WindowsOSVersion.RS5)] // Touch input injection is only supported on RS5 and up
        public void PanWithinARepeatedMandatorySnapPointWithDifferentOffset_Near()
        {
        ...
        [TestProperty("Description", "Apply a single mandatory repeated snap point across the extent, with Offset different from Start, and pan within it.")]
        [TestProperty("TestPass:MinOSVer", WindowsOSVersion.RS5)] // Touch input injection is only supported on RS5 and up
        public void PanWithinARepeatedMandatorySnapPointWithDifferentOffset_Center()
        {
        ...
        [TestProperty("Description", "Apply a single mandatory repeated snap point across the extent, with Offset different from Start, and pan within it.")]
        [TestProperty("TestPass:MinOSVer", WindowsOSVersion.RS5)] // Touch input injection is only supported on RS5 and up
        public void PanWithinARepeatedMandatorySnapPointWithDifferentOffset_Far()
        {
