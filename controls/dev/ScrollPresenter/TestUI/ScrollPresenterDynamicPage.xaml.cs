...
namespace MUXControlsTestApp
{
    public sealed partial class ScrollPresenterDynamicPage : TestPage
    {
...
#else
                if (cmbSnapPointKind.SelectedIndex != 2)
                {
        ...
        private void BtnGetPosition_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                Vector2 position = ScrollPresenterTestHooks.GetPosition(scrollPresenter);
                txtPositionX.Text = position.X.ToString();
                txtPositionY.Text = position.Y.ToString();
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnGetMinPosition_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                txtMinPositionX.Text = minPosition.X.ToString();
                txtMinPositionY.Text = minPosition.Y.ToString();
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnSetMinPosition_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ScrollPresenterTestHooks.SetMinPosition(scrollPresenter, new Vector2(float.Parse(txtMinPositionX.Text), float.Parse(txtMinPositionY.Text)));
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnGetMaxPosition_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                Vector2 maxPosition = ScrollPresenterTestHooks.GetMaxPosition(scrollPresenter);
                txtMaxPositionX.Text = maxPosition.X.ToString();
                txtMaxPositionY.Text = maxPosition.Y.ToString();
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnSetMaxPosition_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ScrollPresenterTestHooks.SetMaxPosition(scrollPresenter, new Vector2(float.Parse(txtMaxPositionX.Text), float.Parse(txtMaxPositionY.Text)));
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnGetPositionExpressionAnimationExpression_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                txtPositionExpressionAnimationExpression.Text = ScrollPresenterTestHooks.GetTransformExpressionAnimationExpression(scrollPresenter);
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnSetPositionExpressionAnimationExpression_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ScrollPresenterTestHooks.SetTransformExpressionAnimationExpression(scrollPresenter, txtPositionExpressionAnimationExpression.Text);
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnGetMinPositionExpressionAnimationExpression_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                txtMinPositionExpressionAnimationExpression.Text = ScrollPresenterTestHooks.GetMinPositionExpressionAnimationExpression(scrollPresenter);
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnSetMinPositionExpressionAnimationExpression_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ScrollPresenterTestHooks.SetMinPositionExpressionAnimationExpression(scrollPresenter, txtMinPositionExpressionAnimationExpression.Text);
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnGetMaxPositionExpressionAnimationExpression_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                txtMaxPositionExpressionAnimationExpression.Text = ScrollPresenterTestHooks.GetMaxPositionExpressionAnimationExpression(scrollPresenter);
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnSetMaxPositionExpressionAnimationExpression_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ScrollPresenterTestHooks.SetMaxPositionExpressionAnimationExpression(scrollPresenter, txtMaxPositionExpressionAnimationExpression.Text);
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
