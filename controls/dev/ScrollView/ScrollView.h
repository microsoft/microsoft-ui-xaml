...
#pragma region IScrollView
    ...
    winrt::ScrollPresenter ScrollPresenter() const;
...
#pragma endregion
    ...
    void ScrollControllersAutoHidingChangedDbg();
...
private:
    ...
    void OnIndicatorStateStoryboardCompleted(
        const winrt::IInspectable& sender,
        const winrt::IInspectable& args);
    void OnScrollControllerCanScrollChanged(
        const winrt::IScrollController& sender,
        const winrt::IInspectable& args);
    void OnScrollControllerIsScrollingWithMouseChanged(
        const winrt::IScrollController& sender,
        const winrt::IInspectable& args);
    ...
    void UnhookHorizontalScrollControllerEvents(bool isForDestructor);
    void HookVerticalScrollControllerEvents();
    void UnhookVerticalScrollControllerEvents(bool isForDestructor);
    ...
    void HandleScrollControllerPointerEntered(
        bool isForHorizontalScrollController);
    void HandleScrollControllerPointerExited(
        bool isForHorizontalScrollController);
    ...
    winrt::event_token m_horizontalScrollControllerCanScrollChangedToken{};
    winrt::event_token m_verticalScrollControllerCanScrollChangedToken{};

    winrt::event_token m_horizontalScrollControllerIsScrollingWithMouseChangedToken{};
    winrt::event_token m_verticalScrollControllerIsScrollingWithMouseChangedToken{};
    ...
    bool m_isHorizontalScrollControllerScrollingWithMouse{ false };
    bool m_isVerticalScrollControllerScrollingWithMouse{ false };
