...
namespace MUXControlsTestApp
{
    public sealed partial class RevealScenarioLights : TestPage
    {
        public RevealScenarioLights()
        {
            ...
            _backgroundLight = compositor.CreateSpotLight();
            _borderLight = compositor.CreateSpotLight();
            _borderWideLight = compositor.CreateSpotLight();
        ...
        double SpotlightInnerConeAlphaValue
        {
            ...
            set { _revealTest.BackgroundLight.InnerConeColor = Microsoft.UI.ColorHelper.FromArgb((byte)value, (byte)value, (byte)value, (byte)value); }
        }

        double SpotlightOuterConeAlphaValue
        {
            get { return _revealTest.BackgroundLight.OuterConeColor.A; }
            set { _revealTest.BackgroundLight.OuterConeColor = Microsoft.UI.ColorHelper.FromArgb((byte)value, (byte)value, (byte)value, (byte)value); }
        }
