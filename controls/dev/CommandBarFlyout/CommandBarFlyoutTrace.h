...
#ifdef DBG
#define COMMANDBARFLYOUT_TRACE_INFO_DBG(sender, message, ...)    COMMANDBARFLYOUT_TRACE_INFO(sender, message, __VA_ARGS__)
#define COMMANDBARFLYOUT_TRACE_VERBOSE_DBG(sender, message, ...) COMMANDBARFLYOUT_TRACE_VERBOSE(sender, message, __VA_ARGS__)
#define COMMANDBARFLYOUT_TRACE_PERF_DBG(info)                    COMMANDBARFLYOUT_TRACE_PERF(info)
#else
#define COMMANDBARFLYOUT_TRACE_INFO_DBG(sender, message, ...)
#define COMMANDBARFLYOUT_TRACE_VERBOSE_DBG(sender, message, ...)
#define COMMANDBARFLYOUT_TRACE_PERF_DBG(info)
#endif // DBG
