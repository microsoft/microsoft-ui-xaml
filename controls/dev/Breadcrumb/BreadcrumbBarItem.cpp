...
void BreadcrumbBarItem::HookListeners(bool forEllipsisDropDownItem)
{
    ...
    {
        m_childPreviewKeyDownToken = PreviewKeyDown({ this, &BreadcrumbBarItem::OnChildPreviewKeyDown });
    }
...
void BreadcrumbBarItem::RevokeListeners()
{
    ...
    if (m_childPreviewKeyDownToken.value)
    {
        PreviewKeyDown(m_childPreviewKeyDownToken);
...
{
    if (auto const& dataTemplate = newDataTemplate.try_as<winrt::IElementFactory>())
    {
