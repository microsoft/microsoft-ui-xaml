...
#ifdef DBG
#define ITEMCONTAINER_TRACE_INFO_DBG(sender, message, ...)    ITEMCONTAINER_TRACE_INFO(sender, message, __VA_ARGS__)
#define ITEMCONTAINER_TRACE_VERBOSE_DBG(sender, message, ...) ITEMCONTAINER_TRACE_VERBOSE(sender, message, __VA_ARGS__)
#define ITEMCONTAINER_TRACE_PERF_DBG(info)                    ITEMCONTAINER_TRACE_PERF(info)
#else
#define ITEMCONTAINER_TRACE_INFO_DBG(sender, message, ...)
#define ITEMCONTAINER_TRACE_VERBOSE_DBG(sender, message, ...)
#define ITEMCONTAINER_TRACE_PERF_DBG(info)
#endif // DBG
