...
namespace MUXControlsTestApp
{
    public class FallbackGrid : Microsoft.UI.Xaml.Controls.Grid
    {
        ...
        internal static readonly Windows.UI.Color RectangleColor = Colors.Red;
        ...
        {
            Latest = this;
            Microsoft.UI.Xaml.Shapes.Rectangle rect = new Microsoft.UI.Xaml.Shapes.Rectangle();
    ...
    public sealed partial class AnimatedVisualPlayerPage : TestPage
    {
        ...
        async void ReversePositivePlaybackRateAnimationPlayButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            SetTextBoxTextToPlayerProgress(ReversePositivePlaybackRateAnimationTextBox);
        }

        void SetTextBoxTextToPlayerProgress(TextBox textBox)
        {
        ...
        {
            // TODO 23778051: Bring this back when we have a GraphicsCaptureItem that accepts a
            // Microsoft.UI.Composition.Visual object instead of a Microsoft.UI.Composition.Visual object.
            /*if (IsRS5OrHigher())
            {
