...
void TwoPaneView::OnApplyTemplate()
{
    ...
    m_xamlRootChangedRevoker = XamlRoot().Changed(winrt::auto_revoke, { this, &TwoPaneView::OnXamlRootChanged });
...
void TwoPaneView::OnXamlRootChanged(const winrt::IInspectable& sender, const winrt::Microsoft::UI::Xaml::XamlRootChangedEventArgs& args)
{
    UpdateMode();
}
