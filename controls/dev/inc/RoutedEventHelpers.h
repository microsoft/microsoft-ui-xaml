...
template <>
struct RoutedEventTraits<RoutedEventType::DragEnter>
{
    static winrt::RoutedEvent Event() { return winrt::UIElement::DragEnterEvent(); }
    using HandlerT = winrt::DragEventHandler;
};

template <>
struct RoutedEventTraits<RoutedEventType::DragLeave>
{
    static winrt::RoutedEvent Event() { return winrt::UIElement::DragLeaveEvent(); }
    using HandlerT = winrt::DragEventHandler;
};

template <>
struct RoutedEventTraits<RoutedEventType::Drop>
{
    static winrt::RoutedEvent Event() { return winrt::UIElement::DropEvent(); }
    using HandlerT = winrt::DragEventHandler;
};
