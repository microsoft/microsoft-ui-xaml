...
{
    auto propertyType = winrt::TypeName();
    propertyType.Name = propertyTypeNameString;
    propertyType.Kind = winrt::TypeKind::Metadata;

    auto ownerType = winrt::TypeName();
    ownerType.Name = ownerTypeNameString;
    ownerType.Kind = winrt::TypeKind::Metadata;
...
inline bool SetFocus(winrt::DependencyObject const& object, winrt::FocusState focusState)
{
    if (object)
    {
        auto result = winrt::FocusManager::TryFocusAsync(object, focusState);
...
template <typename D, typename T, typename ... I>
struct __declspec(empty_bases)DeriveFromBitmapIconHelper_base : winrt::Microsoft::UI::Xaml::Controls::BitmapIconT<D, winrt::default_interface<T>, winrt::composable, I...>
{
    using composable = T;
    using class_type = typename T;
...
template <typename D, typename T, typename ... I>
struct __declspec(empty_bases)DeriveFromPathIconHelper_base : winrt::Microsoft::UI::Xaml::Controls::PathIconT<D, winrt::default_interface<T>, winrt::composable, I...>
{
    using composable = T;
    using class_type = typename T;
...
template <typename D, typename T, typename ... I>
struct __declspec(empty_bases)DeriveFromBitmapIconSourceHelper_base : winrt::Microsoft::UI::Xaml::Controls::BitmapIconSourceT<D, winrt::default_interface<T>, winrt::composable, I...>
{
    using composable = T;
    using class_type = typename T;
...
template <typename D, typename T, typename ... I>
struct __declspec(empty_bases)DeriveFromPathIconSourceHelper_base : winrt::Microsoft::UI::Xaml::Controls::PathIconSourceT<D, winrt::default_interface<T>, winrt::composable, I...>
{
    using composable = T;
    using class_type = typename T;
...
template <typename D, typename T, typename ... I>
struct __declspec(empty_bases) DeriveFromRangeBaseHelper_base : winrt::Microsoft::UI::Xaml::Controls::Primitives::RangeBaseT<D, winrt::default_interface<T>, winrt::composable, I...>
{
    using composable = T;
    using class_type = typename T;
