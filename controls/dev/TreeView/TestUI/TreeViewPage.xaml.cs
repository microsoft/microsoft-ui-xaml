...
namespace MUXControlsTestApp
{
    ...
    public sealed partial class TreeViewPage : TestPage
    {
        ...
        {
            this.Frame.NavigateWithoutAnimation(typeof(TreeViewItemTemplateSelectorTestPage));
        }
        ...
        private void TreeViewItemsSourceTestPage_Click(object sender, RoutedEventArgs e)
        {
            Frame.NavigateWithoutAnimation(typeof(TreeViewItemsSourceTestPage));
        }
