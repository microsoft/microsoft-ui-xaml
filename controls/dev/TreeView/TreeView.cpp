...
void TreeView::OnItemClick(const winrt::IInspectable& /*sender*/, const winrt::Microsoft::UI::Xaml::Controls::ItemClickEventArgs& args)
{
...
void TreeView::OnContainerContentChanging(const winrt::IInspectable& sender, const winrt::Microsoft::UI::Xaml::Controls::ContainerContentChangingEventArgs& args)
{
...
winrt::TreeViewNode TreeView::GetAssociatedNode(winrt::IInspectable item)
{
    return GetAssociatedNodeImpl(item, m_rootNode.get());
}

winrt::TreeViewNode TreeView::GetAssociatedNodeImpl(winrt::IInspectable const& item, winrt::TreeViewNode const& node)
{
    ...
    {
        if (auto result = GetAssociatedNodeImpl(item, childNode))
        {
            return result;
        }
    }
