...
class TreeViewNode :
    public ReferenceTracker<TreeViewNode, winrt::implementation::TreeViewNodeT, winrt::Microsoft::UI::Xaml::Data::ICustomPropertyProvider, winrt::Windows::Foundation::IStringable>,
