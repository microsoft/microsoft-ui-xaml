...
void MenuBarItem::PopulateContent()
{
    ...
    {
        if (winrt::IFlyoutBase flyoutBase = flyout)
        {
...
{
    const auto isAltDown = (winrt::InputKeyboardSource::GetKeyStateForCurrentThread(winrt::VirtualKey::Menu) & winrt::CoreVirtualKeyStates::Down) == winrt::CoreVirtualKeyStates::Down;
