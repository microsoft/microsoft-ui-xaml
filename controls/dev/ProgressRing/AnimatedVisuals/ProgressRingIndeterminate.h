...
namespace AnimatedVisuals
{
    ...
    class ProgressRingIndeterminate
        : public winrt::implements<ProgressRingIndeterminate, winrt::Microsoft::UI::Xaml::Controls::IAnimatedVisualSource>
    {
    ...
    public:
        virtual winrt::Microsoft::UI::Composition::CompositionPropertySet GetThemeProperties(winrt::Microsoft::UI::Composition::Compositor compositor);
