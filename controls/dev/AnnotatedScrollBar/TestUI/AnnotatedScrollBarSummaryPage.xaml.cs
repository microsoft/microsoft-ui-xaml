...
namespace MUXControlsTestApp
{
    ...
    public sealed partial class AnnotatedScrollBarSummaryPage : TestPage
    {
        ...
        private void isValueScrollOffsetCheckBox_Checked(object sender, RoutedEventArgs e)
        {
            pageAnnotatedScrollbar.IsValueScrollOffset = true;
        }

        private void isValueScrollOffsetCheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
            pageAnnotatedScrollbar.IsValueScrollOffset = false;
        }

        private void isDetailLabelEnabledCheckBox_Checked(object sender, RoutedEventArgs e)
        {
            pageAnnotatedScrollbar.DetailLabelRequested += AnnotatedScrollBar_DetailLabelRequested;
        }

        private void isDetailLabelEnabledCheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
            pageAnnotatedScrollbar.DetailLabelRequested -= AnnotatedScrollBar_DetailLabelRequested;
        }

        private void useLongLabelContentCheckBox_Checked(object sender, RoutedEventArgs e)
        {
            _useLongLabels = true;
            _numLabels = 1;
        ...
        private void useLongLabelContentCheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
        ...
        private void cancelScrollingEventCheckBox_Checked(object sender, RoutedEventArgs e)
        {
            _cancelScrolling = true;
        }

        private void cancelScrollingEventCheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
        ...
        private void BtnGetLabelContentAreaSize_Click(object sender, RoutedEventArgs e)
        {
            if(pageAnnotatedScrollbar != null)
            {
                txtLabelContentAreaSize.Text = pageAnnotatedScrollbar.LabelContentAreaSize.ToString();
            }
        }

        private void BtnGetScrollOffsetToLabelOffsetFactor_Click(object sender, RoutedEventArgs e)
        {
            if(pageAnnotatedScrollbar != null)
            {
                txtScrollOffsetToLabelOffsetFactor.Text = pageAnnotatedScrollbar.ScrollOffsetToLabelOffsetFactor.ToString();
            }
        }
