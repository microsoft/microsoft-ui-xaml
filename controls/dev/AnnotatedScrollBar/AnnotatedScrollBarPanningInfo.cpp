...
{
#ifdef DBG
    ANNOTATEDSCROLLBAR_TRACE_INFO(nullptr, TRACE_MSG_METH_STR, METH_NAME, this, L"Add Handler");
#endif
...
{
#ifdef DBG
    ANNOTATEDSCROLLBAR_TRACE_INFO(nullptr, TRACE_MSG_METH_STR, METH_NAME, this, L"Remove Handler");
#endif
