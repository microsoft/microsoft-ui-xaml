...
namespace MUXControlsTestApp
{
    ...
    public sealed partial class TabViewPage : TestPage
    {
        ...
        protected async override void OnNavigatedTo(Microsoft.UI.Xaml.Navigation.NavigationEventArgs args) 
        {
        ...
        private void MultipleTabViewPageButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void OnSecondTabDragStarting(object sender, DragStartingEventArgs e)
        {
            TabDraggedResultsTextBlock.Text = "SecondTab dragged";
            e.DragUI.SetContentFromBitmapImage(new Microsoft.UI.Xaml.Media.Imaging.BitmapImage(new Uri("ms-appx:///Assets/ingredient2.png")));
        }
    }
}
