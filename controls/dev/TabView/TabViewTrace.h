...
#ifdef DBG
#define TABVIEW_TRACE_INFO_DBG(sender, message, ...)    TABVIEW_TRACE_INFO(sender, message, __VA_ARGS__)
#define TABVIEW_TRACE_VERBOSE_DBG(sender, message, ...) TABVIEW_TRACE_VERBOSE(sender, message, __VA_ARGS__)
#define TABVIEW_TRACE_PERF_DBG(info)    TABVIEW_TRACE_PERF(info)
#else
#define TABVIEW_TRACE_INFO_DBG(sender, message, ...)
#define TABVIEW_TRACE_VERBOSE_DBG(sender, message, ...)
#define TABVIEW_TRACE_PERF_DBG(info)
#endif // DBG
