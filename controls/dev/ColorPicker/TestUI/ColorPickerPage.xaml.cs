...
namespace MUXControlsTestApp
{
    ...
    public sealed partial class ColorPickerPage : TestPage
    {
        ...
        public ColorPickerPage()
        {
            ...
            this.ColorPicker.Color = Microsoft.UI.Colors.Red;
        ...
        {
            this.ColorPicker.Color = Microsoft.UI.Colors.White;
        }
        ...
        {
            this.ColorPicker.Color = Microsoft.UI.Colors.Green;
        }

        private void ColorBlueButton_Click(object sender, RoutedEventArgs e)
        {
            this.ColorPicker.Color = Microsoft.UI.Colors.Blue;
        }
        ...
        {
            this.ColorPicker.PreviousColor = Microsoft.UI.Colors.Red;
        }

        private void PreviousColorGreenButton_Click(object sender, RoutedEventArgs e)
        {
            this.ColorPicker.PreviousColor = Microsoft.UI.Colors.Green;
        }

        private void PreviousColorBlueButton_Click(object sender, RoutedEventArgs e)
        {
            this.ColorPicker.PreviousColor = Microsoft.UI.Colors.Blue;
        }
