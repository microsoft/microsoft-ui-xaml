    ...
    public sealed partial class CalendarViewPage : TestPage
    {
        ...
        private void SetDensityColors(CalendarViewDayItem dayItem)
        {
            if (hasDensityBars.IsChecked.Value)
            {
                ...
                if (calendar.Day % 6 == 0 || isToday)
                {
                    ...
                    densityColors.Add(Microsoft.UI.Colors.Green);
                    densityColors.Add(Microsoft.UI.Colors.Green);

                    if (calendar.Day % 4 == 0 || isToday)
                    {
                        densityColors.Add(Microsoft.UI.Colors.Blue);
                        densityColors.Add(Microsoft.UI.Colors.Blue);
                    }
                    if (calendar.Day % 9 == 0 || isToday)
                    {
                        densityColors.Add(Microsoft.UI.Colors.Orange);
                    }
                    if (isToday)
                    {
                        densityColors.Add(Microsoft.UI.Colors.Red);
                        densityColors.Add(Microsoft.UI.Colors.Yellow);
                    }
        ...
        private SolidColorBrush GetSolidColorBrush()
        {
            ...
            switch (brushColor.SelectedIndex)
            {
                ...
                case 1: // Red
                    solidColorBrush = new SolidColorBrush(Microsoft.UI.Colors.Red);
                    break;

                case 2: // Orange
                    solidColorBrush = new SolidColorBrush(Microsoft.UI.Colors.Orange);
                    break;

                case 3: // Yellow
                    solidColorBrush = new SolidColorBrush(Microsoft.UI.Colors.Yellow);
                    break;

                case 4: // Green 
                    solidColorBrush = new SolidColorBrush(Microsoft.UI.Colors.Green);
                    break;
            }
