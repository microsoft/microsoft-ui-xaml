...
namespace MUXControlsTestApp
{
    public sealed partial class CommandBarPage : Page
    {
        ...
        public void BottomAppBarButton_Click(object sender, RoutedEventArgs args)
        {
            if (this.BottomCmdBar.Visibility == Visibility.Visible)
            {
                this.BottomCmdBar.Visibility = Visibility.Collapsed;
            }
            else
            {
                this.BottomCmdBar.Visibility = Visibility.Visible;
            }
        }
