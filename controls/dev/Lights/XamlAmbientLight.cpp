...
{
    // MaterialHelper::LightPolicyChangedHelper<XamlAmbientLight>(this, isDisabledByMaterialPolicy); // Bug 24355584: DCPP: Reveal is disabled
    MaterialHelper::LightPolicyChangedHelper<XamlAmbientLight>(this, true);
}
