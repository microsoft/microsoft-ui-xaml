...
//
//
// In RS5, as part of work to support Materials in XamlIslandRoots, the responsibility of managing and broadcasting fallback policy
...
public:
    ...
    // Acrylic Brush
    static int constexpr BuildAcrylicBrushCompositionEffectFactoryKey(bool shouldBrushBeOpaque, bool useCrossFadeEffect);
