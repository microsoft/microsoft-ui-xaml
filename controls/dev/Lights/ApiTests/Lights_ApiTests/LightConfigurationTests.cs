...
namespace Microsoft.UI.Xaml.Tests.MUXControls.ApiTests
{
    ...
    public class SecondaryWindowLightConfiguration : IDisposable
    {
        ...
        public SecondaryWindowLightConfiguration()
        {
            ...
            {
                App.CurrentWindow.Content = new Frame();
            });
        }
    ...
    public class LightConfigurationTests : ApiTestBase
    {
        ...
        //[TestMethod]
        [TestProperty("Ignore", "True")] // TODO 29556562: Disabled after converting MUXControlsTestApp to a desktop .NET 5 app.  Re-enable when fixed.
        ...
        void VerifyLights(CoreApplicationView whichView, bool forceLightAttachDuringLayout, bool resetWindowContent)
        {
            ...
            RunOnUIThread.Execute(whichView, () =>
            {
                ...
                {
                    App.CurrentWindow.Content = mySPRoot;
                }
                else
                {
                    Content = mySPRoot;
            ...
            if (resetWindowContent)
            {
                RunOnUIThread.Execute(whichView, () =>
                {
                    ...
                    if (whichView != CoreApplication.MainView)
                    {
                        App.CurrentWindow.Content = newSPRoot;
            ...
            _visualRoot = GetTopParent(App.CurrentWindow.Content);
            ...
            RunOnUIThread.Execute(whichView, () =>
            {
                ...
                {
                    App.CurrentWindow.Content = null;
                }
            });
            IdleSynchronizer.Wait();
        ...
        private void CTR_CheckCleanup(object sender, object e)
        {
            ...
            Verify.AreEqual(_visualRoot.Lights.Count, 0, "App.CurrentWindow.Content.Lights.Count should be 0");
            ...
            bool wuxSetsRSVLightOnRootVisual = ApiInformation.IsEnumNamedValuePresent("Microsoft.UI.Xaml.Controls.Symbol", "GlobalNavigationButton");
        ...
        private void PollTimer_Tick(object sender, object e)
        {
            ...
            {
                Verify.AreEqual(_visualRoot.Lights.Count, 5, "App.CurrentWindow.Content.Lights.Count should be 5");
            ...
            {
                Log.Comment("App.CurrentWindow.Content.Lights.Count is " + _visualRoot.Lights.Count + ", should be 5");
