...
// HookupWindowPointerHandlers makes use of CoreWindow's PointerMoved/PointerReleased/PointerCaptureLost events,
// which pass a PointerEventArgs that contains a Windows::UI::Input::PointerPoint, as opposed to a PointerRoutedEventArgs
// that contains a Microsoft::UI::Input::PointerPoint. The wui::PointerPoint still references types in the
// Windows::Device::Input namespace.
...
void RevealBorderLight::EnsureCompositionResources()
{
    ...
    {
        auto compositor = m_targetElement.XamlRoot().Compositor();
...
{
    // MaterialHelper::LightPolicyChangedHelper<RevealBorderLight>(this, isDisabledByMaterialPolicy); // Bug 24355584: DCPP: Reveal is disabled
    MaterialHelper::LightPolicyChangedHelper<RevealBorderLight>(this, true);
}
#endif
...
void RevealBorderLight::HookupWindowPointerHandlers()
{
    ...
    if (m_coreWindow)
    {
        ...
        m_PointerEnteredToken = m_coreWindow.PointerEntered(
            [strongThis](const winrt::CoreWindow&, const::winrt::Windows::UI::Core::PointerEventArgs&)
            {
        ...
        m_PointerMovedToken = m_coreWindow.PointerMoved(
            [strongThis](const winrt::CoreWindow&, const ::winrt::Windows::UI::Core::PointerEventArgs& args)
            {
