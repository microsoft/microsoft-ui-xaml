...
{
    bool isColorOrIntensityAnimated = (!IsIgnored(state.InnerConeIntensity) && IsAnimated(state.InnerConeIntensity)) ||
...
{
    bool isColorOrIntensityIgnored = IsIgnored(state.InnerConeIntensity) && IsIgnored(state.OuterConeIntensity);
