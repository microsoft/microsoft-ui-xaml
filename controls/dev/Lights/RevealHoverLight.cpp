...
{
    // MaterialHelper::LightPolicyChangedHelper<RevealHoverLight>(this, isDisabledByMaterialPolicy); // Bug 24355584: DCPP: Reveal is disabled
    MaterialHelper::LightPolicyChangedHelper<RevealHoverLight>(this, true);
