...
void ScrollViewerIRefreshInfoProviderAdapter::OnScrollViewerViewChanging(const winrt::IInspectable& /*sender*/, const winrt::Microsoft::UI::Xaml::Controls::ScrollViewerViewChangingEventArgs& args)
{
