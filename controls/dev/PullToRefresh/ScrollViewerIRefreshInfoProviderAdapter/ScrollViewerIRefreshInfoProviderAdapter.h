...
public:
    ...
    winrt::IRefreshInfoProvider Adapt(winrt::FxScrollViewer const& adaptee, winrt::Size const& size);
...
private:
    ...
    void OnScrollViewerViewChanging(const winrt::IInspectable& sender, const winrt::Microsoft::UI::Xaml::Controls::ScrollViewerViewChangingEventArgs& args);
