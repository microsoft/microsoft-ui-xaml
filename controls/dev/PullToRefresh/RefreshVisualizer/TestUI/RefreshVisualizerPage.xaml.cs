...
namespace MUXControlsTestApp
{
    public sealed partial class RefreshVisualizerPage : TestPage
    {
        ...
        public RefreshVisualizerPage()
        {
            ...
            grid.Background = new SolidColorBrush(Microsoft.UI.ColorHelper.FromArgb(255, 255, 255, 0));
        ...
        private void ChangeBackgroundClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                case 0:
                    this.RefreshVisualizer.Background = new SolidColorBrush(Microsoft.UI.ColorHelper.FromArgb(255, 255, 0, 0));
                    break;
                case 1:
                    this.RefreshVisualizer.Background = new SolidColorBrush(Microsoft.UI.ColorHelper.FromArgb(255, 0, 255, 0));
                    break;
                case 2:
                    this.RefreshVisualizer.Background = new SolidColorBrush(Microsoft.UI.ColorHelper.FromArgb(255, 0, 0, 255));
                    break;
                default:
                    this.RefreshVisualizer.Background = new SolidColorBrush(Microsoft.UI.ColorHelper.FromArgb(0, 0, 0, 0));
        ...
        private void ChangeForegroundClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                case 0:
                    this.RefreshVisualizer.Foreground = new SolidColorBrush(Microsoft.UI.ColorHelper.FromArgb(255, 255, 0, 0));
                    break;
                case 1:
                    this.RefreshVisualizer.Foreground = new SolidColorBrush(Microsoft.UI.ColorHelper.FromArgb(255, 0, 255, 0));
                    break;
                case 2:
                    this.RefreshVisualizer.Foreground = new SolidColorBrush(Microsoft.UI.ColorHelper.FromArgb(255, 0, 0, 255));
                    break;
                default:
                    this.RefreshVisualizer.Foreground = new SolidColorBrush(Microsoft.UI.ColorHelper.FromArgb(255, 0, 0, 0));
