...
{
#ifdef DBG
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"key", key);
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"isRepeatKey", isRepeatKey);
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"queued keys size", m_navigationKeysToProcess.size());
#endif
    ...
    if (lastNavigationKey == key)
    {
        ...
        {
#ifdef DBG
            ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"Navigation keys throttling.");
#endif
...
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"Navigation keys list cleared for Home/End.");
#endif
    ...
    default:
    {
        ...
        {
#ifdef DBG
            ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"Incoming key and last queued navigation key canceled.");
#endif
    ...
    const winrt::GettingFocusEventArgs& args)
{
    ...
    if (focusState == winrt::FocusState::Keyboard)
    {
...
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"ElementIndex", elementIndex);
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"CurrentElementIndex", currentElementIndex);
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"FocusMovingIntoItemsRepeater", focusMovingIntoItemsRepeater);
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"Direction", static_cast<int>(args.Direction()));
#endif
...
#ifdef DBG
                    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"Redirecting focus to CurrentElementIndex", currentElementIndex);
#endif
                    bool success = args.TrySetNewFocusedElement(currentElement);
#ifdef DBG
                    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"TrySetNewFocusedElement result", success);
#endif
                    return;
                }
            }
        ...
        if (m_selector != nullptr && !focusMovingIntoItemsRepeater)
        {
            ...
            m_selector->OnFocusedAction(GetElementIndexPath(element), isCtrlDown, isShiftDown);
        }
    }
}
    ...
    const winrt::KeyRoutedEventArgs& args)
{
...
#ifdef DBG
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"sender element index", element ? GetElementIndex(element) : -1);
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"current element index", GetCurrentElementIndex());
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"key", args.Key());
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"key repeat count", args.KeyStatus().RepeatCount);
#endif
    ...
    {
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"Key canceled.");
#endif
    ...
    const winrt::FocusState& focusState)
{
    ...
    if (m_selector != nullptr)
    {
        ...
        m_isProcessingInteraction = true;
        m_selector->OnInteractedAction(GetElementIndexPath(element), isCtrlDown, isShiftDown);
    }
...
#ifdef DBG
            ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, isForPageUp ? L"PageUp - phase 1" : L"PageDown - phase 1", index);
#endif
...
#ifdef DBG
                    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, isForPageUp ? L"PageUp - phase 2" : L"PageDown - phase 2", index);
#endif
...
#ifdef DBG
                            ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, isForPageUp ? L"PageUp - phase 3" : L"PageDown - phase 3", index);
#endif
...
#ifdef DBG
            ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT_INT, METH_NAME, this, L"index", index, success);
#endif
...
#ifdef DBG
                        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_navigationKeyBringIntoViewPendingCount incremented", m_navigationKeyBringIntoViewPendingCount);
#endif
                    }
                    else if (startBringIntoView)
                    {
#ifdef DBG
                        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_METH, METH_NAME, this, L"UIElement::StartBringIntoView");
#endif
