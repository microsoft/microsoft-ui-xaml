...
namespace MUXControlsTestApp
{
    public sealed partial class ItemsViewInteractiveTestsPage : TestPage
    {
        ...
        public ItemsViewInteractiveTestsPage()
        {
            ...
            btnGetCurrentElementIndex.GettingFocus += BtnGetCurrentElementIndex_GettingFocus;
        }
        ...
        private void BtnGetCurrentElementIndex_GettingFocus(UIElement sender, Microsoft.UI.Xaml.Input.GettingFocusEventArgs args)
        {
        ...
        private void BtnGetCurrentElementIndex_Click(object sender, RoutedEventArgs e)
        {
            this.txtStatus.Text = "GetCurrentElementIndex ...";

            int currentElementIndex = itemsView.CurrentItemIndex;

            txtCurrentElementIndex.Text = currentElementIndex.ToString();

            this.txtStatus.Text = "GetCurrentElementIndex. Done.";
