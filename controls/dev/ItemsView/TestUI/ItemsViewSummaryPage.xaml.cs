...
{
    public sealed partial class ItemsViewSummaryPage : TestPage
    {
        ...
        private DataTemplate[] _recipeTemplates = new DataTemplate[16];
        ...
        private async void UIElement_DragStarting(UIElement sender, DragStartingEventArgs args)
        {
        ...
        {
            int currentElementIndex = _itemsView.CurrentItemIndex;

            if (log)
            {
                AppendAsyncEventMessage($"ItemsView.CurrentElementIndex={currentElementIndex}");
            }
            ...
            if (bdrCurrentElement != null)
            {
                ...
                if (itemsRepeater != null)
                {
                    currentElement = itemsRepeater.TryGetElement(currentElementIndex);
                }
            ...
            try
            {
                if (_itemsView != null)
                {
                    ...
                    if (scrollView != null)
                    {
                        ...
                        {
                            scrollView.HorizontalAnchorRatio = 0.5;
        ...
        private void BtnSetHeight_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                _itemsView.Height = Convert.ToDouble(txtHeight.Text);
            }
            catch (Exception ex)
            {
                txtExceptionReport.Text = ex.ToString();
        ...
        private void BtnSetWidth_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                _itemsView.Width = Convert.ToDouble(txtWidth.Text);
