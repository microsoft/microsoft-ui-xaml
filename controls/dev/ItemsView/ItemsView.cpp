    ...
    const winrt::ItemContainer& itemContainer)
{
    ...
    {
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"Returns false based on ItemContainer.CanUserInvoke.");
#endif
...
#ifdef DBG
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"Returns based on ItemsView.IsItemInvokedEnabled.", canRaiseItemInvoked);
#endif
...
#ifdef DBG
    ITEMSVIEW_TRACE_VERBOSE(*this, TRACE_MSG_METH_PTR_STR, METH_NAME, this, m_originalVerticalScrollController, L"m_originalVerticalScrollController");
    ITEMSVIEW_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_originalVerticalScrollBarVisibility", m_originalVerticalScrollBarVisibility);
#endif
}
...
{
#ifdef DBG
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_PTR_STR, METH_NAME, this, VerticalScrollController(), L"VerticalScrollController");
#endif
    ...
    if (auto scrollView = m_scrollView.get())
    {
        ...
        if (auto scrollPresenter = scrollViewImpl->GetScrollPresenterPart())
        {
...
{
#ifdef DBG
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_PTR_STR, METH_NAME, this, m_bringIntoViewElement.get(), L"m_bringIntoViewElement reset.");
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_bringIntoViewCorrelationId reset", m_bringIntoViewCorrelationId);
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_bringIntoViewElementRetentionCountdown reset", m_bringIntoViewElementRetentionCountdown);
#endif
...
{
#ifdef DBG
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"ScrollingAnchorRequestedEventArgs.AnchorCandidates.Size", args.AnchorCandidates().Size());
#endif
...
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_PTR_STR, METH_NAME, this, m_bringIntoViewElement.get(), L"ScrollingAnchorRequestedEventArgs.AnchorElement set to m_bringIntoViewElement.");
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"at index", GetElementIndex(m_bringIntoViewElement.get()));
#endif
...
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"for m_bringIntoViewElement index", GetElementIndex(m_bringIntoViewElement.get()));
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_bringIntoViewCorrelationId set", m_bringIntoViewCorrelationId);
#endif
    }
...
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_navigationKeyBringIntoViewPendingCount decremented", m_navigationKeyBringIntoViewPendingCount);
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_navigationKeyBringIntoViewCorrelationId set", m_navigationKeyBringIntoViewCorrelationId);
#endif
    }
}
...
{
#ifdef DBG
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"ScrollingScrollCompletedEventArgs.CorrelationId", args.CorrelationId());
#endif
...
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"m_bringIntoViewCorrelationId reset & m_bringIntoViewElementRetentionCountdown initialized to 4.");
#endif
    ...
    if (args.CorrelationId() == m_navigationKeyBringIntoViewCorrelationId)
    {
        ...
        {
#ifdef DBG
            ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"m_navigationKeyBringIntoViewCorrelationId reset.");
#endif
        ...
        {
#ifdef DBG
            ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"m_navigationKeyProcessingCountdown initialized to 4.");
#endif
...
{
#ifdef DBG
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_bringIntoViewElementRetentionCountdown", m_bringIntoViewElementRetentionCountdown);
    ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_navigationKeyProcessingCountdown", m_navigationKeyProcessingCountdown);
#endif
...
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"Keyboard navigation fields reset.");
#endif
...
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"Bring-into-view fields reset.");
#endif
    ...
    bool expectBringIntoView)
{
    ...
    {
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"current element index", currentElementIndex);
    ...
    const winrt::BringIntoViewOptions& options)
{
...
#ifdef DBG
    ITEMSVIEW_TRACE_VERBOSE(*this, TRACE_MSG_METH_METH, METH_NAME, this, L"UIElement::UpdateLayout");
#endif
    ...
    {
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_PTR_STR, METH_NAME, this, m_bringIntoViewElement.get(), L"m_bringIntoViewElement set. Invoking UIElement.StartBringIntoView without options.");
#endif
    ...
    {
#ifdef DBG
        ITEMSVIEW_TRACE_INFO(*this, TRACE_MSG_METH_PTR_STR, METH_NAME, this, m_bringIntoViewElement.get(), L"m_bringIntoViewElement set. Invoking UIElement.StartBringIntoView with options.");
#endif
