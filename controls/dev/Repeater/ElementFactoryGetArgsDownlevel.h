...
// Microsoft::UI::Xaml:ElementFactoryGetArgs type has been added to WUX in RS5. However, we want Repeater to use it downlevel. 
// The way we achieve this is by implementing the Window::UI::Xaml::IElementFactoryGetArgs
// interface here on our own type and 'lie' that our runtime class name is Microsoft.UI.Xaml.ElementFactoryGetArgs !
...
public:
    ...
    hstring GetRuntimeClassName() const
    {
        ...
        return L"Microsoft.UI.Xaml.ElementFactoryGetArgs";
    }
