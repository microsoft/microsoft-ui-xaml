...
{
    REPEATER_TRACE_INFO(L"MeasureOverride availableSize - %lf x %lf\n", availableSize.Width, availableSize.Height);
...
{
    REPEATER_TRACE_INFO(L"ArrangeOverride finalSize - %lf x %lf\n", finalSize.Width, finalSize.Height);
...
void ItemsRepeater::OnLayoutChanged(const winrt::Layout& oldValue, const winrt::Layout& newValue)
{
    ...
    else if (m_ownsTransitionProvider)
    {
        m_transitionManager.OnTransitionProviderChanged(nullptr);
    }
