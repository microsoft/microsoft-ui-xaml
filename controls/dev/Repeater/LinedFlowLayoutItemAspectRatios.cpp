    ...
    int weight) const
{
    for (std::shared_ptr<ItemAspectRatioBlock> itemAspectRatioBlock : m_itemAspectRatioBlocks)
    {
        ...
        {
#ifdef DBG
            LINEDFLOWLAYOUT_TRACE_INFO(nullptr, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"firstItemIndex", firstItemIndex);
            LINEDFLOWLAYOUT_TRACE_INFO(nullptr, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"lastItemIndex", lastItemIndex);
            LINEDFLOWLAYOUT_TRACE_INFO(nullptr, TRACE_MSG_METH_STR, METH_NAME, this, L"returns True");
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"firstItemIndex", firstItemIndex);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"lastItemIndex", lastItemIndex);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_STR, METH_NAME, this, L"returns False");
#endif
    ...
    int weight) const
{
    ...
    {
#ifdef DBG
        LINEDFLOWLAYOUT_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_STR_FLT, METH_NAME, this, L"totalAspectRatios", totalAspectRatios);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"totalWeights", totalWeights);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_STR_FLT, METH_NAME, this, L"returned value", totalAspectRatios / totalWeights);
#endif
    ...
    int weight) const
{
    ...
    for (int itemAspectRatioIndex = 0; itemAspectRatioIndex < c_blockSize; itemAspectRatioIndex++)
    {
        ...
        {
#ifdef DBG
            LINEDFLOWLAYOUT_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"itemIndex included", currentIndex);
            LINEDFLOWLAYOUT_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"weight included", currentWeight);
            LINEDFLOWLAYOUT_TRACE_VERBOSE(nullptr, TRACE_MSG_METH_STR_FLT, METH_NAME, this, L"aspect ratio included", m_aspectRatios[itemAspectRatioIndex].m_aspectRatio);
#endif
