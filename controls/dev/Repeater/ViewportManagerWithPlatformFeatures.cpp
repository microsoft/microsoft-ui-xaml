...
winrt::UIElement ViewportManagerWithPlatformFeatures::SuggestedAnchor() const
{
    ...
    if (!suggestedAnchor)
    {
        ...
        {
#ifdef DBG
            REPEATER_TRACE_INFO(L"%ls: \tSuggestedAnchor returns IScrollAnchorProvider.CurrentAnchor. \n", GetLayoutId().data());
#endif
        ...
        {
            REPEATER_TRACE_INFO(L"%ls: \tSuggestedAnchor returns null. \n", GetLayoutId().data());
        }
#endif
    }
#ifdef DBG
    ...
    {
        REPEATER_TRACE_INFO(L"%ls: \tSuggestedAnchor returns non-null m_makeAnchorElement. \n", GetLayoutId().data());
    }
#endif
...
{
#ifdef DBG
    REPEATER_TRACE_INFO(anchor == nullptr ? L"%ls: \tOnMakeAnchor resets m_makeAnchorElement. \n" : L"%ls: \tOnMakeAnchor sets m_makeAnchorElement. \n", GetLayoutId().data());
#endif
...
{
#ifdef DBG
    REPEATER_TRACE_INFO(L"%ls: \tOnCompositionTargetRendering resets m_makeAnchorElement. \n", GetLayoutId().data());
#endif
