...
// Microsoft::UI::Xaml:ElementFactoryRecycleArgs type has been added to WUX in RS5. However, we want Repeater to use it downlevel. 
// The way we achieve this is by implementing the Window::UI::Xaml::IElementFactoryRecycleArgs
// interface here on our own type and 'lie' that our runtime class name is Microsoft.UI.Xaml.ElementFactoryRecycleArgs !

class ElementFactoryRecycleArgsDownlevel
    : public ReferenceTracker<
        ElementFactoryRecycleArgsDownlevel,
        reference_tracker_implements_t<winrt::Microsoft::UI::Xaml::IElementFactoryRecycleArgs>::type>
{
public:
    ...
    hstring GetRuntimeClassName() const
    {
        ...
        return L"Microsoft.UI.Xaml.ElementFactoryRecycleArgs";
    }
