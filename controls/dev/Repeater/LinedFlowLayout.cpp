    ...
    winrt::Size const& availableSize)
{
    ...
    UpdateActualLineHeight(context, availableSize);
    ...
    if (m_itemCount > 0 && actualLineHeight > 0.0)
    {
...
#ifdef DBG
                        LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"MeasureConstrainedLinesRegularPath enabled fast path");
#endif
        ...
        if (m_isVirtualizingContext && m_itemsInfoFirstIndex == -1 && m_aspectRatios != nullptr)
        {
            ...
            {
#ifdef DBG
                LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"Forcing layout pass for low aspect ratio weight");
#endif
...
#ifdef DBG
        LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"nearUnfrozenLinesCount", nearUnfrozenLinesCount);
        LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"farUnfrozenLinesCount", farUnfrozenLinesCount);
#endif
        return true;
    }
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_firstFrozenItemIndex", firstFrozenItemIndex);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_lastFrozenItemIndex", lastFrozenItemIndex);
#endif
    ...
    bool isLastSizedLineStretchEnabled)
{
    ...
    for (lineVectorIndex = forward ? 0 : sizedLineCount - 1; ; lineVectorIndex = forward ? lineVectorIndex + 1 : lineVectorIndex - 1)
    {
        ...
        else
        {
            ...
            MUX_ASSERT(!(itemsAreStretched && availableWidth - lineItemsWidth > lineItemsCount && lineVectorIndex != sizedLineCount - 1));
        }
...
#ifdef DBG
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"itemsLayouts.size", itemsLayouts.size());
#endif
...
#ifdef DBG
                LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"End-of-Phase-5 picking phase 5's layout");
#endif
            }
        }
...
{
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"oldStart", oldStart);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"newStart", newStart);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"copyCount", copyCount);

    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_INT_INT, METH_NAME, this, oldStart + copyCount, oldItemsInfoDesiredAspectRatios.size());
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_INT_INT, METH_NAME, this, newStart + copyCount, m_itemsInfoDesiredAspectRatiosForRegularPath.size());
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"entry", actualLineHeight);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_anchorIndex", m_anchorIndex);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"newRecommendedAnchorIndex", newRecommendedAnchorIndex);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"newFirstRealizedItemIndex", newFirstRealizedItemIndex);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"newLastRealizedItemIndex", newLastRealizedItemIndex);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"newRealizedItemCount", newRealizedItemCount);
#endif
...
#ifdef DBG
        LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT_INT, METH_NAME, this, L"discarded realized head range",
...
#ifdef DBG
        LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT_INT, METH_NAME, this, L"discarded realized tail range",
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"exit");
#endif
}
    ...
    float availableWidth)
{
    ...
    if (m_aspectRatios != nullptr && !m_aspectRatios->IsEmpty())
    {
        ...
        {
#ifdef DBG
            LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR, METH_NAME, this, L"Forcing layout pass for low initial aspect ratio average");
            LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"minAverageItemAspectRatio", minAverageItemAspectRatio);
            LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"averageItemAspectRatio", averageItemAspectRatio);
#endif
...
#ifdef DBG_VERBOSE
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_DBL, METH_NAME, this, averageItemsPerLine.second);
#endif
...
{
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"scrollViewport", scrollViewport);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"scrollOffset", scrollOffset);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"padding", padding);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"lineSpacing", lineSpacing);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"actualLineHeight", actualLineHeight);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"lineCount", lineCount);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"forFullyDisplayedLines", forFullyDisplayedLines);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT_INT, METH_NAME, this, forFullyDisplayedLines ? L"fullyDisplayedLines" : L"displayedLines", *firstDisplayedLineIndex, *lastDisplayedLineIndex);
#endif
}
...
{
    MUX_ASSERT(movingWidth < currentLineItemsWidth);
...
#ifdef DBG
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_FLT, METH_NAME, this, L"sizedItemsRectHeight", sizedItemsRectHeight);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_FLT, METH_NAME, this, L"nearRealizationRect", nearRealizationRect);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_FLT, METH_NAME, this, L"farRealizationRect", farRealizationRect);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_FLT, METH_NAME, this, L"realizationRectHeightDeficit", realizationRectHeightDeficit);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_FLT, METH_NAME, this, L"nearSizedItemsRect", nearSizedItemsRect);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_FLT, METH_NAME, this, L"farSizedItemsRect", farSizedItemsRect);
#endif
...
#ifdef DBG
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"linesHeight", linesHeight);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"scrollViewport", scrollViewport);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"scrollableSize", scrollableSize);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"sizedItemsRectHeight", sizedItemsRectHeight);
#endif
...
#ifdef DBG
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"clampedNearSizedItemsRect", clampedNearSizedItemsRect);
        LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"clampedFarSizedItemsRect", clampedFarSizedItemsRect);
#endif
    ...
    bool isLastSizedLineStretchEnabled)
{
    ...
    for (int sizedItemIndex = beginSizedItemIndex; ; sizedItemIndex = forward ? sizedItemIndex + 1 : sizedItemIndex - 1)
    {
        ...
        const bool mustCumulate =
            cumulatedWidth == 0.0 ||                                                                                                                           // No item is present on the current line - it must at least contain one item
        ...
        const bool canCumulate = cumulatedWidth + (cumulatedWidth == 0.0 ? 0.0 : minItemSpacing) + itemWidth <= adjustedAvailableWidth;
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_INT_INT, METH_NAME, this, L"lineIndex", lineIndex);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_INT_INT, METH_NAME, this, L"itemIndex", itemIndex);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"unrealizedNearItemCount", unrealizedNearItemCountTmp);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"realizedItemCount", realizedItemCountTmp);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT_INT, METH_NAME, this, L"realized item index range", unrealizedNearItemCountTmp, unrealizedNearItemCountTmp + realizedItemCountTmp - 1);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"tickCount", tickCount);
    LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"timerInterval", timerInterval);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_unrealizedNearLineCount", m_unrealizedNearLineCount);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"realizedLineCount", realizedLineCount);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_unsizedNearLineCount", m_unsizedNearLineCount);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"sizedLineCount", sizedLineCount);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_firstSizedLineIndex", m_firstSizedLineIndex);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_lastSizedLineIndex", m_lastSizedLineIndex);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"sizedItemCount", sizedItemCount);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"unsizedNearItemCount", unsizedNearItemCount);
#endif
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_firstSizedItemIndex", m_firstSizedItemIndex);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"m_lastSizedItemIndex", m_lastSizedItemIndex);
#endif
...
#ifdef DBG
        LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"unrealizedNearItemCount fallback", unrealizedNearItemCount);
        LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"realizedItemCount fallback", realizedItemCount);
        LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT_INT, METH_NAME, this, L"realized item index range fallback", unrealizedNearItemCount, unrealizedNearItemCount + realizedItemCount - 1);
#endif
    }
    else
    {
...
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"firstStillSizedLineIndex", firstStillSizedLineIndex);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"lastStillSizedLineIndex", lastStillSizedLineIndex);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"firstStillSizedItemIndex", firstStillSizedItemIndex);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"lastStillSizedItemIndex", lastStillSizedItemIndex);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"firstStillRealizedItemIndex", firstStillRealizedItemIndex);
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT, METH_NAME, this, L"lastStillRealizedItemIndex", lastStillRealizedItemIndex);
#endif
...
{
#ifdef DBG
    LINEDFLOWLAYOUT_TRACE_INFO(*this, TRACE_MSG_METH_STR_INT_INT, METH_NAME, this, L"with ElementAvailableSize", beginRealizedItemIndex, endRealizedItemIndex);
#endif
    ...
    int endSizedItemIndex)
{
    ...
    for (int index = 0; index < itemsRangeLength; index++)
    {
        ...
        {
#ifdef DBG
            LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"minWidth", m_itemsInfoMinWidthsForFastPath[index]);
#endif
        ...
        {
#ifdef DBG
            LINEDFLOWLAYOUT_TRACE_VERBOSE(*this, TRACE_MSG_METH_STR_DBL, METH_NAME, this, L"maxWidth", m_itemsInfoMaxWidthsForFastPath[index]);
#endif
...
void LinedFlowLayout::UpdateActualLineHeight(
    winrt::VirtualizingLayoutContext const& context,
    winrt::Size const& availableSize)
{
