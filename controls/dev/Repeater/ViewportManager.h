...
// Manages the virtualization windows (visible/realization) using
// EffectiveViewport and ScrollAnchoring platform features.
class ViewportManager
{
public:
    ViewportManager(ItemsRepeater* owner);
    ...
    void SetLayoutExtent(const winrt::Rect& layoutExtent);

    winrt::Rect GetLayoutExtent() const { return m_layoutExtent; }
    ...
    void ResetLayoutRealizationWindowCacheBuffer();
    void ResetScrollers();
