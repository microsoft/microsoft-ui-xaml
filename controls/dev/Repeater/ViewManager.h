...
#pragma endregion
    ...
    tracker_ref<winrt::Microsoft::UI::Xaml::ElementFactoryGetArgs> m_ElementFactoryGetArgs;
    tracker_ref<winrt::Microsoft::UI::Xaml::ElementFactoryRecycleArgs> m_ElementFactoryRecycleArgs;
