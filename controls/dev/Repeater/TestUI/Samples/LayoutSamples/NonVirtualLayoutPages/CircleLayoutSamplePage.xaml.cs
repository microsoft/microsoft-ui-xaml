...
namespace MUXControlsTestApp.Samples
{
    public sealed partial class CircleLayoutSamplePage : Page
    {
        ...
        public CircleLayoutSamplePage()
        {
            ...
            customAnimations.Checked += delegate { repeater.ItemTransitionProvider = new RadialItemCollectionTransitionProvider(); };
            customAnimations.Unchecked += delegate { repeater.ItemTransitionProvider = new DefaultItemCollectionTransitionProvider(); };
        ...
        private void OnNewItemTapped(object sender, Microsoft.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            _data.Insert(0, (Person)newItem.Content);
            newItem.Content = NewPerson();
        }

        private void OnExistingItemTapped(object sender, Microsoft.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
