    ...
    public sealed partial class AnimationsDemoPage : Page
    {
        ...
        public AnimationsDemoPage()
        {
            ...
            var generator = new AnimationElementFactory(
                ...
                (ItemCollectionTransitionProvider)Resources["SharedTransitionProvider"],
                KeyFromIndexFunc);
            ...
            {
                //ItemCollectionTransitionProvider.AnimationSlowdownFactor = animationSlowdown.Value;
            };
        }
        ...
        private class AnimationElementFactory : ElementFactory
        {
            ...
            public AnimationElementFactory(
                ...
                ItemCollectionTransitionProvider transitionProvider,
            ...
            protected override UIElement GetElementCore(ElementFactoryGetArgs args)
            {
                ...
                if (args.Data is RecipeGroup)
                {
                    ...
                    repeater.ItemTransitionProvider = _transitionProvider;
                }
                else
                {
