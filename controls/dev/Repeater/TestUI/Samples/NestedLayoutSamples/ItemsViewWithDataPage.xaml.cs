...
namespace MUXControlsTestApp.Samples
{
    public sealed partial class ItemsViewWithDataPage : Page
    {
        ...
        TestObservableCollection<Recipe> _flatData;
        TestObservableCollection<RecipeGroup> _oneLevelNestedData;
        TestObservableCollection<Year> _twoLevelNestedData;
        PageInfo _pageInfo;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (_pageInfo != null)
            {
                ...
                {
                    case 0:
                        _flatData = new TestObservableCollection<Recipe>(Enumerable.Range(0, 300).Select(k =>
                            new Recipe
                            {
                        ...
                        break;
                    case 1:
                        _oneLevelNestedData = new TestObservableCollection<RecipeGroup>(Enumerable.Range(0, 10).Select(j =>
                            new RecipeGroup(
                        ...
                        break;
                    case 2:
                        _twoLevelNestedData = new TestObservableCollection<Year>(Enumerable.Range(0, 3).Select(i => new Year(
                            new TestObservableCollection<RecipeGroup>(Enumerable.Range(0, rnd.Next(2, 5)).Select(j => new RecipeGroup(
                                Enumerable.Range(0, rnd.Next(5, 16)).Select(k =>
                                         new Recipe
                                         {
                                             ImageUri = new Uri(string.Format("ms-appx:///Images/recipe{0}.png", k % 8 + 1)),
