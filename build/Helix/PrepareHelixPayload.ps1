...
Copy-Item "$nugetPackagesDir\taef.redist.wlk.10.57.201103001\build\Binaries\$Platform\*" $payloadDir
Copy-Item "$nugetPackagesDir\taef.redist.wlk.10.57.201103001\build\Binaries\$Platform\CoreClr\*" $payloadDir
