...
foreach ($testRun in $testRuns.value)
{
    ...
    $testResults = Invoke-RestMethodWithRetries $testRunResultsUri -Method Get -Headers $azureDevOpsRestApiHeaders
    ...
    foreach ($testResult in $testResults.value)
    {
        ...
        if ($testNeedsSubResultProcessing)
        {
            ...
            $rerunResults = ConvertFrom-Json Download-StringWithRetries $testResult.errorMessage
