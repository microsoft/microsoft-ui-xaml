...
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\MUXControls.Test.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\MUXTestInfra.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Microsoft.Win32.Registry.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Axe.Windows.Actions.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Axe.Windows.Automation.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Axe.Windows.Core.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Axe.Windows.Desktop.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Axe.Windows.Rules.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Axe.Windows.RuleSelection.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Axe.Windows.SystemAbstractions.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Axe.Windows.Telemetry.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Axe.Windows.Win32.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\Newtonsoft.Json.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\System.Drawing.Common.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.Test\System.IO.Packaging.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\Microsoft.UI.Xaml\WebView2Loader.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.ReleaseTest\MUXControls.ReleaseTest.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXControls.ReleaseTest\WebView2Loader.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\NugetPackageTestApp\WebView2Loader.dll $FullPublishDir\Test\
PublishFile -IfExists $FullBuildOutput\MUXExperimental.Test\MUXExperimental.Test.dll $FullPublishDir\Test\
