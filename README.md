...
| --- | --- | --- |
| [Microsoft.UI.Xaml](https://www.nuget.org/packages/Microsoft.UI.Xaml) <br /> Controls and Fluent Design for UWP apps | [![Build Status](https://microsoft.visualstudio.com/WinUI/_apis/build/status/WinUI_build_OS)](https://dev.azure.com/ms/microsoft-ui-xaml/_build?definitionId=20) | ![latest stable version](https://img.shields.io/nuget/v/Microsoft.UI.Xaml.svg) <br /> ![latest prerelease version](https://img.shields.io/nuget/vpre/Microsoft.UI.Xaml.svg) |
