...
[UseSystemFocusVisuals](https://learn.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Control.UseSystemFocusVisuals)
property is set to.
...
[Colors.Transparent](https://learn.microsoft.com/uwp/api/Windows.UI.Colors.Transparent).
...
[Light-weight styling section](https://learn.microsoft.com/windows/uwp/design/controls-and-patterns/xaml-styles#lightweight-styling)
of the
[Styling controls](https://learn.microsoft.com/windows/uwp/design/controls-and-patterns/xaml-styles)
article.
...
There's more information on rounded corners in [WinUI docs](https://learn.microsoft.com/windows/uwp/design/style/rounded-corner),
